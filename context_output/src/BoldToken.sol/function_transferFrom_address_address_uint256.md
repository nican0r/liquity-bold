...
- **Kind**: internal
- **Source**: 5203:256:78
- **Link**: `lib/openzeppelin-contracts/contracts/token/ERC20/ERC20.sol:ERC20:transferFrom(address,address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: BoldToken.transferFrom(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BoldToken._requireValidRecipient(address) (NodeID: 1)
  │   💬 Args: [recipient]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: ERC20.transferFrom(address,address,uint256) (NodeID: 2)
      💬 Args: [sender, recipient, amount]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: Context._msgSender() (NodeID: 3)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ERC20._spendAllowance(address,address,uint256) (NodeID: 4)
    │   💬 Args: [from, spender, amount]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: ERC20.allowance(address,address) (NodeID: 5)
    │ │   💬 Args: [owner, spender]
    │ │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: ERC20._approve(address,address,uint256) (NodeID: 6)
    │     💬 Args: [owner, spender, currentAllowance - amount]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: ERC20._transfer(address,address,uint256) (NodeID: 7)
        💬 Args: [from, to, amount]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: ERC20._beforeTokenTransfer(address,address,uint256) (NodeID: 8)
      │   💬 Args: [from, to, amount]
      │   👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: ERC20._afterTokenTransfer(address,address,uint256) (NodeID: 9)
          💬 Args: [from, to, amount]
          👁️  Def: internal
```
