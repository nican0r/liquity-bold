...
### providerOf (inherited from E2EHelpers)

```solidity
mapping(address => address) internal providerOf
```

### _allocateLQTY_initiativesToReset (inherited from E2EHelpers)

```solidity
address[] internal _allocateLQTY_initiativesToReset
```

### _allocateLQTY_initiatives (inherited from E2EHelpers)

```solidity
address[] internal _allocateLQTY_initiatives
```

### _allocateLQTY_votes (inherited from E2EHelpers)

```solidity
int256[] internal _allocateLQTY_votes
```

### _allocateLQTY_vetos (inherited from E2EHelpers)

```solidity
int256[] internal _allocateLQTY_vetos
```

### ownables

```solidity
address[] internal ownables
```
...
### test_OwnershipRenounced()

- **Signature**: `test_OwnershipRenounced()`
- **Visibility**: external
- **Source Range**: 5377:876:231
- **Details**: [function_test_OwnershipRenounced.md](./function_test_OwnershipRenounced.md)
...
### test_Initially_NewInitiativeCannotBeRegistered()

- **Signature**: `test_Initially_NewInitiativeCannotBeRegistered()`
- **Visibility**: external
- **Source Range**: 6386:678:231
- **Details**: [function_test_Initially_NewInitiativeCannotBeRegistered.md](./function_test_Initially_NewInitiativeCannotBeRegistered.md)
...
### test_AfterOneEpoch_NewInitiativeCanBeRegistered()

- **Signature**: `test_AfterOneEpoch_NewInitiativeCanBeRegistered()`
- **Visibility**: external
- **Source Range**: 7070:606:231
- **Details**: [function_test_AfterOneEpoch_NewInitiativeCanBeRegistered.md](./function_test_AfterOneEpoch_NewInitiativeCanBeRegistered.md)
...
- **Details**: [function_test_E2E.md](./function_test_E2E.md)
...
### test_Borrowing_InExistingDeployment()

- **Signature**: `test_Borrowing_InExistingDeployment()`
- **Visibility**: external
- **Source Range**: 15995:1092:231
- **Details**: [function_test_Borrowing_InExistingDeployment.md](./function_test_Borrowing_InExistingDeployment.md)
...
### test_ManagerOfCurveGauge_UnlessRenounced_CanReassignRewardDistributor()

- **Signature**: `test_ManagerOfCurveGauge_UnlessRenounced_CanReassignRewardDistributor()`
- **Visibility**: external
- **Source Range**: 17093:971:231
- **Details**: [function_test_ManagerOfCurveGauge_UnlessRenounced_CanReassignRewardDistributor.md](./function_test_ManagerOfCurveGauge_UnlessRenounced_CanReassignRewardDistributor.md)
...
### setUp() (inherited from E2EHelpers)

- **Signature**: `setUp()`
- **Visibility**: public
- **Source Range**: 4301:1237:287
