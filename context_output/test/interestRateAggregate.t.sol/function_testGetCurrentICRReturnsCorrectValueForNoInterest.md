# Function: testGetCurrentICRReturnsCorrectValueForNoInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testGetCurrentICRReturnsCorrectValueForNoInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
