# Function: testApplyTroveInterestPermissionlessReducesPendingAggInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testApplyTroveInterestPermissionlessReducesPendingAggInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
