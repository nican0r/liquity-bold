# Function: testCloseTroveReducesPendingAggInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCloseTroveReducesPendingAggInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 9)
  │   💬 Args: [B, BTroveId]
  │   👁️  Def: public
