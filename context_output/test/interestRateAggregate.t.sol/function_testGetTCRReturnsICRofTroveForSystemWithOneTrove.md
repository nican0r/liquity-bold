# Function: testGetTCRReturnsICRofTroveForSystemWithOneTrove()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testGetTCRReturnsICRofTroveForSystemWithOneTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, coll, troveDebtRequest, interestRate]
  │   👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.calcUpfrontFee(uint256,uint256) (NodeID: 4)
  │   💬 Args: [debt, interestRate]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseTest.calcInterest(uint256,uint256) (NodeID: 5)
  │     💬 Args: [debt * avgInterestRate, UPFRONT_INTEREST_PERIOD]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 6)
  │   💬 Args: [expectedICR, troveManager.getCurrentICR(ATroveId, price)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 7)
      💬 Args: [expectedICR, troveManager.getTCR(price)]
      👁️  Def: internal
```
