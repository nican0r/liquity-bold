# Function: testRepayBoldMintsAggInterestToSP()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testRepayBoldMintsAggInterestToSP() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.repayBold(address,uint256,uint256) (NodeID: 8)
