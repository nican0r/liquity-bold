# Function: testBatchLiquidateTrovesPureRedistUpdatesLastAggInterestUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testBatchLiquidateTrovesPureRedistUpdatesLastAggInterestUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 18)
  │   💬 Args: [activePool.lastAggUpdateTime(), block.timestamp]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.batchLiquidateTroves(address,uint256[]) (NodeID: 19)
  │   💬 Args: [A, trovesToLiq]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 20)
