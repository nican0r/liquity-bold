# Function: testCalcTroveAccruedInterestReturnsCorrectInterestForGivenPeriod()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCalcTroveAccruedInterestReturnsCorrectInterestForGivenPeriod() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, 2 ether, debtRequest_A, annualRate_A]
  │   👁️  Def: public
  ...
  │   💬 Args: [troveManager.calcTroveAccruedInterest(ATroveId), expectedInterest_A]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 7)
  │   💬 Args: [B, 2 ether, debtRequest_B, annualRate_B]
  │   👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 12)
      💬 Args: [troveManager.calcTroveAccruedInterest(BTroveId), expectedInterest_B]
      👁️  Def: internal
```
