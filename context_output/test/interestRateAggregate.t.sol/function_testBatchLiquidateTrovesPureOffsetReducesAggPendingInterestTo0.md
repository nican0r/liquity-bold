# Function: testBatchLiquidateTrovesPureOffsetReducesAggPendingInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testBatchLiquidateTrovesPureOffsetReducesAggPendingInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.batchLiquidateTroves(address,uint256[]) (NodeID: 20)
  │   💬 Args: [A, trovesToLiq]
  │   👁️  Def: public
