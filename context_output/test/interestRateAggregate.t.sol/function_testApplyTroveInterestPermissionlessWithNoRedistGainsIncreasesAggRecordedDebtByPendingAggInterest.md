...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testApplyTroveInterestPermissionlessWithNoRedistGainsIncreasesAggRecordedDebtByPendingAggInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 7)
  │   💬 Args: [B, ATroveId]
  │   👁️  Def: public
