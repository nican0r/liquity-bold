# Function: testSPDepositDoesNotChangeAggWeightedDebtSum()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testSPDepositDoesNotChangeAggWeightedDebtSum() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [weightedDebtSum_1, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 5)
  │   💬 Args: [A, sPdeposit]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 6)
      💬 Args: [weightedDebtSum_2, weightedDebtSum_1]
      👁️  Def: internal
```
