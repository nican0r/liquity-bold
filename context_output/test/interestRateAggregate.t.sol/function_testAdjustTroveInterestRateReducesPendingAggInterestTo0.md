# Function: testAdjustTroveInterestRateReducesPendingAggInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testAdjustTroveInterestRateReducesPendingAggInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
