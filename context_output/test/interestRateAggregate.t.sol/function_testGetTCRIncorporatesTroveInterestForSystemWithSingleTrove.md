# Function: testGetTCRIncorporatesTroveInterestForSystemWithSingleTrove()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testGetTCRIncorporatesTroveInterestForSystemWithSingleTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.calcInterest(uint256,uint256) (NodeID: 4)
  │   💬 Args: [debt * interestRate, 14 days]
  │   👁️  Def: internal
