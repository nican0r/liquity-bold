# Function: testCalcPendingAggInterestReturns0For0TimePassedSinceLastUpdate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCalcPendingAggInterestReturns0For0TimePassedSinceLastUpdate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
