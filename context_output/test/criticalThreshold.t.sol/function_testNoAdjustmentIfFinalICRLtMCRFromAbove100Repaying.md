# Function: testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying()
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
