# Function: testNoNewTrovesWithFinalTCRBelowCT()
...
function testNoNewTrovesWithFinalTCRBelowCT() public {
    ...
    this.openTroveNoHints100pct(C, 2.3 ether, 3000e18, 1e17);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNoNewTrovesWithFinalTCRBelowCT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
