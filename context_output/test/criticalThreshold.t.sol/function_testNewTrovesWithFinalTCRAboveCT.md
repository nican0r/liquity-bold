# Function: testNewTrovesWithFinalTCRAboveCT()
...
function testNewTrovesWithFinalTCRAboveCT() public {
    setUpBelowCT();
    this.openTroveNoHints100pct(C, 100 ether, 10000e18, 1e17);
...
- **CriticalThresholdTest::openTroveNoHints100pct(address,uint256,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNewTrovesWithFinalTCRAboveCT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256,string) (NodeID: 8)
      💬 Args: [troveManager.getTCR(price), CCR, "TCR should be >= CCR"]
      👁️  Def: internal
```
