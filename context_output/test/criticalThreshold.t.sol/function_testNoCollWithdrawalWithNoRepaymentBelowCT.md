# Function: testNoCollWithdrawalWithNoRepaymentBelowCT()
...
- **CriticalThresholdTest::withdrawColl(address,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNoCollWithdrawalWithNoRepaymentBelowCT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
