# Function: testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying()
...
function testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying() public {
    ...
    borrowerOperations.repayBold(BTroveId, 1000e18);
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [_boldAmount, _annualInterestRate]
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 8)
