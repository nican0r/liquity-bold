# Function: test_Curve_CanQuoteApproxDx(bool,uint256)
...
- **ICurveStableSwapNG::get_dx(int128,int128,uint256)**
- **Vm::assume(bool)**
- **IERC20Metadata::balanceOf(address)**
- **IERC20Metadata::approve(address,uint256)**
- **ICurveStableSwapNG::exchange(int128,int128,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: ExchangeHelpersTest.test_Curve_CanQuoteApproxDx(bool,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [dyExpected, 1 ether / dyDiv, 1_000_000 ether / dyDiv]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEqDecimal(uint256,uint256,uint256,string) (NodeID: 104)
  │   💬 Args: [IERC20(outputToken).balanceOf(address(this)) - balance0, dy, dyDecimals, "balance != dy"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqRelDecimal(uint256,uint256,uint256,uint256,string) (NodeID: 105)
      💬 Args: [dy, dyExpected, 1e-5 ether, dyDecimals, "dy !~= expected dy"]
      👁️  Def: internal
```
