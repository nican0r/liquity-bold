...
- **Name**: AnchoredInvariantsTest
- **Type**: Contract
- **Path**: test/AnchoredInvariantsTest.t.sol
...
- **Details**: [function_testWrongYield.md](./function_testWrongYield.md)
...
- **Details**: [function_testRedeemUnderflow.md](./function_testRedeemUnderflow.md)
...
### testWrongYieldPrecision()

- **Signature**: `testWrongYieldPrecision()`
- **Visibility**: external
- **Source Range**: 9264:5627:227
- **Details**: [function_testWrongYieldPrecision.md](./function_testWrongYieldPrecision.md)
...
- **Details**: [function_testSortedTroveSize.md](./function_testSortedTroveSize.md)
...
### testAssertLastZombieTroveInABatchHasMoreThanMinDebt()

- **Signature**: `testAssertLastZombieTroveInABatchHasMoreThanMinDebt()`
- **Visibility**: external
- **Source Range**: 23927:12644:227
- **Details**: [function_testAssertLastZombieTroveInABatchHasMoreThanMinDebt.md](./function_testAssertLastZombieTroveInABatchHasMoreThanMinDebt.md)
