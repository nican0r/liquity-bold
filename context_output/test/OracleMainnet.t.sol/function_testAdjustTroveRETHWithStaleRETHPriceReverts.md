# Function: testAdjustTroveRETHWithStaleRETHPriceReverts()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testAdjustTroveRETHWithStaleRETHPriceReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [trovesCount, 1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: OraclesMainnet.etchStaleMockToRethOracle(bytes) (NodeID: 6)
