# Function: testRETHPriceFeedReturnsLastGoodPriceWhenBothOraclesFail()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testRETHPriceFeedReturnsLastGoodPriceWhenBothOraclesFail() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
