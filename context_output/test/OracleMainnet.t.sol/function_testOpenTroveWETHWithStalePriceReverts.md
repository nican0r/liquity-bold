# Function: testOpenTroveWETHWithStalePriceReverts()
...
function testOpenTroveWETHWithStalePriceReverts() public {
    ...
    contractsArray[0].borrowerOperations.openTrove(A, 0, vars.coll, vars.debtRequest, 0, 0, 5e16, vars.debtRequest, address(0), address(0), address(0));
}
```
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testOpenTroveWETHWithStalePriceReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
