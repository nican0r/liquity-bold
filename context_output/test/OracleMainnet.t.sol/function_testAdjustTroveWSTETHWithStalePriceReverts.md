# Function: testAdjustTroveWSTETHWithStalePriceReverts()
...
function testAdjustTroveWSTETHWithStalePriceReverts() public {
    ...
    vm.startPrank(A);
    uint256 troveId = contractsArray[2].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 5e16, debtRequest, address(0), address(0), address(0));
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testAdjustTroveWSTETHWithStalePriceReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [trovesCount, 1]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: OraclesMainnet.etchStaleMockToStethOracle(bytes) (NodeID: 4)
