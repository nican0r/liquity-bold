# Function: testWSTETHPriceFeedReturnsLastGoodPriceWhenETHUSDOracleFails()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testWSTETHPriceFeedReturnsLastGoodPriceWhenETHUSDOracleFails() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [price2, lastGoodPriceBeforeFail]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 7)
      💬 Args: [lastGoodPriceBeforeFail, wstethPriceFeed.lastGoodPrice()]
      👁️  Def: internal
```
