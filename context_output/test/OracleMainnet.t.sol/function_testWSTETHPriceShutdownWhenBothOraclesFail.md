# Function: testWSTETHPriceShutdownWhenBothOraclesFail()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testWSTETHPriceShutdownWhenBothOraclesFail() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [updatedAt, block.timestamp - 7 days]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 7)
  │   💬 Args: [oracleFailedWhileBranchLive]
  │   👁️  Def: internal
