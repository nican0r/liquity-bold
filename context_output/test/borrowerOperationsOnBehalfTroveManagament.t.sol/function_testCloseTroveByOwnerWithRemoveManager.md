# Function: testCloseTroveByOwnerWithRemoveManager()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testCloseTroveByOwnerWithRemoveManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
