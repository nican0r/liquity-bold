# Function: testCloseTroveByOtherWithRemoveManager()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testCloseTroveByOtherWithRemoveManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 7)
      💬 Args: [address(boldToken), C, troveManager.getTroveEntireDebt(ATroveId)]
      👁️  Def: internal
