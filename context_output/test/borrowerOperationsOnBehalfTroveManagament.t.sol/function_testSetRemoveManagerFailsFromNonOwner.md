# Function: testSetRemoveManagerFailsFromNonOwner()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testSetRemoveManagerFailsFromNonOwner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [manager, address(0), "Wrong Manager"]
  │   👁️  Def: internal
