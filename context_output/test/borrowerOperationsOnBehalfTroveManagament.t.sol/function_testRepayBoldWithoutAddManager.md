# Function: testRepayBoldWithoutAddManager()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testRepayBoldWithoutAddManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(ATroveId), initialDebt - 10e18, "Wrong trove debt"]
  │   👁️  Def: internal
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(ATroveId), initialDebt - 20e18, "Wrong trove debt"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 106)
      💬 Args: [boldToken.balanceOf(B), BInitialBoldBalance - 10e18, "Wrong manager balance"]
      👁️  Def: internal
```
