# Function: testCloseTroveByManagerWithRemoveManager()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testCloseTroveByManagerWithRemoveManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
