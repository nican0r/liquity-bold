# Function: testSetRemoveManagerWithOtherAsReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testSetRemoveManagerWithOtherAsReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
