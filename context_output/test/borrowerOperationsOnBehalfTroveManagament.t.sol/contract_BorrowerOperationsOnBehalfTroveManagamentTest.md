...
- **Name**: BorrowerOperationsOnBehalfTroveManagamentTest
- **Type**: Contract
- **Path**: test/borrowerOperationsOnBehalfTroveManagament.t.sol
...
```solidity
AddRemoveManagersTester internal addRemoveManagersTester
```

**AddRemoveManagersTester**: [test/TestContracts/AddRemoveManagersTester.sol/contract_AddRemoveManagersTester.md]
...
- **Signature**: `testSetAddManager()`
- **Visibility**: public
- **Source Range**: 488:473:300
- **Details**: [function_testSetAddManager.md](./function_testSetAddManager.md)
...
### testCanSetAddManagerOnOpenTrove()

- **Signature**: `testCanSetAddManagerOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 967:663:300
- **Details**: [function_testCanSetAddManagerOnOpenTrove.md](./function_testCanSetAddManagerOnOpenTrove.md)
...
### testSetAddManagerFailsFromNonOwner()

- **Signature**: `testSetAddManagerFailsFromNonOwner()`
- **Visibility**: public
- **Source Range**: 1636:737:300
- **Details**: [function_testSetAddManagerFailsFromNonOwner.md](./function_testSetAddManagerFailsFromNonOwner.md)
...
### testWipeOutAddManager()

- **Signature**: `testWipeOutAddManager()`
- **Visibility**: public
- **Source Range**: 2379:723:300
- **Details**: [function_testWipeOutAddManager.md](./function_testWipeOutAddManager.md)
...
### testCannotReopenTrove()

- **Signature**: `testCannotReopenTrove()`
- **Visibility**: public
- **Source Range**: 3152:1189:300
- **Details**: [function_testCannotReopenTrove.md](./function_testCannotReopenTrove.md)
...
### testSetRemoveManager()

- **Signature**: `testSetRemoveManager()`
- **Visibility**: public
- **Source Range**: 4347:500:300
- **Details**: [function_testSetRemoveManager.md](./function_testSetRemoveManager.md)
...
### testCanSetRemoveManagerOnOpenTrove()

- **Signature**: `testCanSetRemoveManagerOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 4853:789:300
- **Details**: [function_testCanSetRemoveManagerOnOpenTrove.md](./function_testCanSetRemoveManagerOnOpenTrove.md)
...
### testSetRemoveManagerWithRemoveManagerAsReceiver()

- **Signature**: `testSetRemoveManagerWithRemoveManagerAsReceiver()`
- **Visibility**: public
- **Source Range**: 5648:542:300
- **Details**: [function_testSetRemoveManagerWithRemoveManagerAsReceiver.md](./function_testSetRemoveManagerWithRemoveManagerAsReceiver.md)
...
### testCanSetRemoveManagerWithRemoveManagerAsReceiverOnOpenTrove()

- **Signature**: `testCanSetRemoveManagerWithRemoveManagerAsReceiverOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 6196:816:300
- **Details**: [function_testCanSetRemoveManagerWithRemoveManagerAsReceiverOnOpenTrove.md](./function_testCanSetRemoveManagerWithRemoveManagerAsReceiverOnOpenTrove.md)
...
### testSetRemoveManagerWithOtherAsReceiver()

- **Signature**: `testSetRemoveManagerWithOtherAsReceiver()`
- **Visibility**: public
- **Source Range**: 7018:534:300
- **Details**: [function_testSetRemoveManagerWithOtherAsReceiver.md](./function_testSetRemoveManagerWithOtherAsReceiver.md)
...
### testCanSetRemoveManagerWithOtherAsReceiverOnOpenTrove()

- **Signature**: `testCanSetRemoveManagerWithOtherAsReceiverOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 7558:808:300
- **Details**: [function_testCanSetRemoveManagerWithOtherAsReceiverOnOpenTrove.md](./function_testCanSetRemoveManagerWithOtherAsReceiverOnOpenTrove.md)
...
### testSetRemoveManagerWithZeroReceiver()

- **Signature**: `testSetRemoveManagerWithZeroReceiver()`
- **Visibility**: public
- **Source Range**: 8372:512:300
- **Details**: [function_testSetRemoveManagerWithZeroReceiver.md](./function_testSetRemoveManagerWithZeroReceiver.md)
...
### testSetRemoveManagerWithZeroReceiverOnOpenTrove()

- **Signature**: `testSetRemoveManagerWithZeroReceiverOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 8890:783:300
- **Details**: [function_testSetRemoveManagerWithZeroReceiverOnOpenTrove.md](./function_testSetRemoveManagerWithZeroReceiverOnOpenTrove.md)
...
### testCanWipeOutRemoveManager()

- **Signature**: `testCanWipeOutRemoveManager()`
- **Visibility**: public
- **Source Range**: 9679:947:300
- **Details**: [function_testCanWipeOutRemoveManager.md](./function_testCanWipeOutRemoveManager.md)
...
### testSetRemoveManagerFailsFromNonOwner()

- **Signature**: `testSetRemoveManagerFailsFromNonOwner()`
- **Visibility**: public
- **Source Range**: 10632:1012:300
- **Details**: [function_testSetRemoveManagerFailsFromNonOwner.md](./function_testSetRemoveManagerFailsFromNonOwner.md)
...
### testAddCollWithAddManager()

- **Signature**: `testAddCollWithAddManager()`
- **Visibility**: public
- **Source Range**: 11650:1758:300
- **Details**: [function_testAddCollWithAddManager.md](./function_testAddCollWithAddManager.md)
...
### testAddCollWithoutAddManager()

- **Signature**: `testAddCollWithoutAddManager()`
- **Visibility**: public
- **Source Range**: 13414:975:300
- **Details**: [function_testAddCollWithoutAddManager.md](./function_testAddCollWithoutAddManager.md)
...
### testWithdrawCollWithRemoveManager()

- **Signature**: `testWithdrawCollWithRemoveManager()`
- **Visibility**: public
- **Source Range**: 14395:1244:300
- **Details**: [function_testWithdrawCollWithRemoveManager.md](./function_testWithdrawCollWithRemoveManager.md)
...
### testWithdrawCollWithoutRemoveManager()

- **Signature**: `testWithdrawCollWithoutRemoveManager()`
- **Visibility**: public
- **Source Range**: 15645:1533:300
- **Details**: [function_testWithdrawCollWithoutRemoveManager.md](./function_testWithdrawCollWithoutRemoveManager.md)
...
### testRepayBoldWithAddManager()

- **Signature**: `testRepayBoldWithAddManager()`
- **Visibility**: public
- **Source Range**: 17184:1982:300
- **Details**: [function_testRepayBoldWithAddManager.md](./function_testRepayBoldWithAddManager.md)
...
### testRepayBoldWithoutAddManager()

- **Signature**: `testRepayBoldWithoutAddManager()`
- **Visibility**: public
- **Source Range**: 19172:1128:300
- **Details**: [function_testRepayBoldWithoutAddManager.md](./function_testRepayBoldWithoutAddManager.md)
...
### testWithdrawBoldWithRemoveManager()

- **Signature**: `testWithdrawBoldWithRemoveManager()`
- **Visibility**: public
- **Source Range**: 20306:853:300
- **Details**: [function_testWithdrawBoldWithRemoveManager.md](./function_testWithdrawBoldWithRemoveManager.md)
...
### testWithdrawBoldWithoutRemoveManager()

- **Signature**: `testWithdrawBoldWithoutRemoveManager()`
- **Visibility**: public
- **Source Range**: 21165:1090:300
- **Details**: [function_testWithdrawBoldWithoutRemoveManager.md](./function_testWithdrawBoldWithoutRemoveManager.md)
...
### testCloseTroveByOwnerWithRemoveManager()

- **Signature**: `testCloseTroveByOwnerWithRemoveManager()`
- **Visibility**: public
- **Source Range**: 22281:898:300
- **Details**: [function_testCloseTroveByOwnerWithRemoveManager.md](./function_testCloseTroveByOwnerWithRemoveManager.md)
...
### testCloseTroveByManagerWithRemoveManager()

- **Signature**: `testCloseTroveByManagerWithRemoveManager()`
- **Visibility**: public
- **Source Range**: 23185:1052:300
- **Details**: [function_testCloseTroveByManagerWithRemoveManager.md](./function_testCloseTroveByManagerWithRemoveManager.md)
...
### testCloseTroveByOtherWithRemoveManager()

- **Signature**: `testCloseTroveByOtherWithRemoveManager()`
- **Visibility**: public
- **Source Range**: 24243:716:300
- **Details**: [function_testCloseTroveByOtherWithRemoveManager.md](./function_testCloseTroveByOtherWithRemoveManager.md)
...
### testCloseTroveWithoutRemoveManager()

- **Signature**: `testCloseTroveWithoutRemoveManager()`
- **Visibility**: public
- **Source Range**: 24965:1613:300
- **Details**: [function_testCloseTroveWithoutRemoveManager.md](./function_testCloseTroveWithoutRemoveManager.md)
...
- **Details**: [function__testReceiver_address_address_address_address_address.md](./function__testReceiver_address_address_address_address_address.md)
...
### testReceiverForRemoveManager()

- **Signature**: `testReceiverForRemoveManager()`
- **Visibility**: public
- **Source Range**: 27153:559:300
- **Details**: [function_testReceiverForRemoveManager.md](./function_testReceiverForRemoveManager.md)
