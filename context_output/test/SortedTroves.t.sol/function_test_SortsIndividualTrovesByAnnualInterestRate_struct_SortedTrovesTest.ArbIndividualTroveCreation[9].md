# Function: test_SortsIndividualTrovesByAnnualInterestRate(struct SortedTrovesTest.ArbIndividualTroveCreation[9])
...
```
┌─ [0] ⚙️ FUNCTION: SortedTrovesTest.test_SortsIndividualTrovesByAnnualInterestRate(struct SortedTrovesTest.ArbIndividualTroveCreation[9]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: SortedTrovesTest._buildList(struct SortedTrovesTest.ArbIndividualTroveCreation[9]) (NodeID: 1)
  │   💬 Args: [troves]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickHints(struct SortedTrovesTest.ArbHints) (NodeID: 2)
  │     💬 Args: [troves[i].hints]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 3)
  │   │   💬 Args: [troveCount, hints.prev]
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 4)
  │   │     💬 Args: [i, 0, (troveCount * 2) + 1]
  │   │     👁️  Def: internal
  │   │   ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 5)
  │   │   │   💬 Args: [x, min, max]
  │   │   │   👁️  Def: internal
  │   │   └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 6)
  │   │       💬 Args: ["Bound result", result]
  │   │       👁️  Def: private
  │   │     └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 7)
  │   │         💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │   │         👁️  Def: internal
  │   │       └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 8)
  ...
  │               💬 Args: [_sendLogPayloadView]
  │               👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SortedTrovesTest._checkOrdering() (NodeID: 15)
      💬 Args: [no args]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 16)
    │   💬 Args: [curr]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 17)
    │   💬 Args: [tm.getTroveCount(), 0, "SortedTroves forward node count doesn't match TroveManager"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 18)
    │   💬 Args: [tm._sortedTroves_getLast(), TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 19)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log() (NodeID: 20)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string,uint256,string,uint256) (NodeID: 26)
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotEndOfList(TroveId) (NodeID: 29)
    │   💬 Args: [curr]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 30)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string,uint256,string,uint256) (NodeID: 31)
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256,string) (NodeID: 34)
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 42)
    │   💬 Args: ["  Trove", TroveId.unwrap(curr)]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 43)
    │     💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 44)
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertNe(TroveId,TroveId,string) (NodeID: 45)
    │   💬 Args: [curr, TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 46)
    │     💬 Args: [a != b, err]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 47)
    │   💬 Args: [curr, troveIds[--i], "SortedTroves reverse ordering is broken"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 48)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 52)
        💬 Args: [curr, TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 53)
          💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
          👁️  Def: internal
```
