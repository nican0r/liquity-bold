# Function: test_CanRemoveBatchedTroves(struct SortedTrovesTest.ArbBatchedTroveCreation[9],uint256[9],uint256)
...
- **Signature**: `test_CanRemoveBatchedTroves(struct SortedTrovesTest.ArbBatchedTroveCreation[9],uint256[9],uint256)`
- **Visibility**: public
- **Source Range**: 18312:917:247

## Implementation

```solidity
function test_CanRemoveBatchedTroves(ArbBatchedTroveCreation[FUZZ_INPUT_LENGTH] calldata troves, uint256[FUZZ_INPUT_LENGTH] calldata removedTroves, uint256 numTrovesToRemove) public {
...
- **MockTroveManager::_getBatchOf(TroveId)**
- **MockTroveManager::_removeTrove(TroveId)**
- **MockTroveManager::_sortedTroves_removeFromBatch(TroveId)**
...
```
┌─ [0] ⚙️ FUNCTION: SortedTrovesTest.test_CanRemoveBatchedTroves(struct SortedTrovesTest.ArbBatchedTroveCreation[9],uint256[9],uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SortedTrovesTest._buildBatchedList(struct SortedTrovesTest.ArbBatchedTroveCreation[9]) (NodeID: 6)
  │   💬 Args: [troves]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickRole(uint256) (NodeID: 7)
  │ │   💬 Args: [troves[i].role]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 8)
  │ │     💬 Args: [role, uint256(type(ArbRole).min), uint256(type(ArbRole).max)]
  │ │     👁️  Def: internal
  │ │   ├─ [4] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 9)
  │ │   │   💬 Args: [x, min, max]
  │ │   │   👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 10)
  │ │       💬 Args: ["Bound result", result]
  │ │       👁️  Def: private
  ...
  │ │           💬 Args: [_sendLogPayloadView]
  │ │           👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickHints(struct SortedTrovesTest.ArbHints) (NodeID: 13)
  │ │   💬 Args: [troves[i].hints]
  │ │   👁️  Def: internal
  ...
  │ │ │           💬 Args: [_sendLogPayloadView]
  │ │ │           👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 20)
  │ │     💬 Args: [troveCount, hints.next]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 21)
  │ │       💬 Args: [i, 0, (troveCount * 2) + 1]
  │ │       👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 22)
  │ │     │   💬 Args: [x, min, max]
  │ │     │   👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 23)
  │ │         💬 Args: ["Bound result", result]
  │ │         👁️  Def: private
  │ │       └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 24)
  │ │           💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │ │           👁️  Def: internal
  │ │         └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 25)
  │ │             💬 Args: [_sendLogPayloadView]
  │ │             👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickHints(struct SortedTrovesTest.ArbHints) (NodeID: 26)
  │ │   💬 Args: [troves[i].hints]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 27)
  │ │ │   💬 Args: [troveCount, hints.prev]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 28)
  │ │ │     💬 Args: [i, 0, (troveCount * 2) + 1]
  │ │ │     👁️  Def: internal
  │ │ │   ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 29)
  │ │ │   │   💬 Args: [x, min, max]
  │ │ │   │   👁️  Def: internal
  │ │ │   └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 30)
  │ │ │       💬 Args: ["Bound result", result]
  │ │ │       👁️  Def: private
  │ │ │     └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 31)
  │ │ │         💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │ │ │         👁️  Def: internal
  │ │ │       └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 32)
  │ │ │           💬 Args: [_sendLogPayloadView]
  │ │ │           👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 33)
  │ │     💬 Args: [troveCount, hints.next]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 34)
  │ │       💬 Args: [i, 0, (troveCount * 2) + 1]
  │ │       👁️  Def: internal
  │ │     ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 35)
  │ │     │   💬 Args: [x, min, max]
  │ │     │   👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 36)
  │ │         💬 Args: ["Bound result", result]
  │ │         👁️  Def: private
  │ │       └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 37)
  │ │           💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │ │           👁️  Def: internal
  │ │         └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 38)
  │ │             💬 Args: [_sendLogPayloadView]
  │ │             👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickBatch(uint256) (NodeID: 39)
  │ │   💬 Args: [troves[i].batch]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 40)
  │ │     💬 Args: [batch, 0, tm._getBatchCount() - 1]
  │ │     👁️  Def: internal
  │ │   ├─ [4] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 41)
  │ │   │   💬 Args: [x, min, max]
  │ │   │   👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 42)
  │ │       💬 Args: ["Bound result", result]
  │ │       👁️  Def: private
  ...
  │ │           💬 Args: [_sendLogPayloadView]
  │ │           👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SortedTrovesTest._pickHints(struct SortedTrovesTest.ArbHints) (NodeID: 45)
  │     💬 Args: [troves[i].hints]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 46)
  │   │   💬 Args: [troveCount, hints.prev]
  │   │   👁️  Def: internal
  │   │ └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 47)
  │   │     💬 Args: [i, 0, (troveCount * 2) + 1]
  │   │     👁️  Def: internal
  │   │   ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 48)
  │   │   │   💬 Args: [x, min, max]
  │   │   │   👁️  Def: internal
  │   │   └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 49)
  │   │       💬 Args: ["Bound result", result]
  │   │       👁️  Def: private
  │   │     └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 50)
  │   │         💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │   │         👁️  Def: internal
  │   │       └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 51)
  │   │           💬 Args: [_sendLogPayloadView]
  │   │           👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: SortedTrovesTest._pickHint(uint256,uint256) (NodeID: 52)
  │       💬 Args: [troveCount, hints.next]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 53)
  │         💬 Args: [i, 0, (troveCount * 2) + 1]
  │         👁️  Def: internal
  │       ├─ [5] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 54)
  │       │   💬 Args: [x, min, max]
  │       │   👁️  Def: internal
  │       └─ [5] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 55)
  │           💬 Args: ["Bound result", result]
  │           👁️  Def: private
  │         └─ [6] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 56)
  │             💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
  │             👁️  Def: internal
  │           └─ [7] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 57)
  │               💬 Args: [_sendLogPayloadView]
  │               👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 58)
  │   💬 Args: [tm._sortedTroves_getSize(), troves.length]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SortedTrovesTest._pickTrove(uint256) (NodeID: 59)
  │   💬 Args: [removedTroves[i]]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 60)
  │     💬 Args: [trove, 0, tm.getTroveCount() - 1]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 61)
  │   │   💬 Args: [x, min, max]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 62)
  │       💬 Args: ["Bound result", result]
  │       👁️  Def: private
  ...
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Unknown.isNotZero(BatchId) (NodeID: 65)
  │   💬 Args: [tm._getBatchOf(id)]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Unknown.isZero(BatchId) (NodeID: 66)
  │     💬 Args: [x]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 67)
  │   💬 Args: [tm._sortedTroves_getSize(), troves.length - numTrovesToRemove]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: SortedTrovesTest._checkOrdering() (NodeID: 68)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 69)
  │ │   💬 Args: [curr]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 70)
  │ │   💬 Args: [tm.getTroveCount(), 0, "SortedTroves forward node count doesn't match TroveManager"]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 71)
  │ │   💬 Args: [tm._sortedTroves_getLast(), TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 72)
  │ │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log() (NodeID: 73)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 74)
  │ │     💬 Args: [abi.encodeWithSignature("log()")]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 75)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log(string) (NodeID: 76)
  │ │   💬 Args: ["Forward list:"]
  │ │   👁️  Def: internal
  ...
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log(string,uint256,string,uint256) (NodeID: 79)
  │ │   💬 Args: ["  Trove", TroveId.unwrap(curr), "annualInterestRate", prevAnnualInterestRate]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 80)
  │ │     💬 Args: [abi.encodeWithSignature("log(string,uint256,string,uint256)", p0, p1, p2, p3)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 81)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.isNotEndOfList(TroveId) (NodeID: 82)
  │ │   💬 Args: [curr]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 83)
  │ │     💬 Args: [x]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log(string,uint256,string,uint256) (NodeID: 84)
  │ │   💬 Args: ["  Trove", TroveId.unwrap(curr), "annualInterestRate", currAnnualInterestRate]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 85)
  │ │     💬 Args: [abi.encodeWithSignature("log(string,uint256,string,uint256)", p0, p1, p2, p3)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 86)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256,string) (NodeID: 87)
  │ │   💬 Args: [currAnnualInterestRate, prevAnnualInterestRate, "SortedTroves ordering is broken"]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 88)
  │ │   💬 Args: [i, tm.getTroveCount(), "SortedTroves forward node count doesn't match TroveManager"]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log() (NodeID: 89)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 90)
  │ │     💬 Args: [abi.encodeWithSignature("log()")]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 91)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log(string) (NodeID: 92)
  │ │   💬 Args: ["Reverse list:"]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 93)
  │ │     💬 Args: [abi.encodeWithSignature("log(string)", p0)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 94)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log(string,uint256) (NodeID: 95)
  ...
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertNe(TroveId,TroveId,string) (NodeID: 98)
  │ │   💬 Args: [curr, TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 99)
  │ │     💬 Args: [a != b, err]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 100)
  │ │   💬 Args: [curr, troveIds[--i], "SortedTroves reverse ordering is broken"]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
  │ │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: console.log() (NodeID: 102)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 103)
  │ │     💬 Args: [abi.encodeWithSignature("log()")]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 104)
  │ │       💬 Args: [_sendLogPayloadView]
  │ │       👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 105)
  │     💬 Args: [curr, TROVE_ID_END_OF_LIST, "SortedTroves reverse node count doesn't match TroveManager"]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 106)
  │       💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: SortedTrovesTest._checkBatchContiguity() (NodeID: 107)
      💬 Args: [no args]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 108)
    │   💬 Args: [prev]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string) (NodeID: 109)
    │   💬 Args: ["Batch IDs:"]
    │   👁️  Def: internal
    ...
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string,address) (NodeID: 112)
    │   💬 Args: ["  ", BatchId.unwrap(prevBatch)]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 113)
    │     💬 Args: [abi.encodeWithSignature("log(string,address)", p0, p1)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 114)
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotZero(BatchId) (NodeID: 115)
    │   💬 Args: [prevBatch]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isZero(BatchId) (NodeID: 116)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 117)
    │   💬 Args: [prev, tm._sortedTroves_getBatchHead(prevBatch), "Wrong batch head"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 118)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotEndOfList(TroveId) (NodeID: 119)
    │   💬 Args: [curr]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isEndOfList(TroveId) (NodeID: 120)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: console.log(string,address) (NodeID: 121)
    │   💬 Args: ["  ", BatchId.unwrap(currBatch)]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 122)
    │     💬 Args: [abi.encodeWithSignature("log(string,address)", p0, p1)]
    │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 123)
    │       💬 Args: [_sendLogPayloadView]
    │       👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotZero(BatchId) (NodeID: 124)
    │   💬 Args: [prevBatch]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isZero(BatchId) (NodeID: 125)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 126)
    │   💬 Args: [seenBatches.has(prevBatch), "Batch already seen"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 127)
    │   💬 Args: [prev, tm._sortedTroves_getBatchTail(prevBatch), "Wrong batch tail"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 128)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotZero(BatchId) (NodeID: 129)
    │   💬 Args: [currBatch]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isZero(BatchId) (NodeID: 130)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 131)
    │   💬 Args: [curr, tm._sortedTroves_getBatchHead(currBatch), "Wrong batch head"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 132)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: Unknown.isNotZero(BatchId) (NodeID: 133)
    │   💬 Args: [prevBatch]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: Unknown.isZero(BatchId) (NodeID: 134)
    │     💬 Args: [x]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 135)
    │   💬 Args: [seenBatches.has(prevBatch), "Batch already seen"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: SortedTrovesTest.assertEq(TroveId,TroveId,string) (NodeID: 136)
    │   💬 Args: [prev, tm._sortedTroves_getBatchTail(prevBatch), "Wrong batch tail"]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 137)
    │     💬 Args: [TroveId.unwrap(a), TroveId.unwrap(b), err]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: console.log() (NodeID: 138)
        💬 Args: [no args]
        👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 139)
          💬 Args: [abi.encodeWithSignature("log()")]
          👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 140)
            💬 Args: [_sendLogPayloadView]
            👁️  Def: internal
```
