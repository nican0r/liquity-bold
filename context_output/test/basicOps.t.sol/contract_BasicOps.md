...
### testOpenTroveFailsWithoutAllowance()

- **Signature**: `testOpenTroveFailsWithoutAllowance()`
- **Visibility**: public
- **Source Range**: 142:364:297
- **Details**: [function_testOpenTroveFailsWithoutAllowance.md](./function_testOpenTroveFailsWithoutAllowance.md)
...
### testOpenTroveFailsWithoutBalance()

- **Signature**: `testOpenTroveFailsWithoutBalance()`
- **Visibility**: public
- **Source Range**: 512:433:297
- **Details**: [function_testOpenTroveFailsWithoutBalance.md](./function_testOpenTroveFailsWithoutBalance.md)
...
- **Details**: [function_testOpenTrove.md](./function_testOpenTrove.md)
...
- **Details**: [function_testCloseTrove.md](./function_testCloseTrove.md)
...
- **Details**: [function_testAdjustTrove.md](./function_testAdjustTrove.md)
...
- **Details**: [function_testRedeem.md](./function_testRedeem.md)
...
- **Details**: [function_testLiquidation.md](./function_testLiquidation.md)
...
- **Details**: [function_testSPDeposit.md](./function_testSPDeposit.md)
...
- **Details**: [function_testSPWithdrawal.md](./function_testSPWithdrawal.md)
