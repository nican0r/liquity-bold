# Function: testChangeBatchInterestRateUpdatesBatchWeightedMgmtFeeCorrectly()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testChangeBatchInterestRateUpdatesBatchWeightedMgmtFeeCorrectly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
