# Function: testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithCloseTrove()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithCloseTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 13)
      💬 Args: [entireSystemDebt, entireDebtA, 2]
      👁️  Def: internal
```
