# Function: testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithRedemption()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithRedemption() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [20e16, _annualInterestRate]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 11)
  │   💬 Args: [A, 1000e18]
  │   👁️  Def: public
