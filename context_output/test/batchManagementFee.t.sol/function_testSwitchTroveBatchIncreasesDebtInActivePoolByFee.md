# Function: testSwitchTroveBatchIncreasesDebtInActivePoolByFee()
...
function testSwitchTroveBatchIncreasesDebtInActivePoolByFee() public {
    ...
    assertApproxEqAbs(activePool.aggRecordedDebt(), ((((activePoolInitialDebt + batchBAccruedInterest) + batchBAccruedManagementFee) + batchDAccruedInterest) + batchDAccruedManagementFee) + upfrontFee, 10);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testSwitchTroveBatchIncreasesDebtInActivePoolByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 14)
      💬 Args: [activePool.aggRecordedDebt(), ((((activePoolInitialDebt + batchBAccruedInterest) + batchBAccruedManagementFee) + batchDAccruedInterest) + batchDAccruedManagementFee) + upfrontFee, 10]
      👁️  Def: internal
```
