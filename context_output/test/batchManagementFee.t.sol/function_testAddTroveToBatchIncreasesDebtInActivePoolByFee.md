# Function: testAddTroveToBatchIncreasesDebtInActivePoolByFee()
...
function testAddTroveToBatchIncreasesDebtInActivePoolByFee() public {
    ...
    assertApproxEqAbs(activePool.aggRecordedDebt(), (((activePoolInitialDebt + batchAccruedInterest) + batchAccruedManagementFee) + troveAccruedInterest) + upfrontFee, 10);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testAddTroveToBatchIncreasesDebtInActivePoolByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveId, B]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setInterestBatchManager(address,uint256,address) (NodeID: 10)
  │   💬 Args: [C, troveId, B]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 11)
      💬 Args: [activePool.aggRecordedDebt(), (((activePoolInitialDebt + batchAccruedInterest) + batchAccruedManagementFee) + troveAccruedInterest) + upfrontFee, 10]
      👁️  Def: internal
```
