# Function: testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithLiquidateTroveRedistribute()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testAfterBatchManagementFeeAccrualEntireSystemDebtMatchesWithLiquidateTroveRedistribute() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [20e16, _annualInterestRate]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 11)
  │   💬 Args: [A, CTroveId]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 12)
      💬 Args: [entireSystemDebt, entireDebtA, 100]
      👁️  Def: internal
```
