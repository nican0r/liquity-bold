...
- **Name**: SPInvariantsTest
- **Type**: Contract
- **Path**: test/SPInvariants.t.sol
...
### stabilityPool (inherited from SPInvariantsBase)
...
### handler (inherited from SPInvariantsBase)
...
- **Details**: [function_invariant_AllFundsClaimable.md](./function_invariant_AllFundsClaimable.md)
...
### setUp() (inherited from BaseInvariantTest)
