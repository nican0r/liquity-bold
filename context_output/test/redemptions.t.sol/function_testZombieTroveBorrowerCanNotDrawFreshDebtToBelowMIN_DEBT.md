# Function: testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT()
...
### findAmountToBorrowWithAdjustTrove(uint256,uint256)

- **Kind**: internal
- **Source**: 5638:946:254
- **Link**: `test/TestContracts/BaseTest.sol:BaseTest:findAmountToBorrowWithAdjustTrove(uint256,uint256)`

```solidity
function findAmountToBorrowWithAdjustTrove(uint256 troveId, uint256 targetDebt) internal view returns (uint256 borrow, uint256 upfrontFee) {
...
- **Redemptions::adjustZombieTrove(address,uint256,uint256,bool,uint256,bool)**
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.findAmountToBorrowWithAdjustTrove(uint256,uint256) (NodeID: 46)
  │   💬 Args: [troveIDs.A, MIN_DEBT - debtDeficiency]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 47)
  │ │   💬 Args: [troveId, borrowRight]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 48)
  │     💬 Args: [troveId, borrow]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.findAmountToBorrowWithAdjustTrove(uint256,uint256) (NodeID: 49)
      💬 Args: [troveIDs.B, MIN_DEBT - debtDeficiency]
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 50)
    │   💬 Args: [troveId, borrowRight]
    │   👁️  Def: internal
