# Function: testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 46)
  │   💬 Args: [troveManager.troveIsStale(troveIDs.A)]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 49)
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 50)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 51)
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.B)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 52)
  ...
  │   💬 Args: [troveManager.calcTroveAccruedInterest(troveIDs.B), 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 56)
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 57)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 58)
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.B)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 59)
      💬 Args: [sortedTroves.contains(troveIDs.B)]
      👁️  Def: internal
```
