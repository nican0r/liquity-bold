# Function: testRedemption1TroveLeavesCollFeeInActivePool()
...
- **ITroveManagerTester::getEffectiveRedemptionFeeInColl(uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemption1TroveLeavesCollFeeInActivePool() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 45)
  │   💬 Args: [E, redeemAmount]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 46)
  │   💬 Args: [collToken.balanceOf(address(activePool)), activePoolBalBefore - expectedCollDelta]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 47)
      💬 Args: [activePool.getCollBalance(), activePoolCollTrackerBefore - expectedCollDelta]
      👁️  Def: internal
```
