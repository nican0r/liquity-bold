# Function: testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 46)
  │   💬 Args: [E, troveColl_E, troveDebtRequest_E, interestRate_E]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 47)
  │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
  │     👁️  Def: public
  ...
  │   💬 Args: [troveManager.getCurrentICR(troveID_E, price), MCR]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 50)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.A), MIN_DEBT]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 51)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 52)
  │   💬 Args: [A, troveID_E]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 53)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveID_E)), uint8(ITroveManager.Status.closedByLiquidation)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 54)
  │   💬 Args: [troveManager.hasRedistributionGains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 55)
  │   💬 Args: [troveManager.hasRedistributionGains(troveIDs.B)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 56)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.A), MIN_DEBT]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 57)
      💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT]
      👁️  Def: internal
```
