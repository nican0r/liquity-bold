# Function: testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
