# Function: testZombieTroveCanStillBeRedeemedFrom()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveCanStillBeRedeemedFrom() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debt_B, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 47)
  │   💬 Args: [E, redeemAmount]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 48)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), debt_B - redeemAmount]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 49)
  │   💬 Args: [E, redeemAmount]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 50)
