# Function: testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debtDelta_A, 0, "A delta should be positive"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 49)
  │   💬 Args: [debtDelta_B, 0, "B delta should be positive"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.adjustZombieTrove(address,uint256,uint256,bool,uint256,bool) (NodeID: 50)
  │   💬 Args: [A, troveIDs.A, 0, false, debtDelta_A + surplusDebt, true]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 51)
  │     💬 Args: [_troveId, _isDebtIncrease ? _boldChange : 0]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.adjustZombieTrove(address,uint256,uint256,bool,uint256,bool) (NodeID: 52)
  │   💬 Args: [B, troveIDs.B, 0, false, debtDelta_A + surplusDebt, true]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 53)
  │     💬 Args: [_troveId, _isDebtIncrease ? _boldChange : 0]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 54)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.A), MIN_DEBT, "A debt should be above min"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 55)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT, "B debt should be above min"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 56)
  │   💬 Args: [troveManager.calcTroveAccruedInterest(troveIDs.A), 0]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 57)
      💬 Args: [troveManager.calcTroveAccruedInterest(troveIDs.B), 0]
      👁️  Def: internal
```
