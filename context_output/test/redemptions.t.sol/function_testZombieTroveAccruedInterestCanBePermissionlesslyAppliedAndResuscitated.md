# Function: testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 48)
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 49)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 50)
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 52)
  │   💬 Args: [E, troveIDs.B]
  │   👁️  Def: public
  ...
  │   💬 Args: [troveManager.checkTroveIsZombie(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 56)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
