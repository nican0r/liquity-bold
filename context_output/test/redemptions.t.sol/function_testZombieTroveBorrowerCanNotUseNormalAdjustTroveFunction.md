# Function: testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction()
...
- **Redemptions::adjustTrove100pct(address,uint256,uint256,uint256,bool,bool)**
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
