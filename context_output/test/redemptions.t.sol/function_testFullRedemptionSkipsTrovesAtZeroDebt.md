# Function: testFullRedemptionSkipsTrovesAtZeroDebt()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testFullRedemptionSkipsTrovesAtZeroDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 42)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 43)
  │   💬 Args: [E, redeemAmount_2]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 44)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 45)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.B)), uint8(ITroveManager.Status.zombie)]
  │   👁️  Def: internal
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 48)
