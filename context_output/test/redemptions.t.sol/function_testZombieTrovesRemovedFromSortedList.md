# Function: testZombieTrovesRemovedFromSortedList()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovesRemovedFromSortedList() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 40)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 41)
  │   💬 Args: [sortedTroves.contains(troveIDs.B)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 42)
  │   💬 Args: [sortedTroves.contains(troveIDs.C)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 43)
  │   💬 Args: [sortedTroves.contains(troveIDs.D)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: DevTestSetup._redeemAndCreateZombieTrovesAAndB(struct BaseTest.ABCDEF) (NodeID: 44)
  │   💬 Args: [troveIDs]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 45)
  │ │   💬 Args: [E, redeemAmount]
  │ │   👁️  Def: public
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 46)
  │ │   💬 Args: [troveManager.getTroveEntireDebt(_troveIDs.A), 0]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 47)
  │ │   💬 Args: [troveManager.getTroveEntireDebt(_troveIDs.B), MIN_DEBT]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 48)
  │ │   💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 49)
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 50)
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 51)
  │   💬 Args: [sortedTroves.contains(troveIDs.B)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 52)
  │   💬 Args: [sortedTroves.contains(troveIDs.C)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 53)
  │   💬 Args: [sortedTroves.contains(troveIDs.C)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 54)
  │   💬 Args: [sortedTroves.getLast(), troveIDs.C]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 55)
      💬 Args: [troveManager.lastZombieTroveId(), troveIDs.B, "Wrong last zombie trove pointer"]
      👁️  Def: internal
```
