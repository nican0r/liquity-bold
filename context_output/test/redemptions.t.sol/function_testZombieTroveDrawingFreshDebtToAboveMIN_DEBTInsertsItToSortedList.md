# Function: testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debtDelta_B, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 48)
  ...
  │   💬 Args: [sortedTroves.contains(troveIDs.A)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 57)
      💬 Args: [sortedTroves.contains(troveIDs.B)]
      👁️  Def: internal
```
