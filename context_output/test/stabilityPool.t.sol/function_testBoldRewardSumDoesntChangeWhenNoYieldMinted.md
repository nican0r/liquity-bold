# Function: testBoldRewardSumDoesntChangeWhenNoYieldMinted()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumDoesntChangeWhenNoYieldMinted() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [pendingAggInterest, 0, "Pending interest should be zero"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 25)
  │   💬 Args: [boldRewardSum_1, 0, "BOLD reward sum 1"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.repayBold(address,uint256,uint256) (NodeID: 26)
  │   💬 Args: [B, troveIDs.B, 1_000 ether]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 27)
      💬 Args: [boldRewardSum_2, boldRewardSum_1, "BOLD reward sum 2"]
      👁️  Def: internal
```
