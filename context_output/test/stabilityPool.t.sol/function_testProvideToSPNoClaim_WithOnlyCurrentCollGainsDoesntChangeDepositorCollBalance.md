# Function: testProvideToSPNoClaim_WithOnlyCurrentCollGainsDoesntChangeDepositorCollBalance()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaim_WithOnlyCurrentCollGainsDoesntChangeDepositorCollBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
