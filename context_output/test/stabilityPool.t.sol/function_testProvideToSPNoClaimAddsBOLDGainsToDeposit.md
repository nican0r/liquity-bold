# Function: testProvideToSPNoClaimAddsBOLDGainsToDeposit()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaimAddsBOLDGainsToDeposit() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 27)
      💬 Args: [stabilityPool.getCompoundedBoldDeposit(A), (depositBefore_A + topUp) + currentBoldGain, 1e4]
      👁️  Def: public
