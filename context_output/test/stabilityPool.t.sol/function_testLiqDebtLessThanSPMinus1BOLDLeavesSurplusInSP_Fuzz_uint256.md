# Function: testLiqDebtLessThanSPMinus1BOLDLeavesSurplusInSP_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiqDebtLessThanSPMinus1BOLDLeavesSurplusInSP_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [_surplusToLeaveInSP, 1e18, 2000e18]
  │   👁️  Def: internal
  ...
  │   💬 Args: [_surplusToLeaveInSP, 1e18]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositNoClaim(address,uint256) (NodeID: 16)
  │   💬 Args: [A, toSP]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256) (NodeID: 17)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIdB), stabilityPool.getTotalBoldDeposits() - 1e18]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 18)
  │   💬 Args: [A, troveIdB]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 19)
  │   💬 Args: [stabilityPool.getTotalBoldDeposits(), _surplusToLeaveInSP]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256) (NodeID: 20)
  │   💬 Args: [stabilityPool.getCompoundedBoldDeposit(A), stabilityPool.getTotalBoldDeposits()]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 21)
