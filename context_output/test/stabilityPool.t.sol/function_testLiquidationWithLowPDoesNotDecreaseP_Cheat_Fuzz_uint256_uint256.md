# Function: testLiquidationWithLowPDoesNotDecreaseP_Cheat_Fuzz(uint256,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiquidationWithLowPDoesNotDecreaseP_Cheat_Fuzz(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, troveIDs.D]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 35)
  │   💬 Args: [scale2, scale1, "scale didnt change"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256) (NodeID: 36)
      💬 Args: [stabilityPool.P(), 1e27]
      👁️  Def: internal
```
