# Function: testBoldRewardsOwedIncreasesWhenDepositToppedUp()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenDepositToppedUp() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 29)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
