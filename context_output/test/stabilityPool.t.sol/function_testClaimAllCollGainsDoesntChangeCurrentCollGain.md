# Function: testClaimAllCollGainsDoesntChangeCurrentCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testClaimAllCollGainsDoesntChangeCurrentCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 29)
      💬 Args: [stabilityPool.getDepositorCollGain(A), 0]
      👁️  Def: internal
```
