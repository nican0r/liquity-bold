# Function: testGetDepositorBoldGain_1SPDepositor1RewardEvent_EarnsAllSPYield()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testGetDepositorBoldGain_1SPDepositor1RewardEvent_EarnsAllSPYield() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 31)
      💬 Args: [stabilityPool.getDepositorYieldGain(A), expectedSpYield, 1e4]
      👁️  Def: public
