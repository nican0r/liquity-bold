# Function: testBoldRewardsOwedIncreasesWhenRedemptionOccurs()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenRedemptionOccurs() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 27)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 28)
  │   💬 Args: [collToken.balanceOf(A), wethBalBefore_A]
  │   👁️  Def: internal
