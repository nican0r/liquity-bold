# Function: testBoldRewardSumIncreasesWhenTroveOpened()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenTroveOpened() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 26)
  │   💬 Args: [E, 3 ether, 2000e18, 25e16]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 27)
  │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
  │     👁️  Def: public
