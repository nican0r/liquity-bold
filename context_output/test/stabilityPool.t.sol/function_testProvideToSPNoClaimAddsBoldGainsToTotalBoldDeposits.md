# Function: testProvideToSPNoClaimAddsBoldGainsToTotalBoldDeposits()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaimAddsBoldGainsToTotalBoldDeposits() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 24)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 25)
  │   💬 Args: [currentBoldGain, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositNoClaim(address,uint256) (NodeID: 26)
  │   💬 Args: [A, topUp]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 27)
      💬 Args: [stabilityPool.getTotalBoldDeposits(), (totalBoldDepositsBefore + topUp) + currentBoldGain, 1e4]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 28)
        💬 Args: [_x, _y, _margin, ""]
        👁️  Def: internal
```
