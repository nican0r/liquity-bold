# Function: testProvideToSPNoClaimReducesDepositorBoldBalanceByOnlyTheTopUp()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaimReducesDepositorBoldBalanceByOnlyTheTopUp() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 27)
      💬 Args: [boldToken.balanceOf(A), boldBalBefore_A - topUp]
      👁️  Def: internal
```
