# Function: testProvideToSPWithClaim_WithOnlyStashedCollGainsSendsStashedCollGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithOnlyStashedCollGainsSendsStashedCollGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [collBal_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 28)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
