# Function: testProvideToSPWithClaim_WithCurrentAndStashedCollGainsZerosStashedCollBalance()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithCurrentAndStashedCollGainsZerosStashedCollBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 32)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
