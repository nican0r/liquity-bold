# Function: testBoldRewardSumIncreasesWhenTroveLiquidated()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenTroveLiquidated() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 26)
  │   💬 Args: [A, troveIDs.D]
  │   👁️  Def: public
