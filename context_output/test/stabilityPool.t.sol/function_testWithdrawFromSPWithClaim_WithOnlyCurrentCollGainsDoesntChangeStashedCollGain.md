# Function: testWithdrawFromSPWithClaim_WithOnlyCurrentCollGainsDoesntChangeStashedCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPWithClaim_WithOnlyCurrentCollGainsDoesntChangeStashedCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
