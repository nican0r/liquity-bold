# Function: testBoldRewardsOwedOnlyIcreasesByUpfrontFeeYieldWhenNoInterestMinted()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedOnlyIcreasesByUpfrontFeeYieldWhenNoInterestMinted() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 27)
  │   💬 Args: [E, 0, 3 ether, 2000e18, 25e16]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictOpenTroveUpfrontFee(uint256,uint256) (NodeID: 28)
  │     💬 Args: [_boldAmount, _annualInterestRate]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 29)
  │   💬 Args: [yieldGainsOwed_2, yieldGainsOwed_1 + _getSPYield(upfrontFee), "Yield owed mismatch 2"]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: DevTestSetup._getSPYield(uint256) (NodeID: 30)
  │     💬 Args: [upfrontFee]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 31)
  │   │   💬 Args: [spYield, 0]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256) (NodeID: 32)
  │       💬 Args: [spYield, _aggInterest]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 33)
      💬 Args: [yieldGainsPending_2, 0, "Yield pending mismatch 2"]
      👁️  Def: internal
```
