# Function: testBoldRewardSumIncreasesWhenTroveDebtAndCollAdjusted()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenTroveDebtAndCollAdjusted() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.adjustTrove100pct(address,uint256,uint256,uint256,bool,bool) (NodeID: 26)
  │   💬 Args: [A, troveIDs.A, 1, 1, true, true]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 27)
