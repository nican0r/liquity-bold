# Function: testWithdrawFromSPNoClaimAddsBoldGainsToTotalBoldDeposits()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPNoClaimAddsBoldGainsToTotalBoldDeposits() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 27)
      💬 Args: [stabilityPool.getTotalBoldDeposits(), (totalBoldDepositsBefore - withdrawal) + currentBoldGain]
      👁️  Def: internal
```
