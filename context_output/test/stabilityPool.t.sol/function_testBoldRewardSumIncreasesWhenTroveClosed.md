# Function: testBoldRewardSumIncreasesWhenTroveClosed()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenTroveClosed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 32)
  │   💬 Args: [E, troveIDs.E]
  │   👁️  Def: public
