# Function: testGetDepositorBoldGain_2SPDepositor1RewardEvent_EarnFairShareOfSPYield()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testGetDepositorBoldGain_2SPDepositor1RewardEvent_EarnFairShareOfSPYield() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [B, expectedSpYield]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 28)
  │   💬 Args: [expectedShareOfReward_A + expectedShareOfReward_B, expectedSpYield, 1e3]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 29)
  │     💬 Args: [_x, _y, _margin, ""]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 30)
  │   💬 Args: [expectedShareOfReward_B, expectedShareOfReward_A]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 31)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 32)
  │   💬 Args: [stabilityPool.getDepositorYieldGain(A), expectedShareOfReward_A, 1e4]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 33)
  │     💬 Args: [_x, _y, _margin, ""]
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 34)
      💬 Args: [stabilityPool.getDepositorYieldGain(B), expectedShareOfReward_B, 1e4]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 35)
        💬 Args: [_x, _y, _margin, ""]
        👁️  Def: internal
```
