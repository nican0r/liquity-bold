# Function: testWithdrawFromSPNoClaim_WithOnlyCurrentCollGainsStashesCollGains()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPNoClaim_WithOnlyCurrentCollGainsStashesCollGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 27)
      💬 Args: [stabilityPool.stashedColl(A), currentCollGain]
      👁️  Def: internal
```
