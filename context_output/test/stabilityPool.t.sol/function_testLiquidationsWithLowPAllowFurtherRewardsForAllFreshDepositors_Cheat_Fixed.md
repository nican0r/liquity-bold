# Function: testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fixed()
...
- **Kind**: internal
- **Source**: 73194:5267:334
- **Link**: `test/stabilityPool.t.sol:SPTest:testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fuzz(uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fixed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: SPTest.testLiquidationsWithLowPAllowFurtherRewardsForAllFreshDepositors_Cheat_Fuzz(uint256,uint256) (NodeID: 1)
      💬 Args: [2371624267, 555740272250686904193353073666173923435456188015]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 2)
    │   💬 Args: [_cheatP, 1e27, 1e29]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 3)
    │ │   💬 Args: [x, min, max]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 4)
    │     💬 Args: ["Bound result", result]
    │     👁️  Def: private
    │   └─ [4] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 5)
    │       💬 Args: [abi.encodeWithSignature("log(string,uint256)", p0, p1)]
    │       👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 6)
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 8)
    │   💬 Args: [stabilityPool.P(), _cheatP, "P is not set"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: DevTestSetup._setupForPTests() (NodeID: 9)
    │   💬 Args: [no args]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: DevTestSetup._setupForBatchLiquidateTrovesPureOffset(uint256) (NodeID: 10)
    │ │   💬 Args: [1]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 11)
    │ │ │   💬 Args: [A, 5 ether * _magnitude, troveDebtRequest_A, interestRate]
    │ │ │   👁️  Def: public
    │ │ │ └─ [5] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 12)
    │ │ │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
    │ │ │     👁️  Def: public
    │ │ │   └─ [6] ⚙️ FUNCTION: BaseTest.predictOpenTroveUpfrontFee(uint256,uint256) (NodeID: 13)
    │ │ │       💬 Args: [_boldAmount, _annualInterestRate]
    │ │ │       👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 14)
    │ │ │   💬 Args: [B, 5 ether * _magnitude, troveDebtRequest_B, interestRate]
    │ │ │   👁️  Def: public
    │ │ │ └─ [5] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 15)
    │ │ │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
    │ │ │     👁️  Def: public
    │ │ │   └─ [6] ⚙️ FUNCTION: BaseTest.predictOpenTroveUpfrontFee(uint256,uint256) (NodeID: 16)
    │ │ │       💬 Args: [_boldAmount, _annualInterestRate]
    │ │ │       👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 17)
    │ │ │   💬 Args: [C, 25e17 * _magnitude, troveDebtRequest_C, interestRate]
    │ │ │   👁️  Def: public
    │ │ │ └─ [5] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 18)
    │ │ │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
    │ │ │     👁️  Def: public
    │ │ │   └─ [6] ⚙️ FUNCTION: BaseTest.predictOpenTroveUpfrontFee(uint256,uint256) (NodeID: 19)
    │ │ │       💬 Args: [_boldAmount, _annualInterestRate]
    │ │ │       👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 20)
    │ │ │   💬 Args: [D, 25e17 * _magnitude, troveDebtRequest_D, interestRate]
    │ │ │   👁️  Def: public
    │ │ │ └─ [5] ⚙️ FUNCTION: BaseTest.openTroveHelper(address,uint256,uint256,uint256,uint256) (NodeID: 21)
    │ │ │     💬 Args: [_account, 0, _coll, _boldAmount, _annualInterestRate]
    │ │ │     👁️  Def: public
    │ │ │   └─ [6] ⚙️ FUNCTION: BaseTest.predictOpenTroveUpfrontFee(uint256,uint256) (NodeID: 22)
    │ │ │       💬 Args: [_boldAmount, _annualInterestRate]
    │ │ │       👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 23)
    │ │ │   💬 Args: [A, troveDebtRequest_A]
    │ │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 24)
    │ │ │   💬 Args: [B, troveDebtRequest_B]
    │ │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 25)
    │ │ │   💬 Args: [troveManager.checkBelowCriticalThreshold(price)]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 26)
    │ │ │   💬 Args: [troveManager.getCurrentICR(troveIDs.C, price), MCR]
    │ │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 27)
    │ │     💬 Args: [troveManager.getCurrentICR(troveIDs.D, price), MCR]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 28)
    │     💬 Args: [B, stabilityPool.getCompoundedBoldDeposit(B)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 29)
    │   💬 Args: [stabilityPool.getTotalBoldDeposits(), stabilityPool.getCompoundedBoldDeposit(A), 1e14, "A should own all SP"]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 30)
    │     💬 Args: [_x, _y, _margin, _reason]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 31)
    │   💬 Args: [_surplus, debtDelta + 1e9, debtDelta + 10e18]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: StdUtils._bound(uint256,uint256,uint256) (NodeID: 32)
    │ │   💬 Args: [x, min, max]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: StdUtils.console2_log_StdUtils(string,uint256) (NodeID: 33)
    │     💬 Args: ["Bound result", result]
    │     👁️  Def: private
    ...
    │         💬 Args: [_sendLogPayloadView]
    │         👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.transferBold(address,address,uint256) (NodeID: 36)
    │   💬 Args: [B, A, boldToken.balanceOf(B) / 2]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 37)
    │   💬 Args: [A, _surplus]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 38)
    │   💬 Args: [stabilityPool.getDepositorYieldGain(A), 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 39)
    │   💬 Args: [activePool.calcPendingAggInterest(), 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 40)
    │   💬 Args: [A, troveIDs.C]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 41)
    │   💬 Args: [scale2, scale1, "scale didnt change"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 42)
    │   💬 Args: [freshDeposit, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.transferBold(address,address,uint256) (NodeID: 43)
    │   💬 Args: [D, C, freshDeposit]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 44)
    │   💬 Args: [C, freshDeposit]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 45)
    │   💬 Args: [D, freshDeposit]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 46)
    │   💬 Args: [A, stabilityPool.getCompoundedBoldDeposit(A)]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 47)
    │   💬 Args: [stabilityPool.getCompoundedBoldDeposit(A), 0, "A deposit should be zero"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 48)
    │   💬 Args: [pendingAggInterest, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.getShareofSPReward(address,uint256) (NodeID: 49)
    │   💬 Args: [C, testVars.expectedSpYield1]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.getShareofSPReward(address,uint256) (NodeID: 50)
    │   💬 Args: [D, testVars.expectedSpYield1]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 51)
    │   💬 Args: [testVars.expectedShareOfYield1_C, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 52)
    │   💬 Args: [testVars.expectedShareOfYield1_D, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 53)
    │   💬 Args: [testVars.expectedShareOfYield1_C, testVars.expectedShareOfYield1_D]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 54)
    │   💬 Args: [A, troveIDs.D]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 55)
    │   💬 Args: [testVars.spEthGain, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 56)
    │   💬 Args: [testVars.expectedShareOfColl, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 57)
    │   💬 Args: [testVars.expectedShareOfYield1_C, testVars.boldGainC, 1e6, "C share of yield mismatch"]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 58)
    │     💬 Args: [_x, _y, _margin, _reason]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 59)
    │   💬 Args: [testVars.expectedShareOfYield1_D, testVars.boldGainD, 1e6, "D share of yield mismatch"]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 60)
    │     💬 Args: [_x, _y, _margin, _reason]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 61)
    │   💬 Args: [testVars.expectedShareOfColl, testVars.ethGainC, 1e7, "C share of coll mismatch"]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 62)
    │     💬 Args: [_x, _y, _margin, _reason]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 63)
    │   💬 Args: [testVars.expectedShareOfColl, testVars.ethGainD, 1e7, "D share of coll mismatch"]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 64)
    │     💬 Args: [_x, _y, _margin, _reason]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.transferBold(address,address,uint256) (NodeID: 65)
    │   💬 Args: [C, E, boldToken.balanceOf(C)]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 66)
    │   💬 Args: [E, boldToken.balanceOf(E)]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 67)
    │   💬 Args: [pendingAggInterest2, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.getShareofSPReward(address,uint256) (NodeID: 68)
    │   💬 Args: [E, expectedSpYield2]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 69)
    │   💬 Args: [expectedShareOfYield2_E, 0]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 70)
    │   💬 Args: [A, troveIDs.A]
    │   👁️  Def: public
    └─ [2] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256,string) (NodeID: 71)
        💬 Args: [expectedShareOfYield2_E, boldGainE, 1e9, "E share of yield mismatch"]
        👁️  Def: public
      └─ [3] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 72)
          💬 Args: [_x, _y, _margin, _reason]
          👁️  Def: internal
```
