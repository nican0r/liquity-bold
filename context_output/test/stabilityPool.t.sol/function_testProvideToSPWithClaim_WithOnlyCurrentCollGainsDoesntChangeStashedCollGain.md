# Function: testProvideToSPWithClaim_WithOnlyCurrentCollGainsDoesntChangeStashedCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithOnlyCurrentCollGainsDoesntChangeStashedCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
