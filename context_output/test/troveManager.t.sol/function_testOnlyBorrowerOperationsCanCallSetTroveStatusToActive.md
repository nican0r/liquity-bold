# Function: testOnlyBorrowerOperationsCanCallSetTroveStatusToActive()
...
- **ITroveManagerTester::setTroveStatusToActive(uint256)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallSetTroveStatusToActive() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
