# Function: testOnlyBorrowerOperationsCanCallOnAdjustTrove()
...
- **ITroveManagerTester::onAdjustTrove(uint256,uint256,uint256,struct TroveChange)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallOnAdjustTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
