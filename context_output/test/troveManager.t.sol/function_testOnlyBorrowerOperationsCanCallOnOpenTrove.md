# Function: testOnlyBorrowerOperationsCanCallOnOpenTrove()
...
- **ITroveManagerTester::onOpenTrove(address,uint256,struct TroveChange,uint256)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallOnOpenTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
