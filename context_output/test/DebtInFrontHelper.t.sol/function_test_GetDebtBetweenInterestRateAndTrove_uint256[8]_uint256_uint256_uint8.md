# Function: test_GetDebtBetweenInterestRateAndTrove(uint256[8],uint256,uint256,uint8)
...
function test_GetDebtBetweenInterestRateAndTrove(uint256[8] memory debt, uint256 troveIdToStopAt, uint256 hintId, uint8 numTrials) external {
    ...
    (uint256 actualDebt, ) = debtInFrontHelper.getDebtBetweenInterestRateAndTrove(0, 0.006 ether, 0.008 ether, troveIdToStopAt, hintId, numTrials);
...
- **IDebtInFrontHelper::getDebtBetweenInterestRateAndTrove(uint256,uint256,uint256,uint256,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: DebtInFrontHelperTest.test_GetDebtBetweenInterestRateAndTrove(uint256[8],uint256,uint256,uint8) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │   💬 Args: [troveIdToStopAt, 0, debt.length]
  │   👁️  Def: internal
