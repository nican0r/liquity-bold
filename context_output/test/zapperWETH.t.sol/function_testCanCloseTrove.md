...
- **WETHZapper::closeTroveToRawETH(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: ZapperWETHTest.testCanCloseTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 1)
  │   💬 Args: [address(WETH), B, 100 ether + ETH_GAS_COMPENSATION]
  │   👁️  Def: internal
  ...
  │   💬 Args: [troveManager.getTroveEntireColl(troveId), 0, "Coll mismatch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 100)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), 0, "Debt mismatch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 101)
  │   💬 Args: [boldToken.balanceOf(A), 0, "BOLD bal mismatch"]
  │   👁️  Def: internal
