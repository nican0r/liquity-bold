# Function: test_AdjustTroveInterestRateEmitsTroveOperation()
...
function test_AdjustTroveInterestRateEmitsTroveOperation() external {
    ...
    vm.expectEmit();
    emit TroveOperation(troveId, Operation.adjustTroveInterestRate, newInterestRate, 0, 0, 0, 0, 0);
    vm.prank(A);
...
```
┌─ [0] ⚙️ FUNCTION: TroveEventsTest.test_AdjustTroveInterestRateEmitsTroveOperation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
