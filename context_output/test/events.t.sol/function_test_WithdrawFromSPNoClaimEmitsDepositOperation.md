# Function: test_WithdrawFromSPNoClaimEmitsDepositOperation()
...
function test_WithdrawFromSPNoClaimEmitsDepositOperation() external {
    ...
    vm.expectEmit();
    emit DepositOperation(A, Operation.withdrawFromSP, deposit.pendingBoldLoss, -int256(withdrawal), deposit.pendingBoldYieldGain, 0, deposit.pendingCollGain, 0);
...
```
┌─ [0] ⚙️ FUNCTION: StabilityPoolEventsTest.test_WithdrawFromSPNoClaimEmitsDepositOperation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
