...
- **Name**: TroveEventsTest
- **Type**: Contract
- **Path**: test/events.t.sol
...
### test_OpenTroveEmitsTroveUpdated()

- **Signature**: `test_OpenTroveEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 2397:893:303
- **Details**: [function_test_OpenTroveEmitsTroveUpdated.md](./function_test_OpenTroveEmitsTroveUpdated.md)
...
### test_OpenTroveEmitsTroveOperation()

- **Signature**: `test_OpenTroveEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 3296:873:303
- **Details**: [function_test_OpenTroveEmitsTroveOperation.md](./function_test_OpenTroveEmitsTroveOperation.md)
...
### test_AdjustTroveEmitsTroveUpdated()

- **Signature**: `test_AdjustTroveEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 4175:906:303
- **Details**: [function_test_AdjustTroveEmitsTroveUpdated.md](./function_test_AdjustTroveEmitsTroveUpdated.md)
...
### test_AdjustTroveEmitsTroveOperation()

- **Signature**: `test_AdjustTroveEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 5087:773:303
- **Details**: [function_test_AdjustTroveEmitsTroveOperation.md](./function_test_AdjustTroveEmitsTroveOperation.md)
...
### test_AdjustTroveInterestRateEmitsTroveUpdated()

- **Signature**: `test_AdjustTroveInterestRateEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 5866:801:303
- **Details**: [function_test_AdjustTroveInterestRateEmitsTroveUpdated.md](./function_test_AdjustTroveInterestRateEmitsTroveUpdated.md)
...
### test_AdjustTroveInterestRateEmitsTroveOperation()

- **Signature**: `test_AdjustTroveInterestRateEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 6673:762:303
- **Details**: [function_test_AdjustTroveInterestRateEmitsTroveOperation.md](./function_test_AdjustTroveInterestRateEmitsTroveOperation.md)
...
### test_ApplyTroveInterestPermissionlessEmitsTroveUpdated()

- **Signature**: `test_ApplyTroveInterestPermissionlessEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 7441:770:303
- **Details**: [function_test_ApplyTroveInterestPermissionlessEmitsTroveUpdated.md](./function_test_ApplyTroveInterestPermissionlessEmitsTroveUpdated.md)
...
### test_ApplyTroveInterestPermissionlessEmitsTroveOperation()

- **Signature**: `test_ApplyTroveInterestPermissionlessEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 8217:724:303
- **Details**: [function_test_ApplyTroveInterestPermissionlessEmitsTroveOperation.md](./function_test_ApplyTroveInterestPermissionlessEmitsTroveOperation.md)
...
### test_CloseTroveEmitsTroveUpdated()

- **Signature**: `test_CloseTroveEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 8947:951:303
- **Details**: [function_test_CloseTroveEmitsTroveUpdated.md](./function_test_CloseTroveEmitsTroveUpdated.md)
...
### test_CloseTroveEmitsTroveOperation()

- **Signature**: `test_CloseTroveEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 9904:1066:303
- **Details**: [function_test_CloseTroveEmitsTroveOperation.md](./function_test_CloseTroveEmitsTroveOperation.md)
...
### test_LiquidateEmitsTroveUpdated()

- **Signature**: `test_LiquidateEmitsTroveUpdated()`
- **Visibility**: external
- **Source Range**: 10976:758:303
- **Details**: [function_test_LiquidateEmitsTroveUpdated.md](./function_test_LiquidateEmitsTroveUpdated.md)
...
### test_LiquidateEmitsTroveOperation()

- **Signature**: `test_LiquidateEmitsTroveOperation()`
- **Visibility**: external
- **Source Range**: 11740:1023:303
- **Details**: [function_test_LiquidateEmitsTroveOperation.md](./function_test_LiquidateEmitsTroveOperation.md)
...
### test_LiquidateEmitsLiquidation()

- **Signature**: `test_LiquidateEmitsLiquidation()`
- **Visibility**: external
- **Source Range**: 12769:1214:303
- **Details**: [function_test_LiquidateEmitsLiquidation.md](./function_test_LiquidateEmitsLiquidation.md)
...
### test_BatchLiquidateTrovesEmitsTroveUpdatedForEachLiquidatedTrove()

- **Signature**: `test_BatchLiquidateTrovesEmitsTroveUpdatedForEachLiquidatedTrove()`
- **Visibility**: external
- **Source Range**: 13989:1333:303
- **Details**: [function_test_BatchLiquidateTrovesEmitsTroveUpdatedForEachLiquidatedTrove.md](./function_test_BatchLiquidateTrovesEmitsTroveUpdatedForEachLiquidatedTrove.md)
...
### test_BatchLiquidateTrovesEmitsTroveOperationForEachLiquidatedTrove()

- **Signature**: `test_BatchLiquidateTrovesEmitsTroveOperationForEachLiquidatedTrove()`
- **Visibility**: external
- **Source Range**: 15328:1620:303
- **Details**: [function_test_BatchLiquidateTrovesEmitsTroveOperationForEachLiquidatedTrove.md](./function_test_BatchLiquidateTrovesEmitsTroveOperationForEachLiquidatedTrove.md)
...
### test_BatchLiquidateTrovesEmitsLiquidation()

- **Signature**: `test_BatchLiquidateTrovesEmitsLiquidation()`
- **Visibility**: external
- **Source Range**: 16954:2704:303
- **Details**: [function_test_BatchLiquidateTrovesEmitsLiquidation.md](./function_test_BatchLiquidateTrovesEmitsLiquidation.md)
...
### test_RedeemCollateralEmitsTroveUpdatedForEachRedeemedTrove()

- **Signature**: `test_RedeemCollateralEmitsTroveUpdatedForEachRedeemedTrove()`
- **Visibility**: external
- **Source Range**: 19664:2112:303
- **Details**: [function_test_RedeemCollateralEmitsTroveUpdatedForEachRedeemedTrove.md](./function_test_RedeemCollateralEmitsTroveUpdatedForEachRedeemedTrove.md)
...
### test_RedeemCollateralEmitsTroveOperationForEachRedeemedTrove()

- **Signature**: `test_RedeemCollateralEmitsTroveOperationForEachRedeemedTrove()`
- **Visibility**: external
- **Source Range**: 21782:2011:303
- **Details**: [function_test_RedeemCollateralEmitsTroveOperationForEachRedeemedTrove.md](./function_test_RedeemCollateralEmitsTroveOperationForEachRedeemedTrove.md)
