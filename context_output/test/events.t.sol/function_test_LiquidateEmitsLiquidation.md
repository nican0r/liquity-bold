# Function: test_LiquidateEmitsLiquidation()
...
function test_LiquidateEmitsLiquidation() external {
    ...
    (uint256 liquidatedTroveId, uint256 liquidatedColl) = openTroveWithExactICRAndDebt(A, 0, MCR, liquidatedDebt, 0.01 ether);
    ...
    vm.expectEmit();
    emit Liquidation(l.debtOffsetBySP, l.debtRedistributed, l.ethGasCompensation, l.collGasCompensation, l.collSentToSP, l.collRedistributed, l.collSurplus, (l.collRedistributed * DECIMAL_PRECISION) / otherColl, (l.debtRedistributed * DECIMAL_PRECISION) / otherColl, price);
...
```
┌─ [0] ⚙️ FUNCTION: TroveEventsTest.test_LiquidateEmitsLiquidation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  └─ [1] ⚙️ FUNCTION: BaseTest.openTroveWithExactICRAndDebt(address,uint256,uint256,uint256,uint256) (NodeID: 6)
      💬 Args: [A, 0, MCR, liquidatedDebt, 0.01 ether]
      👁️  Def: public
