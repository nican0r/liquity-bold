# Function: test_ProvideToSPNoClaimEmitsDepositOperation()
...
function test_ProvideToSPNoClaimEmitsDepositOperation() external {
    ...
    vm.expectEmit();
    emit DepositOperation(A, Operation.provideToSP, deposit.pendingBoldLoss, int256(topUp), deposit.pendingBoldYieldGain, 0, deposit.pendingCollGain, 0);
...
```
┌─ [0] ⚙️ FUNCTION: StabilityPoolEventsTest.test_ProvideToSPNoClaimEmitsDepositOperation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
