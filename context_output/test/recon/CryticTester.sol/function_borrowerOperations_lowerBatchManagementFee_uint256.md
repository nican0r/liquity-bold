# Function: borrowerOperations_lowerBatchManagementFee(uint256)
...
- **BorrowerOperationsTester::lowerBatchManagementFee(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_lowerBatchManagementFee(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
