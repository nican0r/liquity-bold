# Function: borrowerOperations_repayBold(uint256,uint256)
...
- **BorrowerOperationsTester::repayBold(uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_repayBold(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
