# Function: borrowerOperations_addColl(uint256,uint256)
...
- **BorrowerOperationsTester::addColl(uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_addColl(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
