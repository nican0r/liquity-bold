# Function: test_stabilityPool_withdrawFromSP()
...
### stabilityPool_withdrawFromSP(uint256,bool)

- **Kind**: internal
- **Source**: 879:149:329
- **Link**: `test/recon/targets/StabilityPoolTargets.sol:StabilityPoolTargets:stabilityPool_withdrawFromSP(uint256,bool)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_stabilityPool_withdrawFromSP() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StabilityPoolTargets.stabilityPool_withdrawFromSP(uint256,bool) (NodeID: 4)
      💬 Args: [500e18, false]
      👁️  Def: public
