# Function: test_collateralRegistry_redeemCollateral()
...
### collateralRegistry_redeemCollateral(uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 628:258:324
- **Link**: `test/recon/targets/CollateralRegistryTargets.sol:CollateralRegistryTargets:collateralRegistry_redeemCollateral(uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_collateralRegistry_redeemCollateral() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: CollateralRegistryTargets.collateralRegistry_redeemCollateral(uint256,uint256,uint256) (NodeID: 5)
      💬 Args: [100e18, 10, 5e16]
      👁️  Def: public
