# Function: test_borrowerOperations_removeFromBatch()
...
### borrowerOperations_removeFromBatch(uint256,uint256,uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 3808:298:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_removeFromBatch(uint256,uint256,uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_removeFromBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_removeFromBatch(uint256,uint256,uint256,uint256,uint256) (NodeID: 9)
      💬 Args: [0, 5e16, 0, 0, 100e18]
      👁️  Def: public
