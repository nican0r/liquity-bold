# Function: test_borrowerOperations_kickFromBatch()
...
### borrowerOperations_kickFromBatch(uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 2294:198:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_kickFromBatch(uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_kickFromBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_kickFromBatch(uint256,uint256,uint256) (NodeID: 9)
      💬 Args: [0, 0, 0]
      👁️  Def: public
