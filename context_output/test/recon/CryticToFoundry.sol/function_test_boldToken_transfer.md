# Function: test_boldToken_transfer()
...
### boldToken_transfer(address,uint256)

- **Kind**: internal
- **Source**: 1290:132:321
- **Link**: `test/recon/targets/BoldTokenTargets.sol:BoldTokenTargets:boldToken_transfer(address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_boldToken_transfer() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BoldTokenTargets.boldToken_transfer(address,uint256) (NodeID: 1)
      💬 Args: [_getActors()[0], 100e18]
      👁️  Def: public
