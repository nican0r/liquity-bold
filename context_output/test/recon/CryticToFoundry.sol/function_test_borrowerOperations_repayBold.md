# Function: test_borrowerOperations_repayBold()
...
### borrowerOperations_repayBold(uint256,uint256)

- **Kind**: internal
- **Source**: 4290:160:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_repayBold(uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_repayBold() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_repayBold(uint256,uint256) (NodeID: 8)
      💬 Args: [0, 50e18]
      👁️  Def: public
