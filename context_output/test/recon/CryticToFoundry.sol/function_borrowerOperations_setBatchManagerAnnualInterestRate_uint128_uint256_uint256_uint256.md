# Function: borrowerOperations_setBatchManagerAnnualInterestRate(uint128,uint256,uint256,uint256)
...
- **BorrowerOperationsTester::setBatchManagerAnnualInterestRate(uint128,uint256,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_setBatchManagerAnnualInterestRate(uint128,uint256,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
