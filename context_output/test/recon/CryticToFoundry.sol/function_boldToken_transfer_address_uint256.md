# Function: boldToken_transfer(address,uint256)
...
- **BoldToken::transfer(address,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BoldTokenTargets.boldToken_transfer(address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
