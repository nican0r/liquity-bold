# Function: test_borrowerOperations_adjustTroveInterestRate()
...
### borrowerOperations_adjustTroveInterestRate(uint256,uint256,uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 1112:314:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_adjustTroveInterestRate(uint256,uint256,uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_adjustTroveInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_adjustTroveInterestRate(uint256,uint256,uint256,uint256,uint256) (NodeID: 5)
      💬 Args: [0, 6e16, 0, 0, 100e18]
      👁️  Def: public
