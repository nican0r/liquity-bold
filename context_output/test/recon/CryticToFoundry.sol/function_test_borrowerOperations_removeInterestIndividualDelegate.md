# Function: test_borrowerOperations_removeInterestIndividualDelegate()
...
function test_borrowerOperations_removeInterestIndividualDelegate() public {
    ...
    borrowerOperations_setInterestIndividualDelegate(0, _getActors()[0], 5e16, 10e16, 5e16, 0, 0, 100e18, 7 days);
...
### borrowerOperations_setInterestIndividualDelegate(uint256,address,uint128,uint128,uint256,uint256,uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 5244:512:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_setInterestIndividualDelegate(uint256,address,uint128,uint128,uint256,uint256,uint256,uint256,uint256)`
...
### borrowerOperations_removeInterestIndividualDelegate(uint256)

- **Kind**: internal
- **Source**: 4112:172:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_removeInterestIndividualDelegate(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_removeInterestIndividualDelegate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_setInterestIndividualDelegate(uint256,address,uint128,uint128,uint256,uint256,uint256,uint256,uint256) (NodeID: 5)
  │   💬 Args: [0, _getActors()[0], 5e16, 10e16, 5e16, 0, 0, 100e18, 7 days]
  │   👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_removeInterestIndividualDelegate(uint256) (NodeID: 11)
      💬 Args: [0]
      👁️  Def: public
