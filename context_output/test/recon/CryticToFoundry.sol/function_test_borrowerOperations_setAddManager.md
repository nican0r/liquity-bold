# Function: test_borrowerOperations_setAddManager()
...
### borrowerOperations_setAddManager(uint256,address)

- **Kind**: internal
- **Source**: 4456:162:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_setAddManager(uint256,address)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_setAddManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_setAddManager(uint256,address) (NodeID: 5)
      💬 Args: [0, _getActors()[0]]
      👁️  Def: public
