# Function: test_borrowerOperations_applyPendingDebt()
...
### borrowerOperations_applyPendingDebt(uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 1830:204:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_applyPendingDebt(uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_applyPendingDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_applyPendingDebt(uint256,uint256,uint256) (NodeID: 5)
      💬 Args: [0, 0, 0]
      👁️  Def: public
