# Function: borrowerOperations_closeTrove(uint256)
...
- **BorrowerOperationsTester::closeTrove(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_closeTrove(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
