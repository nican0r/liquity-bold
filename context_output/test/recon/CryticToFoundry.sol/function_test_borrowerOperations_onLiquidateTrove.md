# Function: test_borrowerOperations_onLiquidateTrove()
...
### borrowerOperations_onLiquidateTrove(uint256)

- **Kind**: internal
- **Source**: 3205:140:320
- **Link**: `test/recon/targets/AdminTargets.sol:AdminTargets:borrowerOperations_onLiquidateTrove(uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_onLiquidateTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: AdminTargets.borrowerOperations_onLiquidateTrove(uint256) (NodeID: 5)
      💬 Args: [0]
      👁️  Def: public
