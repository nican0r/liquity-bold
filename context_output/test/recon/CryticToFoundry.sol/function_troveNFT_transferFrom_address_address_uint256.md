# Function: troveNFT_transferFrom(address,address,uint256)
...
- **TroveNFT::transferFrom(address,address,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: TroveNFTTargets.troveNFT_transferFrom(address,address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
