# Function: borrowerOperations_setRemoveManager(uint256,address)
...
- **BorrowerOperationsTester::setRemoveManager(uint256,address)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_setRemoveManager(uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
