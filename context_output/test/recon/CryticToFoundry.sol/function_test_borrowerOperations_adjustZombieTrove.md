# Function: test_borrowerOperations_adjustZombieTrove()
...
### borrowerOperations_adjustZombieTrove(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256)

- **Kind**: internal
- **Source**: 1432:392:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_adjustZombieTrove(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_adjustZombieTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_adjustZombieTrove(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256) (NodeID: 5)
      💬 Args: [0, 1e18, true, 100e18, true, 0, 0, 100e18]
      👁️  Def: public
