...
- **Name**: RedemptionHelperTest
- **Type**: Contract
- **Path**: test/RedemptionHelper.t.sol
...
```solidity
TestDeployer.TroveManagerParams[] internal params
```

### branch

```solidity
TestDeployer.LiquityContractsDev[] internal branch
```

### redemptionHelper

```solidity
IRedemptionHelper internal redemptionHelper
```
...
- **Details**: [function_provideToSP_uint256_address_uint256.md](./function_provideToSP_uint256_address_uint256.md)
...
- **Details**: [function_provideToSPs_address_uint256[3].md](./function_provideToSPs_address_uint256[3].md)
...
### test_SimulateRedemption(uint256,struct RedemptionHelperTest.TroveParams[20],uint256[3],uint256[3],uint256,uint256)
...
- **Details**: [function_test_SimulateRedemption_uint256_struct_RedemptionHelperTest.TroveParams[20]_uint256[3]_uint256[3]_uint256_uint256.md](./function_test_SimulateRedemption_uint256_struct_RedemptionHelperTest.TroveParams[20]_uint256[3]_uint256[3]_uint256_uint256.md)
...
### test_TruncateRedemption(uint256,struct RedemptionHelperTest.TroveParams[20],uint256[3],uint256[3],uint256,uint256)
...
- **Details**: [function_test_TruncateRedemption_uint256_struct_RedemptionHelperTest.TroveParams[20]_uint256[3]_uint256[3]_uint256_uint256.md](./function_test_TruncateRedemption_uint256_struct_RedemptionHelperTest.TroveParams[20]_uint256[3]_uint256[3]_uint256_uint256.md)
...
### test_RedeemCollateral_RefundsRemainingBold()

- **Signature**: `test_RedeemCollateral_RefundsRemainingBold()`
- **Visibility**: external
- **Source Range**: 10945:1194:245
- **Details**: [function_test_RedeemCollateral_RefundsRemainingBold.md](./function_test_RedeemCollateral_RefundsRemainingBold.md)
...
### test_RedeemCollateral_ForwardsRedeemedColl()

- **Signature**: `test_RedeemCollateral_ForwardsRedeemedColl()`
- **Visibility**: external
- **Source Range**: 12145:1310:245
- **Details**: [function_test_RedeemCollateral_ForwardsRedeemedColl.md](./function_test_RedeemCollateral_ForwardsRedeemedColl.md)
...
### test_RedeemCollateral_RevertsWhenRedeemedCollLtMin()

- **Signature**: `test_RedeemCollateral_RevertsWhenRedeemedCollLtMin()`
- **Visibility**: external
- **Source Range**: 13461:1412:245
- **Details**: [function_test_RedeemCollateral_RevertsWhenRedeemedCollLtMin.md](./function_test_RedeemCollateral_RevertsWhenRedeemedCollLtMin.md)
