# Function: test_RedeemCollateral_RevertsWhenRedeemedCollLtMin()
...
```
┌─ [0] ⚙️ FUNCTION: RedemptionHelperTest.test_RedeemCollateral_RevertsWhenRedeemedCollLtMin() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
