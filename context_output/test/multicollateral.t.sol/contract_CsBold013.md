...
```solidity
uint256 internal constant INITIAL_PRICE = 2_000 ether
```
...
- **Details**: [function_openTroveWithExactICRAndDebt_uint256_address_uint256_uint256_uint256_uint256.md](./function_openTroveWithExactICRAndDebt_uint256_address_uint256_uint256_uint256_uint256.md)
...
### test_WontRedeemMoreThanTotalUnbacked_UnlessTotalUnbackedIsZero()

- **Signature**: `test_WontRedeemMoreThanTotalUnbacked_UnlessTotalUnbackedIsZero()`
- **Visibility**: external
- **Source Range**: 41358:3341:311
- **Details**: [function_test_WontRedeemMoreThanTotalUnbacked_UnlessTotalUnbackedIsZero.md](./function_test_WontRedeemMoreThanTotalUnbacked_UnlessTotalUnbackedIsZero.md)
