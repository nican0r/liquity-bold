# Function: testMultiCollateralRedemptionWithZeroUnbacked()
...
```
┌─ [0] ⚙️ FUNCTION: MulticollateralTest.testMultiCollateralRedemptionWithZeroUnbacked() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 17)
  │   💬 Args: [contractsArray[0].troveManager.shutdownTime(), 0, "First branch should be shut down"]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 21)
  │   💬 Args: [A, redeemAmount]
  │   👁️  Def: public
