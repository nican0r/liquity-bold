# Function: testRepayingTooMuchDebtCapsAtMinDebt()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTest.testRepayingTooMuchDebtCapsAtMinDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, 100 ether, 2_000 ether, 0.01 ether]
  │   👁️  Def: public
  ...
  │   💬 Args: [address(boldToken), A, 3_000 ether]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 102)
      💬 Args: [troveManager.getTroveEntireDebt(troveId), MIN_DEBT, "Trove debt should be MIN_DEBT"]
      👁️  Def: internal
```
