...
- **Name**: BorrowerOperationsTest
- **Type**: Contract
- **Path**: test/borrowerOperations.t.sol
...
### testCloseLastTroveReverts()

- **Signature**: `testCloseLastTroveReverts()`
- **Visibility**: public
- **Source Range**: 157:653:299
- **Details**: [function_testCloseLastTroveReverts.md](./function_testCloseLastTroveReverts.md)
...
### testRepayingTooMuchDebtCapsAtMinDebt()

- **Signature**: `testRepayingTooMuchDebtCapsAtMinDebt()`
- **Visibility**: public
- **Source Range**: 816:386:299
- **Details**: [function_testRepayingTooMuchDebtCapsAtMinDebt.md](./function_testRepayingTooMuchDebtCapsAtMinDebt.md)
...
### testWithdrawingTooMuchCollateralReverts()

- **Signature**: `testWithdrawingTooMuchCollateralReverts()`
- **Visibility**: public
- **Source Range**: 1208:312:299
- **Details**: [function_testWithdrawingTooMuchCollateralReverts.md](./function_testWithdrawingTooMuchCollateralReverts.md)
...
### testZeroAdjustmentReverts()

- **Signature**: `testZeroAdjustmentReverts()`
- **Visibility**: public
- **Source Range**: 1526:312:299
- **Details**: [function_testZeroAdjustmentReverts.md](./function_testZeroAdjustmentReverts.md)
...
### testOpenTroveChargesUpfrontFee()

- **Signature**: `testOpenTroveChargesUpfrontFee()`
- **Visibility**: public
- **Source Range**: 1844:885:299
- **Details**: [function_testOpenTroveChargesUpfrontFee.md](./function_testOpenTroveChargesUpfrontFee.md)
...
### testOpenTroveRevertsIfUpfrontFeeExceedsUserProvidedLimit()

- **Signature**: `testOpenTroveRevertsIfUpfrontFeeExceedsUserProvidedLimit()`
- **Visibility**: public
- **Source Range**: 2735:528:299
- **Details**: [function_testOpenTroveRevertsIfUpfrontFeeExceedsUserProvidedLimit.md](./function_testOpenTroveRevertsIfUpfrontFeeExceedsUserProvidedLimit.md)
...
### testWithdrawBoldChargesUpfrontFee()

- **Signature**: `testWithdrawBoldChargesUpfrontFee()`
- **Visibility**: public
- **Source Range**: 3269:984:299
- **Details**: [function_testWithdrawBoldChargesUpfrontFee.md](./function_testWithdrawBoldChargesUpfrontFee.md)
...
### testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit()

- **Signature**: `testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit()`
- **Visibility**: public
- **Source Range**: 4259:504:299
- **Details**: [function_testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit.md](./function_testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit.md)
...
### testAdjustInterestRateFailsIfNotNew()

- **Signature**: `testAdjustInterestRateFailsIfNotNew()`
- **Visibility**: public
- **Source Range**: 4769:333:299
- **Details**: [function_testAdjustInterestRateFailsIfNotNew.md](./function_testAdjustInterestRateFailsIfNotNew.md)
...
### testAdjustInterestRateChargesUpfrontFeeWhenPremature()

- **Signature**: `testAdjustInterestRateChargesUpfrontFeeWhenPremature()`
- **Visibility**: public
- **Source Range**: 5108:2755:299
- **Details**: [function_testAdjustInterestRateChargesUpfrontFeeWhenPremature.md](./function_testAdjustInterestRateChargesUpfrontFeeWhenPremature.md)
...
### testAdjustInterestRateRevertsWhenUpfrontFeeExceedsUserProvidedLimit()

- **Signature**: `testAdjustInterestRateRevertsWhenUpfrontFeeExceedsUserProvidedLimit()`
- **Visibility**: public
- **Source Range**: 7869:697:299
- **Details**: [function_testAdjustInterestRateRevertsWhenUpfrontFeeExceedsUserProvidedLimit.md](./function_testAdjustInterestRateRevertsWhenUpfrontFeeExceedsUserProvidedLimit.md)
