# Function: testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
