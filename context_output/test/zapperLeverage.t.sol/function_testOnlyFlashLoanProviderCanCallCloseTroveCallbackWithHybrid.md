# Function: testOnlyFlashLoanProviderCanCallCloseTroveCallbackWithHybrid()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyFlashLoanProviderCanCallCloseTroveCallbackWithHybrid() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
