# Function: testOnlyOwnerOrManagerCanLeverDownWithCurveFromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithCurveFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
