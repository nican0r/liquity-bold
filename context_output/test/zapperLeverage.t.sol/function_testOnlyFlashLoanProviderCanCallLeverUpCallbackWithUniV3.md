# Function: testOnlyFlashLoanProviderCanCallLeverUpCallbackWithUniV3()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyFlashLoanProviderCanCallLeverUpCallbackWithUniV3() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
