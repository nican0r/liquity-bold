# Function: testOnlyFlashLoanProviderCanCallOpenTroveCallbackWithCurve()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyFlashLoanProviderCanCallOpenTroveCallbackWithCurve() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
