# Function: testOnlyFlashLoanProviderCanCallCloseTroveCallbackWithCurve()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyFlashLoanProviderCanCallCloseTroveCallbackWithCurve() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
