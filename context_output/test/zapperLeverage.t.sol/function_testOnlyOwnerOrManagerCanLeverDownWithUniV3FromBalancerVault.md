# Function: testOnlyOwnerOrManagerCanLeverDownWithUniV3FromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithUniV3FromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
