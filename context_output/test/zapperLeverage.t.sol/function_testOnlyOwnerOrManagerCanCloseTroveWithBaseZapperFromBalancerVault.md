# Function: testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
