# Function: testOnlyOwnerOrManagerCanLeverUpWithHybridFromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithHybridFromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
