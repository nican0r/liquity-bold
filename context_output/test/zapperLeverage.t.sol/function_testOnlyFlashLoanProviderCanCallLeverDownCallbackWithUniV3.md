# Function: testOnlyFlashLoanProviderCanCallLeverDownCallbackWithUniV3()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyFlashLoanProviderCanCallLeverDownCallbackWithUniV3() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
