# Function: testCannotCloseTroveWithLeverageUniV3IfLessCollThanExpected()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotCloseTroveWithLeverageUniV3IfLessCollThanExpected() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCannotCloseTroveIfLessCollThanExpected(contract IZapper,uint256) (NodeID: 1)
      💬 Args: [IZapper(leverageZapperUniV3Array[i]), i]
      👁️  Def: internal
