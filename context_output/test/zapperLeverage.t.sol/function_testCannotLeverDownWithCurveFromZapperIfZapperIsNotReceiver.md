# Function: testCannotLeverDownWithCurveFromZapperIfZapperIsNotReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotLeverDownWithCurveFromZapperIfZapperIsNotReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
