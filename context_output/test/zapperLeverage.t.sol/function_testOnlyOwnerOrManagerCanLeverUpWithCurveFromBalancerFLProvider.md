# Function: testOnlyOwnerOrManagerCanLeverUpWithCurveFromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithCurveFromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
