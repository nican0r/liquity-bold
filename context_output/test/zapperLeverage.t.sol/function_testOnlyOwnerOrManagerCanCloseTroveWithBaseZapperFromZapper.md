# Function: testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
