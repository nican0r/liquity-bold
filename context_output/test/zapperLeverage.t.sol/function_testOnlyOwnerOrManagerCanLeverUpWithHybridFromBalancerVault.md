# Function: testOnlyOwnerOrManagerCanLeverUpWithHybridFromBalancerVault()
...
### _testOnlyOwnerOrManagerCanLeverUpFromBalancerVault(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)

- **Kind**: internal
- **Source**: 41581:2676:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testOnlyOwnerOrManagerCanLeverUpFromBalancerVault(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)`

```solidity
function _testOnlyOwnerOrManagerCanLeverUpFromBalancerVault(ILeverageZapper _leverageZapper, ExchangeType _exchangeType, uint256 _branch) internal {
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithHybridFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testOnlyOwnerOrManagerCanLeverUpFromBalancerVault(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256) (NodeID: 1)
