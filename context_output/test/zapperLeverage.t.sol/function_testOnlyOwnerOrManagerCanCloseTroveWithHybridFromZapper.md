# Function: testOnlyOwnerOrManagerCanCloseTroveWithHybridFromZapper()
...
### _testOnlyOwnerOrManagerCanCloseTroveFromZapper(contract IZapper,uint256)

- **Kind**: internal
- **Source**: 76120:917:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testOnlyOwnerOrManagerCanCloseTroveFromZapper(contract IZapper,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithHybridFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testOnlyOwnerOrManagerCanCloseTroveFromZapper(contract IZapper,uint256) (NodeID: 1)
    ...
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 7)
        💬 Args: [address(_zapper.flashLoanProvider().receiver()), address(0), "Receiver should be zero"]
        👁️  Def: internal
```
