# Function: testCannotLeverUpTroveWithUniV3IfZapperIsNotReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotLeverUpTroveWithUniV3IfZapperIsNotReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
