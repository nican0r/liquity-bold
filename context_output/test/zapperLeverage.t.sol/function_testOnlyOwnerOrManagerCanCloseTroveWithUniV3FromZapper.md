# Function: testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
