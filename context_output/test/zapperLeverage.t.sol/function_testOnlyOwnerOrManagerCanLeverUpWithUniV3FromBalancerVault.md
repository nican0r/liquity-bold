# Function: testOnlyOwnerOrManagerCanLeverUpWithUniV3FromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithUniV3FromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
