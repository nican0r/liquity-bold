# Function: testOnlyOwnerOrManagerCanLeverUpWithCurveFromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithCurveFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
