# Function: testOnlyOwnerOrManagerCanLeverDownWithCurveFromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithCurveFromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
