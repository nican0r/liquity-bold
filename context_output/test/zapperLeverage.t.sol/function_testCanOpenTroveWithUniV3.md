# Function: testCanOpenTroveWithUniV3()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCanOpenTroveWithUniV3() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCanOpenTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256,address) (NodeID: 1)
      💬 Args: [leverageZapperUniV3Array[i], ExchangeType.UniV3, i, address(0)]
      👁️  Def: internal
