# Function: testOnlyOwnerOrManagerCanLeverDownWithCurveFromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithCurveFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
