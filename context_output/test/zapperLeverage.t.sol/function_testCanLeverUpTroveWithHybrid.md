# Function: testCanLeverUpTroveWithHybrid()
...
### _testCanLeverUpTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)

- **Kind**: internal
- **Source**: 25692:4263:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testCanLeverUpTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)`
...
### leverUpTrove(struct ZapperLeverageMainnet.LeverUpParams)

- **Kind**: internal
- **Source**: 24321:683:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:leverUpTrove(struct ZapperLeverageMainnet.LeverUpParams)`
...
function leverUpTrove(LeverUpParams memory _params) internal returns (uint256, uint256) {
    ...
    ILeverageZapper.LeverUpTroveParams memory params = ILeverageZapper.LeverUpTroveParams({troveId: _params.troveId, flashLoanAmount: flashLoanAmount, boldAmount: effectiveBoldAmount, maxUpfrontFee: 1000e18});
    vm.startPrank(A);
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCanLeverUpTroveWithHybrid() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCanLeverUpTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256) (NodeID: 1)
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: ZapperLeverageMainnet.leverUpTrove(struct ZapperLeverageMainnet.LeverUpParams) (NodeID: 12)
    │   💬 Args: [params]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: ZapperLeverageMainnet._getLeverUpFlashLoanAndBoldAmount(struct ZapperLeverageMainnet.LeverUpParams) (NodeID: 13)
    │     💬 Args: [_params]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 14)
    ...
    │   │   👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: ZapperLeverageMainnet._getBoldAmountToSwap(enum ZapperLeverageMainnet.ExchangeType,uint256,uint256,uint256,uint256,contract IERC20) (NodeID: 16)
    ...
    │       👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: ZapperLeverageMainnet._getBoldAmountToSwapCurve(uint256,uint256,uint256,uint256) (NodeID: 17)
    │     │   💬 Args: [_branch, _boldAmount, _maxBoldAmount, _minCollAmount]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: ZapperLeverageMainnet._getBoldAmountToSwapUniV3(uint256,uint256,contract IERC20) (NodeID: 18)
    │     │   💬 Args: [_maxBoldAmount, _minCollAmount, _collToken]
    │     │   👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: ZapperLeverageMainnet._getBoldAmountToSwapHybrid(uint256,uint256,contract IERC20) (NodeID: 19)
    │         💬 Args: [_maxBoldAmount, _minCollAmount, _collToken]
    │         👁️  Def: internal
    │       └─ [6] ⚙️ FUNCTION: Math.min(uint256,uint256) (NodeID: 20)
    │           💬 Args: [(boldAmountToSwap * 101) / 100, _maxBoldAmount]
    │           👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.getTroveEntireColl(contract ITroveManager,uint256) (NodeID: 21)
    │   💬 Args: [contractsArray[_branch].troveManager, vars.troveId]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 22)
    │   💬 Args: [(coll >= collExpected) || ((collExpected - coll) <= 4e17), "Coll mismatch"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BaseTest.getTroveEntireDebt(contract ITroveManager,uint256) (NodeID: 23)
    │   💬 Args: [contractsArray[_branch].troveManager, vars.troveId]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256,string) (NodeID: 24)
    │   💬 Args: [troveEntireDebt, expectedMinNetDebt, "Debt too low"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256,string) (NodeID: 25)
    │   💬 Args: [troveEntireDebt, expectedMaxNetDebt, "Debt too high"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 26)
    │   💬 Args: [(ICR >= vars.resultingCollateralRatio) || ((vars.resultingCollateralRatio - ICR) < 2e16), "Wrong CR"]
    │   👁️  Def: internal
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256,string) (NodeID: 29)
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 31)
    │   💬 Args: [boldToken.balanceOf(address(_leverageZapper.exchange())), vars.boldBalanceBeforeExchange, "Exchange should not keep BOLD"]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 32)
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 33)
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 34)
    ...
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 36)
