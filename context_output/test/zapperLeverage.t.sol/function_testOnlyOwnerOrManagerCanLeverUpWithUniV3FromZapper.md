# Function: testOnlyOwnerOrManagerCanLeverUpWithUniV3FromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithUniV3FromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
