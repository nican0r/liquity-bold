# Function: testSwitchBatchManagerChargesUpfrontFeeIfOldBatchChangedFeeLessThanCooldownAgo()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testSwitchBatchManagerChargesUpfrontFeeIfOldBatchChangedFeeLessThanCooldownAgo() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, 100 ether, 2000e18, B, 4e16]
  │   👁️  Def: internal
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setBatchInterestRate(address,uint256) (NodeID: 7)
  │   💬 Args: [B, 5e16]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,address) (NodeID: 10)
  │   💬 Args: [A, troveId, C]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,uint256,uint256,address,uint256,uint256,uint256) (NodeID: 11)
  │     💬 Args: [_troveOwner, _troveId, 0, 0, _newBatchManager, 0, 0, type(uint256).max]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 12)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), ADebtBefore + upfrontFee, 1, "A debt should have increased by upfront fee"]
  │   👁️  Def: internal
