# Function: testCannotSetBatchManagerIfTroveIsLiquidated()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotSetBatchManagerIfTroveIsLiquidated() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
