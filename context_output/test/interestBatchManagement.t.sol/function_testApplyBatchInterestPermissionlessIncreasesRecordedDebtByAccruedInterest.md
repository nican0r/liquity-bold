# Function: testApplyBatchInterestPermissionlessIncreasesRecordedDebtByAccruedInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testApplyBatchInterestPermissionlessIncreasesRecordedDebtByAccruedInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [recordedBatchDebt_2, (recordedBatchDebt_1 + accruedBatchInterest) + accruedBatchManagementFee]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 8)
      💬 Args: [recordedTroveDebt_2, (recordedTroveDebt_1 + accruedTroveInterest) + accruedTroveFee]
      👁️  Def: internal
```
