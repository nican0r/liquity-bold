# Function: testChangeBatchInterestRateDoesNotApplyRedistributionGains()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testChangeBatchInterestRateDoesNotApplyRedistributionGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 10)
  │   💬 Args: [A, CTroveId]
  │   👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
      💬 Args: [troveData.recordedDebt, (troveRecordedDebtBefore + troveAccruedInterest) + batchAccruedManagementFee, "Recorded debt mismatch"]
      👁️  Def: internal
```
