# Function: testCannotAdjustInsideABatchIfBelowMCRPlusBCRIfItWasAlreadyBelow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotAdjustInsideABatchIfBelowMCRPlusBCRIfItWasAlreadyBelow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
