# Function: testRemovesBatchManagerProperlyWithSameNewInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testRemovesBatchManagerProperlyWithSameNewInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [newAnnualInterestRate, annualInterestRate, "New interest rate should be the same"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 9)
  │   💬 Args: [borrowerOperations.interestBatchManagerOf(troveId), address(0), "Wrong batch manager in BO"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 10)
  │   💬 Args: [tmBatchManagerAddress, address(0), "It should not have batch manager in TM"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 11)
      💬 Args: [annualInterestRate, newAnnualInterestRate, "Wrong interest rate"]
      👁️  Def: internal
```
