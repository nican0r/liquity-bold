# Function: testJoinABatchWithSameInterestAndLeaveToDifferentInterestChargesUpfrontFeeTwice()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testJoinABatchWithSameInterestAndLeaveToDifferentInterestChargesUpfrontFeeTwice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
