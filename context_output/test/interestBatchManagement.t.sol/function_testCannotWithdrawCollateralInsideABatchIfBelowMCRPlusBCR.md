# Function: testCannotWithdrawCollateralInsideABatchIfBelowMCRPlusBCR()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotWithdrawCollateralInsideABatchIfBelowMCRPlusBCR() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
