# Function: testJoinABatchWithDifferentInterestAndLeaveToSameInterestChargesUpfrontFeeOnlyOnce()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testJoinABatchWithDifferentInterestAndLeaveToSameInterestChargesUpfrontFeeOnlyOnce() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, troveId, B]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.removeFromBatch(address,uint256,uint256) (NodeID: 8)
  │   💬 Args: [A, troveId, 5e16]
  │   👁️  Def: internal
