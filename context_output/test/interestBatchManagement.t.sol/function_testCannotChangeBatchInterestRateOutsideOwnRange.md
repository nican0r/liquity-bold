# Function: testCannotChangeBatchInterestRateOutsideOwnRange()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotChangeBatchInterestRateOutsideOwnRange() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
