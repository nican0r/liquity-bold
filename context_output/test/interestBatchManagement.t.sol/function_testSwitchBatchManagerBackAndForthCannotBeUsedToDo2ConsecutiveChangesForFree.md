# Function: testSwitchBatchManagerBackAndForthCannotBeUsedToDo2ConsecutiveChangesForFree()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testSwitchBatchManagerBackAndForthCannotBeUsedToDo2ConsecutiveChangesForFree() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [C, uint128(MIN_ANNUAL_INTEREST_RATE), 1e18, 4e16, 0, MIN_INTEREST_RATE_CHANGE_PERIOD]
  │   👁️  Def: internal
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.predictJoinBatchInterestRateUpfrontFee(uint256,address) (NodeID: 8)
  │   💬 Args: [troveId, C]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setBatchInterestRate(address,uint256) (NodeID: 14)
  │   💬 Args: [C, 6e16]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.predictJoinBatchInterestRateUpfrontFee(uint256,address) (NodeID: 17)
  │   💬 Args: [troveId, B]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,address) (NodeID: 18)
  │   💬 Args: [A, troveId, B]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,uint256,uint256,address,uint256,uint256,uint256) (NodeID: 19)
  │     💬 Args: [_troveOwner, _troveId, 0, 0, _newBatchManager, 0, 0, type(uint256).max]
  │     👁️  Def: internal
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), ADebtBefore + upfrontFee, "A debt should increase by upfrontfee after second switch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 22)
  │   💬 Args: [troveData.lastInterestRateAdjTime, block.timestamp, "Wrong interest rate adj time for A after second switch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setBatchInterestRate(address,uint256) (NodeID: 23)
  │   💬 Args: [B, 3e16]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 24)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), ADebtBefore, "A debt should not increase after second batch adjust"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 25)
      💬 Args: [troveData.lastInterestRateAdjTime, block.timestamp, "Wrong interest rate adj time for A after second batch adjust"]
      👁️  Def: internal
```
