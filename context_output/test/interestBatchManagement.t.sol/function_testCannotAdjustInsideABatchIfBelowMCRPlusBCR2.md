# Function: testCannotAdjustInsideABatchIfBelowMCRPlusBCR2()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotAdjustInsideABatchIfBelowMCRPlusBCR2() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
