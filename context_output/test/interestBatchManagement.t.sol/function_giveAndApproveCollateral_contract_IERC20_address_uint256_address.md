# Function: giveAndApproveCollateral(contract IERC20,address,uint256,address)
...
```
┌─ [0] ⚙️ FUNCTION: DevTestSetup.giveAndApproveCollateral(contract IERC20,address,uint256,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
