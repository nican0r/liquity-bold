# Function: testJoinABatchWithDifferentInterestAndLeaveToDifferentInterestChargesUpfrontFeeTwice()
...
function testJoinABatchWithDifferentInterestAndLeaveToDifferentInterestChargesUpfrontFeeTwice() public {
    ...
    assertApproxEqAbs(troveManager.getTroveEntireDebt(troveId), (ADebtBefore + upfrontFee1) + upfrontFee2, 1e14, "A debt should have increased by upfront fee twice");
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testJoinABatchWithDifferentInterestAndLeaveToDifferentInterestChargesUpfrontFeeTwice() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [upfrontFee1, 0, "Upfront 1 fee should be > 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setInterestBatchManager(address,uint256,address) (NodeID: 7)
  │   💬 Args: [A, troveId, B]
  │   👁️  Def: internal
  ...
  │   💬 Args: [upfrontFee2, 0, "Upfront 2 fee should be > 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.removeFromBatch(address,uint256,uint256) (NodeID: 10)
  │   💬 Args: [A, troveId, 4e16]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 11)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), (ADebtBefore + upfrontFee1) + upfrontFee2, 1e14, "A debt should have increased by upfront fee twice"]
  │   👁️  Def: internal
