# Function: testCannotGameUpfrontFeeByJoiningABatchAndChangingInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testCannotGameUpfrontFeeByJoiningABatchAndChangingInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, troveId, B]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.setBatchInterestRate(address,uint256) (NodeID: 8)
  │   💬 Args: [B, 4e16]
  │   👁️  Def: internal
