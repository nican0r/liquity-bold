# Function: testJoinBatchBatchManagerDoesNotChargeUpfrontFeeIfNotTroveNorBatchShortChangeSameInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testJoinBatchBatchManagerDoesNotChargeUpfrontFeeIfNotTroveNorBatchShortChangeSameInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
