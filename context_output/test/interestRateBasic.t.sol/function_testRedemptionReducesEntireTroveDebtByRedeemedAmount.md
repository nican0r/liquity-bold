# Function: testRedemptionReducesEntireTroveDebtByRedeemedAmount()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRedemptionReducesEntireTroveDebtByRedeemedAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 42)
      💬 Args: [entireTroveDebt_2, entireTroveDebt_1 - redeemAmount]
      👁️  Def: internal
```
