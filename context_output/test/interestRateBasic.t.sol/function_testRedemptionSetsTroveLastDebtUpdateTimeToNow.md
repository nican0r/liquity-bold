# Function: testRedemptionSetsTroveLastDebtUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRedemptionSetsTroveLastDebtUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 40)
  │   💬 Args: [troveManager.getTroveLastDebtUpdateTime(troveIDs.A), block.timestamp]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 41)
  │   💬 Args: [E, redeemAmount]
  │   👁️  Def: public
