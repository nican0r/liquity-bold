# Function: testOpenTroveMintsUpfrontFeeToInterestReceivers()
...
function testOpenTroveMintsUpfrontFeeToInterestReceivers() public {
    ...
    assertEqDecimal(boldToken.balanceOf(address(stabilityPool)) + boldToken.balanceOf(address(mockInterestRouter)), fee, 18, "Wrong amount minted to interest receivers");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testOpenTroveMintsUpfrontFeeToInterestReceivers() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, 2 ether, borrow, interestRate]
  │   👁️  Def: public
  ...
  │   💬 Args: [debtWithoutFee, interestRate]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEqDecimal(uint256,uint256,uint256,string) (NodeID: 6)
      💬 Args: [boldToken.balanceOf(address(stabilityPool)) + boldToken.balanceOf(address(mockInterestRouter)), fee, 18, "Wrong amount minted to interest receivers"]
      👁️  Def: internal
```
