# Function: testRevertWhenAdjustInterestRateFromNonOwner()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRevertWhenAdjustInterestRateFromNonOwner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, 2 ether, 2000e18, 37e16]
  │   👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 4)
      💬 Args: [troveManager.getTroveAnnualInterestRate(A_Id), 37e16]
      👁️  Def: internal
```
