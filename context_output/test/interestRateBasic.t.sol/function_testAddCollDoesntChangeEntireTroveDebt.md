# Function: testAddCollDoesntChangeEntireTroveDebt()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testAddCollDoesntChangeEntireTroveDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.addColl(address,uint256,uint256) (NodeID: 5)
