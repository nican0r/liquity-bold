# Function: testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.repayBold(address,uint256,uint256) (NodeID: 4)
  │   💬 Args: [A, ATroveId, boldRepayment]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 5)
      💬 Args: [postRepay.recordedDebt, (preRepay.recordedDebt + preRepay.accruedInterest) - boldRepayment]
      👁️  Def: internal
```
