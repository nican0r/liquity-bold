# Function: testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.withdrawColl(address,uint256,uint256) (NodeID: 4)
