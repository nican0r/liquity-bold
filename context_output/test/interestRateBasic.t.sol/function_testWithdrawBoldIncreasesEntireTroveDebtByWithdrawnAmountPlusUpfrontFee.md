# Function: testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [entireTroveDebt_1, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 5)
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 9)
      💬 Args: [entireTroveDebt_2, (entireTroveDebt_1 + boldWithdrawal) + upfrontFee]
      👁️  Def: internal
```
