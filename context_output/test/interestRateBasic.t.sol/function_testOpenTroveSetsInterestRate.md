# Function: testOpenTroveSetsInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testOpenTroveSetsInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [C, 2 ether, 2000e18, 37e16]
  │   👁️  Def: public
  ...
  │   💬 Args: [troveManager.getTroveAnnualInterestRate(CTroveId), 37e16]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 5)
  │   💬 Args: [D, 2 ether, 2000e18, 1e18]
  │   👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 8)
      💬 Args: [troveManager.getTroveAnnualInterestRate(DTroveId), 1e18]
      👁️  Def: internal
```
