# Function: testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveManager.calcTroveAccruedInterest(ATroveId), 0]
  │   👁️  Def: internal
