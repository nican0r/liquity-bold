...
### (contract IBoldToken,contract IERC20Metadata[],contract ITroveManager[])

- **Kind**: internal
- **Source**: 1826:2019:130
- **Link**: `src/CollateralRegistry.sol:CollateralRegistry:constructor(contract IBoldToken,contract IERC20Metadata[],contract ITroveManager[])`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: CollateralRegistryTester.constructor(contract IBoldToken,contract IERC20Metadata[],contract ITroveManager[]) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: CollateralRegistryTester
  └─ [1] 🏗️ CONSTRUCTOR: CollateralRegistry.constructor(contract IBoldToken,contract IERC20Metadata[],contract ITroveManager[]) (NodeID: 1)
      💬 Args: [_boldToken, _tokens, _troveManagers]
