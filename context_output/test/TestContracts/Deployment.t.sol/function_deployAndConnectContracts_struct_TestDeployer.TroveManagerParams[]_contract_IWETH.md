# Function: deployAndConnectContracts(struct TestDeployer.TroveManagerParams[],contract IWETH)
...
```
┌─ [0] ⚙️ FUNCTION: TestDeployer.deployAndConnectContracts(struct TestDeployer.TroveManagerParams[],contract IWETH) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 1)
  │   💬 Args: [address(this), vars.bytecode, SALT]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 2)
  ...
  │       👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: TestDeployer._nameToken(uint256) (NodeID: 5)
  │   💬 Args: [vars.i]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: TestDeployer._symboltoken(uint256) (NodeID: 6)
  │   💬 Args: [vars.i]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 7)
  │   💬 Args: [troveManagerParamsArray[vars.i]]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 8)
  │     💬 Args: [address(this), getBytecode(type(TroveManagerTester).creationCode, address(addressesRegistry)), SALT]
  │     👁️  Def: public
  │   └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 9)
  │       💬 Args: [type(TroveManagerTester).creationCode, address(addressesRegistry)]
  │       👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 10)
  ...
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 11)
  │ │   💬 Args: [SALT]
  │ │   👁️  Def: public
  │ │ ├─ [3] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 12)
  │ │ │   💬 Args: [no args]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 13)
  │ │ │   💬 Args: [no args]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 14)
  │ │ │     💬 Args: [data]
  │ │ │     👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 15)
  │ │     💬 Args: [_salt]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 16)
  │ │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
  │ │   👁️  Def: public
  │ │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 17)
  ...
  │ │     👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 34)
  ...
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 35)
  │   │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 36)
  │       💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
  │       👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 37)
  │     │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
  │     │   👁️  Def: internal
  │     ├─ [4] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 38)
  │     │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
  │     │   👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 39)
  │         💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 40)
      ...
      👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 41)
    │   💬 Args: [SALT]
    │   👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 42)
    │ │   💬 Args: [no args]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 43)
    │ │   💬 Args: [no args]
    │ │   👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 44)
    │ │     💬 Args: [data]
    │ │     👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 45)
    │     💬 Args: [_salt]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 46)
    │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 47)
    │     💬 Args: [type(MetadataNFT).creationCode, address(initializedFixedAssetReader)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 48)
    │   💬 Args: [address(this), getBytecode(type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 49)
    │     💬 Args: [type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 50)
    │   💬 Args: [address(this), getBytecode(type(TroveNFT).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 51)
    │     💬 Args: [type(TroveNFT).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 52)
    │   💬 Args: [address(this), getBytecode(type(StabilityPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 53)
    │     💬 Args: [type(StabilityPool).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 54)
    │   💬 Args: [address(this), getBytecode(type(ActivePool).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 55)
    │     💬 Args: [type(ActivePool).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 56)
    │   💬 Args: [address(this), getBytecode(type(DefaultPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 57)
    │     💬 Args: [type(DefaultPool).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 58)
    │   💬 Args: [address(this), getBytecode(type(GasPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 59)
    │     💬 Args: [type(GasPool).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 60)
    │   💬 Args: [address(this), getBytecode(type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 61)
    │     💬 Args: [type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 62)
    │   💬 Args: [address(this), getBytecode(type(SortedTroves).creationCode, address(contracts.addressesRegistry)), SALT]
    │   👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 63)
    │     💬 Args: [type(SortedTroves).creationCode, address(contracts.addressesRegistry)]
    │     👁️  Def: public
    └─ [2] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 64)
        💬 Args: [contracts.addressesRegistry, contracts.collToken, _boldToken, _weth, contracts.priceFeed, ICurveStableswapNGPool(address(0)), false, zappers]
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 65)
      │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
      │   👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 66)
          💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
          👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 67)
        │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
        │   👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 68)
        │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
        │   👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 69)
            💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
            👁️  Def: internal
```
