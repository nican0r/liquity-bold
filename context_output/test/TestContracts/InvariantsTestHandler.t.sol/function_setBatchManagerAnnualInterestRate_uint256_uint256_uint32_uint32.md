# Function: setBatchManagerAnnualInterestRate(uint256,uint256,uint32,uint32)
...
function setBatchManagerAnnualInterestRate(uint256 i, uint256 newAnnualInterestRate, uint32 upperHintSeed, uint32 lowerHintSeed) external {
    ...
    newAnnualInterestRate = _bound(newAnnualInterestRate, (batch.interestRateMin > 0) ? (batch.interestRateMin - 1) : 0, batch.interestRateMax + 1);
    ...
    v.premature = (newAnnualInterestRate != batch.interestRate) && (_timeSinceLastBatchInterestRateAdjustment[i][msg.sender] < INTEREST_RATE_ADJ_COOLDOWN);
    ...
    logCall("setBatchManagerAnnualInterestRate", i.toString(), newAnnualInterestRate.decimal(), upperHintSeed.toString(), lowerHintSeed.toString());
    vm.prank(msg.sender);
    try v.c.borrowerOperations.setBatchManagerAnnualInterestRate(uint128(newAnnualInterestRate), v.upperHint, v.lowerHint, v.upfrontFee) {
        ...
        assertGeDecimal(newAnnualInterestRate, batch.interestRateMin, 18, "Should have failed as interest rate wasn't in range");
        assertLeDecimal(newAnnualInterestRate, batch.interestRateMax, 18, "Should have failed as interest rate wasn't in range");
        assertGe(_timeSinceLastBatchInterestRateAdjustment[i][msg.sender], batch.period, "Should have failed as period hasn't passed");
        ...
        if (v.upfrontFee > 0) {
            ...
            if (batchDebt == 0) {
                assertApproxEqAbsDecimal(v.b.entireDebtWithoutRedistribution, 0, 1e3, 18, "Batch debt should be negligible");
        ...
        if (selector == BorrowerOperations.IsShutDown.selector) {
            ...
            assertFalse((batch.interestRateMin <= newAnnualInterestRate) && (newAnnualInterestRate <= batch.interestRateMax), "Shouldn't have failed as interest rate was in range");
        } else if (selector == BorrowerOperations.BatchInterestRateChangePeriodNotPassed.selector) {
            assertLt(_timeSinceLastBatchInterestRateAdjustment[i][msg.sender], batch.period, "Shouldn't have failed as period has passed");
...
### _getBatchDebt(uint256,address)

- **Kind**: internal
- **Source**: 113028:315:270
- **Link**: `test/TestContracts/InvariantsTestHandler.t.sol:InvariantsTestHandler:_getBatchDebt(uint256,address)`
...
- **HintHelpers::predictAdjustBatchInterestRateUpfrontFee(uint256,address,uint256)**
- **Vm::prank(address)**
...
```
┌─ [0] ⚙️ FUNCTION: InvariantsTestHandler.setBatchManagerAnnualInterestRate(uint256,uint256,uint32,uint32) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │   💬 Args: [newAnnualInterestRate, (batch.interestRateMin > 0) ? (batch.interestRateMin - 1) : 0, batch.interestRateMax + 1]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Logging.info(string,string) (NodeID: 12)
  │   💬 Args: ["upper hint: ", _hintToString(i, v.upperHint)]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: InvariantsTestHandler._hintToString(uint256,uint256) (NodeID: 17)
  │ │   💬 Args: [i, v.upperHint]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: InvariantsTestHandler._isOpen(uint256,uint256) (NodeID: 18)
  │ │ │   💬 Args: [i, troveId]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: EnumerableSetMethods.has(struct EnumerableSet,uint256) (NodeID: 19)
  │ │ │     💬 Args: [_troveIds[i], troveId]
  │ │ │     👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 20)
  │ │     💬 Args: [troveId]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 21)
  │ │       💬 Args: [value]
  │ │       👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Logging._log(string,string,string) (NodeID: 13)
  │     💬 Args: ["// ", a, b]
  │     👁️  Def: internal
  ...
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: InvariantsTestHandler._hintToString(uint256,uint256) (NodeID: 27)
  │ │   💬 Args: [i, v.lowerHint]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: InvariantsTestHandler._isOpen(uint256,uint256) (NodeID: 28)
  │ │ │   💬 Args: [i, troveId]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: EnumerableSetMethods.has(struct EnumerableSet,uint256) (NodeID: 29)
  │ │ │     💬 Args: [_troveIds[i], troveId]
  │ │ │     👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 30)
  │ │     💬 Args: [troveId]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 31)
  │ │       💬 Args: [value]
  │ │       👁️  Def: internal
  ...
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseHandler.logCall(string,string,string,string,string) (NodeID: 60)
  │   💬 Args: ["setBatchManagerAnnualInterestRate", i.toString(), newAnnualInterestRate.decimal(), upperHintSeed.toString(), lowerHintSeed.toString()]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 76)
  │ │   💬 Args: [i]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 77)
  │ │     💬 Args: [value]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StringFormatting.decimal(uint256) (NodeID: 78)
  │ │   💬 Args: [newAnnualInterestRate]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: StringFormatting.groupRight(uint256) (NodeID: 79)
  │ │ │   💬 Args: [integerPart]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 80)
  │ │ │ │   💬 Args: [n]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 81)
  │ │ │ │     💬 Args: [value]
  │ │ │ │     👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: StringFormatting.groupRight(string) (NodeID: 82)
  │ │ │     💬 Args: [n.toString()]
  │ │ │     👁️  Def: internal
  │ │ │   ├─ [5] ⚙️ FUNCTION: StringFormatting.groupRight(bytes) (NodeID: 83)
  │ │ │   │   💬 Args: [bytes(str)]
  │ │ │   │   👁️  Def: internal
  ...
  │ │ │       💬 Args: [bytes(str).groupRight()]
  │ │ │       👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 91)
  │ │ │   💬 Args: [(ONE + fractionalPart)]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 92)
  │ │ │     💬 Args: [value]
  │ │ │     👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: StringFormatting.slice(string,int256) (NodeID: 93)
  │ │ │   💬 Args: [(ONE + fractionalPart).toString(), 1]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: StringFormatting.slice(bytes,int256) (NodeID: 94)
  │ │ │ │   💬 Args: [bytes(str), start]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: StringFormatting.slice(bytes,int256,int256) (NodeID: 95)
  │ │ │ │     💬 Args: [str, start, int256(str.length)]
  │ │ │ │     👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: StringFormatting.toString(bytes) (NodeID: 96)
  │ │ │     💬 Args: [bytes(str).slice(start)]
  │ │ │     👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StringFormatting.trimEnd(string,bytes1) (NodeID: 97)
  │ │     💬 Args: [(ONE + fractionalPart).toString().slice(1), "0"]
  │ │     👁️  Def: internal
  │ │   ├─ [4] ⚙️ FUNCTION: StringFormatting.trimEnd(bytes,bytes1) (NodeID: 98)
  │ │   │   💬 Args: [bytes(str), char]
  │ │   │   👁️  Def: internal
  ...
  │ │       💬 Args: [bytes(str).trimEnd(char)]
  │ │       👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 101)
  │ │   💬 Args: [upperHintSeed]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 102)
  │ │     💬 Args: [value]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 103)
  │ │   💬 Args: [lowerHintSeed]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 104)
  │ │     💬 Args: [value]
  │ │     👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BaseHandler._logCaller() (NodeID: 61)
  │ │   💬 Args: [no args]
  │ │   👁️  Def: internal
  ...
  │ │           💬 Args: [_sendLogPayloadView]
  │ │           👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Logging._log(string,string,string,string,string) (NodeID: 66)
  │ │   💬 Args: [_callPrefix(), functionName, "(", _csv([a, b, c, d]), ");"]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BaseHandler._callPrefix() (NodeID: 70)
  │ │ │   💬 Args: [no args]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Logging._csv(string[4]) (NodeID: 71)
  │ │ │   💬 Args: [[a, b, c, d]]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: console.log(string) (NodeID: 67)
  │ │     💬 Args: [string.concat(a, b, c, d, e)]
  │ │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 68)
  │ │       💬 Args: [abi.encodeWithSignature("log(string)", p0)]
  │ │       👁️  Def: internal
  │ │     └─ [5] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 69)
  │ │         💬 Args: [_sendLogPayloadView]
  │ │         👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Logging._log() (NodeID: 72)
  │     💬 Args: [no args]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: console.log() (NodeID: 73)
  │       💬 Args: [no args]
  │       👁️  Def: internal
  ...
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InvariantsTestHandler._TCR(uint256) (NodeID: 105)
  │   💬 Args: [i]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: InvariantsTestHandler._TCR(uint256,int256,int256,uint256) (NodeID: 106)
  │     💬 Args: [i, 0, 0, 0]
  │     👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: Unknown.add(uint256,int256) (NodeID: 107)
  │   │   💬 Args: [branches[i].troveManager.getEntireBranchColl(), collDelta]
  │   │   👁️  Def: internal
  │   ├─ [3] ⚙️ FUNCTION: Unknown.add(uint256,int256) (NodeID: 108)
  │   │   💬 Args: [branches[i].troveManager.getEntireBranchDebt(), debtDelta]
  │   │   👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: InvariantsTestHandler._CR(uint256,uint256,uint256) (NodeID: 109)
  │       💬 Args: [i, coll, debt]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 110)
  │   💬 Args: [isShutdown[i], "Should have failed as branch had been shut down"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 111)
  │   💬 Args: [_batchManagers[i].has(msg.sender), "Should have failed as batch manager wasn't valid"]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: EnumerableAddressSetMethods.has(struct EnumerableAddressSet,address) (NodeID: 112)
  │     💬 Args: [_batchManagers[i], msg.sender]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: EnumerableSetMethods.has(struct EnumerableSet,uint256) (NodeID: 113)
  │       💬 Args: [set._base, uint256(uint160(element))]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGeDecimal(uint256,uint256,uint256,string) (NodeID: 114)
  │   💬 Args: [newAnnualInterestRate, batch.interestRateMin, 18, "Should have failed as interest rate wasn't in range"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLeDecimal(uint256,uint256,uint256,string) (NodeID: 115)
  │   💬 Args: [newAnnualInterestRate, batch.interestRateMax, 18, "Should have failed as interest rate wasn't in range"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGe(uint256,uint256,string) (NodeID: 116)
  │   💬 Args: [_timeSinceLastBatchInterestRateAdjustment[i][msg.sender], batch.period, "Should have failed as period hasn't passed"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGeDecimal(uint256,uint256,uint256,string) (NodeID: 117)
  │   💬 Args: [newTCR, CCR[i], 18, "Should have failed as new TCR < CCR"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: EnumerableSetMethods.size(struct EnumerableSet) (NodeID: 118)
  │   💬 Args: [batch.troves]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: EnumerableSetMethods.get(struct EnumerableSet,uint256) (NodeID: 119)
  │   💬 Args: [batch.troves, j]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InvariantsTestHandler._touchBatch(uint256,address) (NodeID: 120)
  │   💬 Args: [i, msg.sender]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EnumerableSetMethods.size(struct EnumerableSet) (NodeID: 121)
  │ │   💬 Args: [_batches[i][batchManager].troves]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: EnumerableSetMethods.get(struct EnumerableSet,uint256) (NodeID: 122)
  ...
  │     💬 Args: [trove]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InvariantsTestHandler._getBatchDebt(uint256,address) (NodeID: 125)
  │   💬 Args: [i, msg.sender]
  │   👁️  Def: internal
  ...
  │     💬 Args: [batchTroves, j]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbsDecimal(uint256,uint256,uint256,uint256,string) (NodeID: 128)
  │   💬 Args: [v.b.entireDebtWithoutRedistribution, 0, 1e3, 18, "Batch debt should be negligible"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbsDecimal(uint256,uint256,uint256,uint256,string) (NodeID: 129)
  │   💬 Args: [v.upfrontFee, 0, 10, 18, "Upfront fee should be negligible"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: EnumerableSetMethods.size(struct EnumerableSet) (NodeID: 130)
  │   💬 Args: [batch.troves]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: EnumerableSetMethods.get(struct EnumerableSet,uint256) (NodeID: 131)
  │   💬 Args: [batch.troves, j]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 161)
  ...
  │       💬 Args: [set._base, uint256(uint160(element))]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool,string) (NodeID: 164)
  │   💬 Args: [(batch.interestRateMin <= newAnnualInterestRate) && (newAnnualInterestRate <= batch.interestRateMax), "Shouldn't have failed as interest rate was in range"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256,string) (NodeID: 165)
  │   💬 Args: [_timeSinceLastBatchInterestRateAdjustment[i][msg.sender], batch.period, "Shouldn't have failed as period has passed"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: InvariantsTestHandler._TCR(uint256,int256,int256,uint256) (NodeID: 166)
  │   💬 Args: [i, 0, 0, v.upfrontFee]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.add(uint256,int256) (NodeID: 167)
  │ │   💬 Args: [branches[i].troveManager.getEntireBranchColl(), collDelta]
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Unknown.add(uint256,int256) (NodeID: 168)
  │ │   💬 Args: [branches[i].troveManager.getEntireBranchDebt(), debtDelta]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: InvariantsTestHandler._CR(uint256,uint256,uint256) (NodeID: 169)
  │     💬 Args: [i, coll, debt]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool,string) (NodeID: 170)
  │   💬 Args: [v.premature, "Shouldn't have failed as adjustment was not premature"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLtDecimal(uint256,uint256,uint256,string) (NodeID: 171)
  │   💬 Args: [newTCR, CCR[i], 18, "Shouldn't have failed as new TCR >= CCR"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Logging.info(string,string) (NodeID: 172)
  │   💬 Args: ["New TCR would have been: ", newTCR.decimal()]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StringFormatting.decimal(uint256) (NodeID: 177)
  │ │   💬 Args: [newTCR]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: StringFormatting.groupRight(uint256) (NodeID: 178)
  │ │ │   💬 Args: [integerPart]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 179)
  │ │ │ │   💬 Args: [n]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 180)
  │ │ │ │     💬 Args: [value]
  │ │ │ │     👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: StringFormatting.groupRight(string) (NodeID: 181)
  │ │ │     💬 Args: [n.toString()]
  │ │ │     👁️  Def: internal
  │ │ │   ├─ [5] ⚙️ FUNCTION: StringFormatting.groupRight(bytes) (NodeID: 182)
  │ │ │   │   💬 Args: [bytes(str)]
  │ │ │   │   👁️  Def: internal
  │ │ │   └─ [5] ⚙️ FUNCTION: StringFormatting.toString(bytes) (NodeID: 183)
  │ │ │       💬 Args: [bytes(str).groupRight()]
  │ │ │       👁️  Def: internal
  ...
  │ │ │       💬 Args: [bytes(str).groupRight()]
  │ │ │       👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 190)
  │ │ │   💬 Args: [(ONE + fractionalPart)]
  │ │ │   👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 191)
  │ │ │     💬 Args: [value]
  │ │ │     👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: StringFormatting.slice(string,int256) (NodeID: 192)
  │ │ │   💬 Args: [(ONE + fractionalPart).toString(), 1]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: StringFormatting.slice(bytes,int256) (NodeID: 193)
  │ │ │ │   💬 Args: [bytes(str), start]
  │ │ │ │   👁️  Def: internal
  │ │ │ │ └─ [5] ⚙️ FUNCTION: StringFormatting.slice(bytes,int256,int256) (NodeID: 194)
  │ │ │ │     💬 Args: [str, start, int256(str.length)]
  │ │ │ │     👁️  Def: internal
  │ │ │ └─ [4] ⚙️ FUNCTION: StringFormatting.toString(bytes) (NodeID: 195)
  │ │ │     💬 Args: [bytes(str).slice(start)]
  │ │ │     👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: StringFormatting.trimEnd(string,bytes1) (NodeID: 196)
  │ │     💬 Args: [(ONE + fractionalPart).toString().slice(1), "0"]
  │ │     👁️  Def: internal
  │ │   ├─ [4] ⚙️ FUNCTION: StringFormatting.trimEnd(bytes,bytes1) (NodeID: 197)
  │ │   │   💬 Args: [bytes(str), char]
  │ │   │   👁️  Def: internal
  │ │   │ └─ [5] ⚙️ FUNCTION: StringFormatting.slice(bytes,int256,int256) (NodeID: 198)
  │ │   │     💬 Args: [str, 0, int256(end)]
  │ │   │     👁️  Def: internal
  │ │   └─ [4] ⚙️ FUNCTION: StringFormatting.toString(bytes) (NodeID: 199)
  │ │       💬 Args: [bytes(str).trimEnd(char)]
  │ │       👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Logging._log(string,string,string) (NodeID: 173)
  │     💬 Args: ["// ", a, b]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: console.log(string) (NodeID: 174)
  │       💬 Args: [string.concat(a, b, c)]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 175)
  │         💬 Args: [abi.encodeWithSignature("log(string)", p0)]
  │         👁️  Def: internal
  │       └─ [5] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 176)
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Logging.info(string,string) (NodeID: 200)
  │   💬 Args: ["Expected error: ", v.errorString]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: Logging._log(string,string,string) (NodeID: 201)
  │     💬 Args: ["// ", a, b]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: console.log(string) (NodeID: 202)
  │       💬 Args: [string.concat(a, b, c)]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 203)
  │         💬 Args: [abi.encodeWithSignature("log(string)", p0)]
  │         👁️  Def: internal
  │       └─ [5] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 204)
  │           💬 Args: [_sendLogPayloadView]
  │           👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: Logging._log() (NodeID: 205)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: console.log() (NodeID: 206)
  │     💬 Args: [no args]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: StdUtils._sendLogPayload(bytes) (NodeID: 207)
  │       💬 Args: [abi.encodeWithSignature("log()")]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: StdUtils._castLogPayloadViewToPure(function (bytes) view) (NodeID: 208)
  │         💬 Args: [_sendLogPayloadView]
  │         👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: InvariantsTestHandler._sweepBold(address,uint256) (NodeID: 209)
      💬 Args: [msg.sender, v.b.accruedManagementFee]
      👁️  Def: internal
```
