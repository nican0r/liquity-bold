# Function: openTroveAndJoinInterestBatchManager(uint256,uint256,uint256,uint32,uint32,uint32)
...
```
┌─ [0] ⚙️ FUNCTION: InvariantsTestHandler.openTroveAndJoinInterestBatchManager(uint256,uint256,uint256,uint32,uint32,uint32) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
