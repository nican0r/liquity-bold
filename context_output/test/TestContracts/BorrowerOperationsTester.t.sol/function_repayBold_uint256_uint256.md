...
┌─ [0] ⚙️ FUNCTION: BorrowerOperations.repayBold(uint256,uint256) (NodeID: 0)
  ...
  └─ [1] ⚙️ FUNCTION: BorrowerOperations._adjustTrove(contract ITroveManager,uint256,struct TroveChange,uint256) (NodeID: 2)
    ...
    │     💬 Args: [_price]
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchColl() (NodeID: 7)
    │   │   💬 Args: [no args]
    │   │   👁️  Def: public
    │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchDebt() (NodeID: 8)
    │   │   💬 Args: [no args]
    │   │   👁️  Def: public
    ...
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: BorrowerOperations._requireValidAdjustmentInCurrentMode(struct TroveChange,struct BorrowerOperations.LocalVariables_adjustTrove,bool) (NodeID: 21)
    │   💬 Args: [_troveChange, vars, isTroveInBatch]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireICRisAboveMCRPlusBCR(uint256) (NodeID: 22)
    │ │   💬 Args: [_vars.newICR]
    │ │   👁️  Def: internal
    ...
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchColl() (NodeID: 25)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchDebt() (NodeID: 26)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: public
