# Function: getEntireDebtAndColl(uint256)
...
function getEntireDebtAndColl(uint256 _troveId) external view returns (uint256 entireDebt, uint256 entireColl, uint256 pendingBoldDebtReward, uint256 pendingCollReward, uint256 accruedTroveInterest) {
    ...
    return (trove.entireDebt, trove.entireColl, trove.redistBoldDebtGain, trove.redistCollGain, trove.accruedInterest);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: TroveManagerTester.getEntireDebtAndColl(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
