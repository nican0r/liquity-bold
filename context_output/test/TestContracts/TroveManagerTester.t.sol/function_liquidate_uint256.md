...
- **Kind**: internal
- **Source**: 16919:2461:188
- **Link**: `src/TroveManager.sol:TroveManager:batchLiquidateTroves(uint256[])`
...
```
┌─ [0] ⚙️ FUNCTION: TroveManagerTester.liquidate(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: TroveManager.batchLiquidateTroves(uint256[]) (NodeID: 1)
      💬 Args: [troves]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: LiquityMath._min(uint256,uint256) (NodeID: 2)
    │   💬 Args: [MIN_BOLD_IN_SP, totalBoldDeposits]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TroveManager._batchLiquidateTroves(contract IDefaultPool,uint256,uint256,uint256[],struct TroveManager.LiquidationValues,struct TroveChange) (NodeID: 3)
    │   💬 Args: [defaultPoolCached, price, boldInSPForOffsets, _troveArray, totals, troveChange]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TroveManager._isActiveOrZombie(enum ITroveManager.Status) (NodeID: 4)
    │ │   💬 Args: [Troves[troveId].status]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TroveManager.getCurrentICR(uint256,uint256) (NodeID: 5)
    │ │   💬 Args: [troveId, _price]
    │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._getLatestTroveData(uint256,struct LatestTroveData) (NodeID: 6)
    │ │ │   💬 Args: [_troveId, trove]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getBatchManager(uint256) (NodeID: 7)
    │ │ │ │   💬 Args: [_troveId]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getLatestBatchData(address,struct LatestBatchData) (NodeID: 8)
    │ │ │ │   💬 Args: [batchAddress, batch]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ ├─ [6] ⚙️ FUNCTION: TroveManager._getInterestPeriod(uint256) (NodeID: 9)
    │ │ │ │ │   💬 Args: [batch.lastDebtUpdateTime]
    │ │ │ │ │   👁️  Def: internal
    │ │ │ │ ├─ [6] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 10)
    │ │ │ │ │   💬 Args: [latestBatchData.weightedRecordedDebt, period]
    │ │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 11)
    │ │ │ │     💬 Args: [latestBatchData.weightedRecordedBatchManagementFee, period]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getLatestTroveDataFromBatch(uint256,struct LatestTroveData,struct LatestBatchData) (NodeID: 12)
    │ │ │ │   💬 Args: [_troveId, trove, batch]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: LiquityMath._max(uint256,uint256) (NodeID: 13)
    │ │ │ │     💬 Args: [_latestBatchData.lastInterestRateAdjTime, trove.lastInterestRateAdjTime]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getInterestPeriod(uint256) (NodeID: 14)
    ...
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: LiquityMath._computeCR(uint256,uint256,uint256) (NodeID: 16)
    │ │     💬 Args: [trove.entireColl, trove.entireDebt, _price]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TroveManager._liquidate(contract IDefaultPool,uint256,uint256,uint256,struct LatestTroveData,struct TroveManager.LiquidationValues) (NodeID: 17)
    │ │   💬 Args: [_defaultPool, troveId, remainingBoldInSPForOffsets, _price, trove, singleLiquidation]
    │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._getLatestTroveData(uint256,struct LatestTroveData) (NodeID: 18)
    │ │ │   💬 Args: [_troveId, trove]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getBatchManager(uint256) (NodeID: 19)
    │ │ │ │   💬 Args: [_troveId]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getLatestBatchData(address,struct LatestBatchData) (NodeID: 20)
    │ │ │ │   💬 Args: [batchAddress, batch]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ ├─ [6] ⚙️ FUNCTION: TroveManager._getInterestPeriod(uint256) (NodeID: 21)
    │ │ │ │ │   💬 Args: [batch.lastDebtUpdateTime]
    │ │ │ │ │   👁️  Def: internal
    │ │ │ │ ├─ [6] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 22)
    │ │ │ │ │   💬 Args: [latestBatchData.weightedRecordedDebt, period]
    │ │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 23)
    │ │ │ │     💬 Args: [latestBatchData.weightedRecordedBatchManagementFee, period]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getLatestTroveDataFromBatch(uint256,struct LatestTroveData,struct LatestBatchData) (NodeID: 24)
    │ │ │ │   💬 Args: [_troveId, trove, batch]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: LiquityMath._max(uint256,uint256) (NodeID: 25)
    │ │ │ │     💬 Args: [_latestBatchData.lastInterestRateAdjTime, trove.lastInterestRateAdjTime]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getInterestPeriod(uint256) (NodeID: 26)
    │ │ │ │   💬 Args: [Troves[_troveId].lastDebtUpdateTime]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 27)
    │ │ │     💬 Args: [trove.weightedRecordedDebt, period]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._getBatchManager(uint256) (NodeID: 28)
    │ │ │   💬 Args: [_troveId]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._getLatestBatchData(address,struct LatestBatchData) (NodeID: 29)
    │ │ │   💬 Args: [batchAddress, batch]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getInterestPeriod(uint256) (NodeID: 30)
    │ │ │ │   💬 Args: [batch.lastDebtUpdateTime]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 31)
    │ │ │ │   💬 Args: [latestBatchData.weightedRecordedDebt, period]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: LiquityBase._calcInterest(uint256,uint256) (NodeID: 32)
    │ │ │     💬 Args: [latestBatchData.weightedRecordedBatchManagementFee, period]
    │ │ │     👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._movePendingTroveRewardsToActivePool(contract IDefaultPool,uint256,uint256) (NodeID: 33)
    │ │ │   💬 Args: [_defaultPool, trove.redistBoldDebtGain, trove.redistCollGain]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: TroveManager._getOffsetAndRedistributionVals(uint256,uint256,uint256,uint256) (NodeID: 34)
    │ │ │   💬 Args: [trove.entireDebt, trove.entireColl, _boldInSPForOffsets, _price]
    │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: LiquityMath._min(uint256,uint256) (NodeID: 35)
    │ │ │ │   💬 Args: [_entireTroveDebt, _boldInSPForOffsets]
    │ │ │ │   👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getCollGasCompensation(uint256) (NodeID: 36)
    │ │ │ │   💬 Args: [collSPPortion]
    │ │ │ │   👁️  Def: internal
    │ │ │ │ └─ [6] ⚙️ FUNCTION: LiquityMath._min(uint256,uint256) (NodeID: 37)
    │ │ │ │     💬 Args: [_coll / COLL_GAS_COMPENSATION_DIVISOR, COLL_GAS_COMPENSATION_CAP]
    │ │ │ │     👁️  Def: internal
    │ │ │ ├─ [5] ⚙️ FUNCTION: TroveManager._getCollPenaltyAndSurplus(uint256,uint256,uint256,uint256) (NodeID: 38)
    │ │ │ │   💬 Args: [collToOffset, debtToOffset, LIQUIDATION_PENALTY_SP, _price]
    │ │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: TroveManager._getCollPenaltyAndSurplus(uint256,uint256,uint256,uint256) (NodeID: 39)
    │ │ │     💬 Args: [collRedistributionPortion + collSurplus, debtToRedistribute, LIQUIDATION_PENALTY_REDISTRIBUTION, _price]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: TroveManager._closeTrove(uint256,struct TroveChange,address,uint256,uint256,enum ITroveManager.Status) (NodeID: 40)
    ...
    │ │     👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: TroveManager._requireMoreThanOneTroveInSystem(uint256) (NodeID: 41)
    │ │   │   💬 Args: [TroveIdsArrayLength]
    │ │   │   👁️  Def: internal
    │ │   ├─ [5] ⚙️ FUNCTION: TroveManager._removeTroveId(uint256,uint256) (NodeID: 42)
    │ │   │   💬 Args: [_troveId, TroveIdsArrayLength]
    │ │   │   👁️  Def: internal
    │ │   └─ [5] ⚙️ FUNCTION: TroveManager._removeTroveSharesFromBatch(uint256,uint256,uint256,struct TroveChange,address,uint256,uint256) (NodeID: 43)
    │ │       💬 Args: [_troveId, _troveChange.collDecrease, _troveChange.debtDecrease, _troveChange, _batchAddress, _newBatchColl, _newBatchDebt]
    │ │       👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: TroveManager._addLiquidationValuesToTotals(struct LatestTroveData,struct TroveManager.LiquidationValues,struct TroveManager.LiquidationValues,struct TroveChange) (NodeID: 44)
    │     💬 Args: [trove, singleLiquidation, totals, troveChange]
    │     👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TroveManager._redistributeDebtAndColl(contract IActivePool,contract IDefaultPool,uint256,uint256) (NodeID: 45)
    │   💬 Args: [activePoolCached, defaultPoolCached, totals.debtToRedistribute, totals.collToRedistribute]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TroveManager._updateSystemSnapshots_excludeCollRemainder(contract IActivePool,uint256) (NodeID: 46)
    │   💬 Args: [activePoolCached, totals.collGasCompensation]
    │   👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: TroveManager._sendGasCompensation(contract IActivePool,address,uint256,uint256) (NodeID: 47)
