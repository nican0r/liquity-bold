...
- **Name**: SPInvariantsTestHandler
- **Type**: Contract
- **Path**: test/TestContracts/SPInvariantsTestHandler.t.sol
...
```solidity
IBorrowerOperations internal immutable borrowerOperations
```
...
```solidity
IPriceFeedTestnet internal immutable priceFeed
```
...
```solidity
IStabilityPool internal immutable stabilityPool
```
...
```solidity
ITroveManagerTester internal immutable troveManager
```
...
```solidity
HintHelpers internal immutable hintHelpers
```
...
```solidity
uint256 internal immutable initialPrice
```

### troveIndexOf

```solidity
mapping(address => uint256) internal troveIndexOf
```

### myBold

```solidity
uint256 internal myBold = 0
```

### spBold

```solidity
uint256 internal spBold = 0
```

### spColl

```solidity
uint256 internal spColl = 0
```

### fixtureDeposited

```solidity
uint256[] internal fixtureDeposited
```
...
### constructor(struct SPInvariantsTestHandler.Contracts,contract HintHelpers)

- **Signature**: `constructor(struct SPInvariantsTestHandler.Contracts,contract HintHelpers)`
- **Visibility**: public
- **Source Range**: 2440:498:280
- **Details**: [function_constructor_struct_SPInvariantsTestHandler.Contracts_contract_HintHelpers.md](./function_constructor_struct_SPInvariantsTestHandler.Contracts_contract_HintHelpers.md)
...
- **Signature**: `openTrove(uint256)`
- **Visibility**: external
- **Source Range**: 2944:1902:280
- **Details**: [function_openTrove_uint256.md](./function_openTrove_uint256.md)
...
- **Signature**: `liquidateMe()`
- **Visibility**: external
- **Source Range**: 6578:2600:280
- **Details**: [function_liquidateMe.md](./function_liquidateMe.md)
