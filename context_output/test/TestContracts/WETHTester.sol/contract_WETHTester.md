...
- **Name**: WETHTester
- **Type**: Contract
- **Path**: test/TestContracts/WETHTester.sol
...
### tapAmount (inherited from ERC20Faucet)

```solidity
uint256 public immutable tapAmount
```

### tapPeriod (inherited from ERC20Faucet)

```solidity
uint256 public immutable tapPeriod
```

### lastTapped (inherited from ERC20Faucet)

```solidity
mapping(address => uint256) public lastTapped
```

### mock_isWildcardSpender (inherited from ERC20Faucet)
...
- **Details**: [function_constructor_uint256_uint256.md](./function_constructor_uint256_uint256.md)
...
### constructor(string,string,uint256,uint256) (inherited from ERC20Faucet)
...
### mint(address,uint256) (inherited from ERC20Faucet)
...
### tapTo(address) (inherited from ERC20Faucet)
...
### tap() (inherited from ERC20Faucet)
...
### mock_setWildcardSpender(address,bool) (inherited from ERC20Faucet)
