...
- **Name**: LiquidationCostsTest
- **Type**: Contract
- **Path**: test/liquidationCosts.t.sol
...
### testBatchLiquidationsOffset()

- **Signature**: `testBatchLiquidationsOffset()`
- **Visibility**: public
- **Source Range**: 200:1237:308
- **Details**: [function_testBatchLiquidationsOffset.md](./function_testBatchLiquidationsOffset.md)
...
### testBatchLiquidationsRedistribution()

- **Signature**: `testBatchLiquidationsRedistribution()`
- **Visibility**: public
- **Source Range**: 1443:1166:308
- **Details**: [function_testBatchLiquidationsRedistribution.md](./function_testBatchLiquidationsRedistribution.md)
