# Function: testBatchLiquidationsOffset()
...
- **Signature**: `testBatchLiquidationsOffset()`
- **Visibility**: public
- **Source Range**: 200:1237:308
...
```
┌─ [0] ⚙️ FUNCTION: LiquidationCostsTest.testBatchLiquidationsOffset() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, N_TROVES * 5000e18]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pctWithIndex(address,uint256,uint256,uint256,uint256) (NodeID: 5)
  ...
  │       💬 Args: [_boldAmount, _annualInterestRate]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 8)
  │   💬 Args: [troveManager.checkBelowCriticalThreshold(price), false, "System should not be below CT"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.batchLiquidateTroves(address,uint256[]) (NodeID: 9)
  │   💬 Args: [A, trovesToLiq]
  │   👁️  Def: public
