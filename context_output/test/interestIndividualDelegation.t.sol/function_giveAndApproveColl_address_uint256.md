# Function: giveAndApproveColl(address,uint256)
...
```
┌─ [0] ⚙️ FUNCTION: DevTestSetup.giveAndApproveColl(address,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: DevTestSetup.giveAndApproveCollateral(contract IERC20,address,uint256,address) (NodeID: 1)
    ...
    │             💬 Args: [self]
    │             👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 100)
