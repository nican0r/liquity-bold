# Function: testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
