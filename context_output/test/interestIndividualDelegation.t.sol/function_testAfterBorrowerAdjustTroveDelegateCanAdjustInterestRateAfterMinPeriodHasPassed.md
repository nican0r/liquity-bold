# Function: testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
