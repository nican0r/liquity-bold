# Function: testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 4)
      💬 Args: [trove.annualInterestRate, 11e16]
      👁️  Def: internal
```
