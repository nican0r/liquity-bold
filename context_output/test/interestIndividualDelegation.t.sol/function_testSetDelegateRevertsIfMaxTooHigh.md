# Function: testSetDelegateRevertsIfMaxTooHigh()
...
function testSetDelegateRevertsIfMaxTooHigh() public {
    ...
    borrowerOperations.setInterestIndividualDelegate(troveId, C, 1e16, uint128(MAX_ANNUAL_INTEREST_RATE) + 1, 0, 0, 0, 10000e18, 0);
    vm.stopPrank();
}
```
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testSetDelegateRevertsIfMaxTooHigh() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
