# Function: testTroveAfterUrgentRedemptionHas0AccruedInterest()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testTroveAfterUrgentRedemptionHas0AccruedInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debtAfter3, debtBefore3 - redemptionAmount]
  │   👁️  Def: internal
