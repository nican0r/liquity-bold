# Function: testTroveAfterUrgentRedemptionEarnsNoInterest()
...
- **ITroveManagerTester::getEntireDebtAndColl(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testTroveAfterUrgentRedemptionEarnsNoInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debtBefore3, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.uintToArray(uint256) (NodeID: 13)
  │   💬 Args: [troveId3]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 14)
  │   💬 Args: [troveManager.calcTroveAccruedInterest(troveId3), 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 15)
  │   💬 Args: [debtAfter3, 0, "Debt should be positive"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 16)
  │   💬 Args: [debtAfter3, debtBefore3 - redemptionAmount, "Debt mismatch"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 17)
      💬 Args: [troveManager.calcTroveAccruedInterest(troveId3), 0, "Trove accrued interest should be zero"]
      👁️  Def: internal
```
