# Function: testUrgentRedeemRevertsIfMinNotReached()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testUrgentRedeemRevertsIfMinNotReached() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveId]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.uintToArray(uint256) (NodeID: 6)
      💬 Args: [troveId]
      👁️  Def: public
```
