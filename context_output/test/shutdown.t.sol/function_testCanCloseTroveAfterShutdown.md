# Function: testCanCloseTroveAfterShutdown()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testCanCloseTroveAfterShutdown() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [0, B, 0, 11e18, 10000e18, 5e16]
  │   👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ShutdownTest.prepareAndShutdownFirstBranch() (NodeID: 4)
  │   💬 Args: [no args]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: ShutdownTest.openMulticollateralTroveNoHints100pctWithIndex(uint256,address,uint256,uint256,uint256,uint256) (NodeID: 5)
  │     💬 Args: [0, A, 0, 11e18, 10000e18, 5e16]
  │     👁️  Def: public
  │   └─ [3] ⚙️ FUNCTION: BaseTest.calcUpfrontFee(uint256,uint256) (NodeID: 6)
  │       💬 Args: [troveChange.debtIncrease, avgInterestRate]
  │       👁️  Def: internal
  │     └─ [4] ⚙️ FUNCTION: BaseTest.calcInterest(uint256,uint256) (NodeID: 7)
  │         💬 Args: [debt * avgInterestRate, UPFRONT_INTEREST_PERIOD]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 8)
  │   💬 Args: [address(boldToken), A, 20000e18]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 106)
      💬 Args: [uint8(troveManager.getTroveStatus(troveId)), uint8(ITroveManager.Status.closedByOwner)]
      👁️  Def: internal
```
