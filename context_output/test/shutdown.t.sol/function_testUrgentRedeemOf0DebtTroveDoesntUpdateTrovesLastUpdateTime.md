# Function: testUrgentRedeemOf0DebtTroveDoesntUpdateTrovesLastUpdateTime()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testUrgentRedeemOf0DebtTroveDoesntUpdateTrovesLastUpdateTime() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │       💬 Args: [debt * avgInterestRate, UPFRONT_INTEREST_PERIOD]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.uintToArray(uint256) (NodeID: 10)
  │   💬 Args: [troveId]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 11)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveId), 0, "Trove debt not reduced to 0"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 12)
  │   💬 Args: [lastDebtUpdateTime1, block.timestamp, "first update time incorrect"]
  │   👁️  Def: internal
