# Function: testCannotApplyTroveInterestPermissionlesslyAfterShutdown()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testCannotApplyTroveInterestPermissionlesslyAfterShutdown() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
