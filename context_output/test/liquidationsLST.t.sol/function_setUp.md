...
function setUp() override public {
    ...
    (contracts, collateralRegistry, boldToken, , , , ) = deployer.deployAndConnectContracts(TestDeployer.TroveManagerParams(160e16, 120e16, 10e16, 120e16, 5e16, 10e16));
...
- **Vm::warp(uint256)**
- **TestDeployer::deployAndConnectContracts(struct TestDeployer.TroveManagerParams)**
...
```
┌─ [0] ⚙️ FUNCTION: LiquidationsLSTTest.setUp() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: TestAccounts.createAccounts() (NodeID: 1)
  │   💬 Args: [no args]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: DevTestSetup.giveAndApproveColl(address,uint256) (NodeID: 2)
      💬 Args: [accountsList[i], initialCollAmount]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: DevTestSetup.giveAndApproveCollateral(contract IERC20,address,uint256,address) (NodeID: 3)
      ...
      │             💬 Args: [self]
      │             👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 102)
      │   💬 Args: [_token.balanceOf(_account), _amount]
      │   👁️  Def: internal
      └─ [3] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 103)
