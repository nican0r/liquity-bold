...
- **Name**: ProvideUniV3Liquidity
- **Type**: Contract
- **Path**: script/ProvideUniV3Liquidity.s.sol
...
```solidity
WETHTester internal constant WETH = WETHTester(payable(0x3e8Bd35e898505EE0dD29277ee42eD92021C82aF))
```
...
```solidity
ERC20Faucet internal constant usdc = ERC20Faucet(0xF00ad39d0aC1A422DAB5A2EceBAa5268ea909aD4)
```

**ERC20Faucet**: [test/TestContracts/ERC20Faucet.sol/contract_ERC20Faucet.md]

### wstETH

```solidity
ERC20Faucet internal constant wstETH = ERC20Faucet(0xC5958986793086593871f207975053cf66d0B764)
```
...
```solidity
ERC20Faucet internal constant rETH = ERC20Faucet(0x078c20A159eA4EdF8d029Fb21E6bd120455B4acc)
```
