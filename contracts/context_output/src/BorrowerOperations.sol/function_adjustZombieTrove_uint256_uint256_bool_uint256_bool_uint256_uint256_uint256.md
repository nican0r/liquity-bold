...
┌─ [0] ⚙️ FUNCTION: BorrowerOperations.adjustZombieTrove(uint256,uint256,bool,uint256,bool,uint256,uint256,uint256) (NodeID: 0)
  ...
  │ │     💬 Args: [_price]
  │ │     👁️  Def: internal
  │ │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchColl() (NodeID: 9)
  │ │   │   💬 Args: [no args]
  │ │   │   👁️  Def: public
  │ │   ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchDebt() (NodeID: 10)
  │ │   │   💬 Args: [no args]
  │ │   │   👁️  Def: public
  ...
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: BorrowerOperations._requireValidAdjustmentInCurrentMode(struct TroveChange,struct BorrowerOperations.LocalVariables_adjustTrove,bool) (NodeID: 23)
  │ │   💬 Args: [_troveChange, vars, isTroveInBatch]
  │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireICRisAboveMCRPlusBCR(uint256) (NodeID: 24)
  │ │ │   💬 Args: [_vars.newICR]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireICRisAboveMCR(uint256) (NodeID: 25)
  │ │ │   💬 Args: [_vars.newICR]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._getNewTCRFromTroveChange(struct TroveChange,uint256) (NodeID: 26)
  │ │ │   💬 Args: [_troveChange, _vars.price]
  │ │ │   👁️  Def: internal
  │ │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchColl() (NodeID: 27)
  │ │ │ │   💬 Args: [no args]
  │ │ │ │   👁️  Def: public
  │ │ │ ├─ [4] ⚙️ FUNCTION: LiquityBase.getEntireBranchDebt() (NodeID: 28)
  │ │ │ │   💬 Args: [no args]
  │ │ │ │   👁️  Def: public
  │ │ │ └─ [4] ⚙️ FUNCTION: LiquityMath._computeCR(uint256,uint256,uint256) (NodeID: 29)
  │ │ │     💬 Args: [totalColl, totalDebt, _price]
  │ │ │     👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireNoBorrowingUnlessNewTCRisAboveCCR(uint256,uint256) (NodeID: 30)
  │ │ │   💬 Args: [_troveChange.debtIncrease, newTCR]
  │ │ │   👁️  Def: internal
  │ │ ├─ [3] ⚙️ FUNCTION: BorrowerOperations._requireDebtRepaymentGeCollWithdrawal(struct TroveChange,uint256) (NodeID: 31)
  │ │ │   💬 Args: [_troveChange, _vars.price]
  │ │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: BorrowerOperations._requireNewTCRisAboveCCR(uint256) (NodeID: 32)
  │ │     💬 Args: [newTCR]
  │ │     👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BorrowerOperations._moveTokensFromAdjustment(address,struct TroveChange,contract IBoldToken,contract IActivePool) (NodeID: 33)
  │     💬 Args: [receiver, _troveChange, vars.boldToken, vars.activePool]
  │     👁️  Def: internal
  │   └─ [3] ⚙️ FUNCTION: BorrowerOperations._pullCollAndSendToActivePool(contract IActivePool,uint256) (NodeID: 34)
  │       💬 Args: [_activePool, _troveChange.collIncrease]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperations._reInsertIntoSortedTroves(uint256,uint256,uint256,uint256,address,uint256) (NodeID: 35)
