# Function: kickFromBatch(uint256,uint256,uint256)
...
function kickFromBatch(uint256 _troveId, uint256 _upperHint, uint256 _lowerHint) override external {
    _removeFromBatch({_troveId: _troveId, _newAnnualInterestRate: 0, _upperHint: _upperHint, _lowerHint: _lowerHint, _maxUpfrontFee: 0, _kick: true});
}
```
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperations.kickFromBatch(uint256,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: BorrowerOperations._removeFromBatch(uint256,uint256,uint256,uint256,uint256,bool) (NodeID: 1)
      💬 Args: [_troveId, 0, _upperHint, _lowerHint, 0, true]
      👁️  Def: internal
