# Function: testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTest.testWithdrawBoldRevertsIfUpfrontFeeExceedsUserProvidedLimit() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
