# Function: testCloseLastTroveReverts()
...
### checkBelowCriticalThreshold(bool)

- **Kind**: internal
- **Source**: 10899:250:254
- **Link**: `test/TestContracts/BaseTest.sol:BaseTest:checkBelowCriticalThreshold(bool)`
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTest.testCloseLastTroveReverts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [A, 100 ether, 100000e18, 1e17]
  │   👁️  Def: public
  ...
  │   💬 Args: [address(boldToken), A, aliceDebt]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.checkBelowCriticalThreshold(bool) (NodeID: 102)
      💬 Args: [false]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool) (NodeID: 103)
