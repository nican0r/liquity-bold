...
```solidity
uint256 internal NUM_COLLATERALS = 3
```

### NUM_VARIANTS

```solidity
uint256 internal NUM_VARIANTS = 4
```
...
```solidity
TroveNFT internal troveNFTWETH
```
...
```solidity
TroveNFT internal troveNFTWstETH
```
...
```solidity
TroveNFT internal troveNFTRETH
```
...
```solidity
string internal topMulti = "<!DOCTYPE html><html lang=\"en\"><head><Title>Test Uri</Title><style>.container{display:flex;flex-direction:row;margin-bottom:20px}.container img{width:300px;height:484px;margin-right:20px}.container pre{flex:1}</style></head><body><script>"
```
...
### testTroveNFTMetadata()

- **Signature**: `testTroveNFTMetadata()`
- **Visibility**: public
- **Source Range**: 5650:579:336
- **Details**: [function_testTroveNFTMetadata.md](./function_testTroveNFTMetadata.md)
...
### _writeUriFile(string[])

- **Signature**: `_writeUriFile(string[])`
- **Visibility**: public
- **Source Range**: 6508:1444:336
- **Details**: [function__writeUriFile_string[].md](./function__writeUriFile_string[].md)
...
- **Signature**: `testTroveURI()`
- **Visibility**: public
- **Source Range**: 7958:562:336
- **Details**: [function_testTroveURI.md](./function_testTroveURI.md)
...
### testTroveURIAttributes()

- **Signature**: `testTroveURIAttributes()`
- **Visibility**: public
- **Source Range**: 8526:2364:336
- **Details**: [function_testTroveURIAttributes.md](./function_testTroveURIAttributes.md)
...
- **Details**: [function_test_toLocale.md](./function_test_toLocale.md)
...
- **Details**: [function_test_toLocaleString.md](./function_test_toLocaleString.md)
