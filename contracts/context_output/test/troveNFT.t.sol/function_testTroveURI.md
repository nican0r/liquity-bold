...
- **Kind**: internal
- **Source**: 6508:1444:336
- **Link**: `test/troveNFT.t.sol:troveNFTTest:_writeUriFile(string[])`
...
```
┌─ [0] ⚙️ FUNCTION: troveNFTTest.testTroveURI() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdCheats.deal(address,address,uint256) (NodeID: 1)
  │   💬 Args: [address(boldToken), A, 30000e18]
  │   👁️  Def: internal
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 99)
  │   💬 Args: [A, 30000e18]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: troveNFTTest._writeUriFile(string[]) (NodeID: 100)
      💬 Args: [uris]
      👁️  Def: public
```
