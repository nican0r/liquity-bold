...
function testInitiativeRegistrationAndClaim() external {
    ...
    assertEq(boldToken.balanceOf(address(merklDistributionCreator.distributor())) - initialMerklDistributorBoldBalance, campaignAmount, "Merkl Distributor should have campaign amount BOLD");
}
```
...
- **uniV4MerklRewardsInitiative** (`contract UniV4MerklRewards`) [lib/V2-gov/src/UniV4MerklRewards.sol/contract_UniV4MerklRewards.md]
...
```
┌─ [0] ⚙️ FUNCTION: InitiativeUniV4Merkl.testInitiativeRegistrationAndClaim() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │   💬 Args: [governance.registeredInitiatives(address(uniV4MerklRewardsInitiative)), 0, "Initiative should not be registered"]
  │   👁️  Def: internal
  ...
  │   💬 Args: [address(uniV4MerklRewardsInitiative), int256(lqtyStake)]
  │   👁️  Def: internal
  ...
  │   💬 Args: [boldToken.balanceOf(address(uniV4MerklRewardsInitiative)), 0, "Initiative should have sent incentives to campaign"]
  │   👁️  Def: internal
  ...
  │   💬 Args: [campaign.amount, campaignAmount, "amount minus fees"]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bytes,bytes,string) (NodeID: 28)
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 29)
      💬 Args: [boldToken.balanceOf(address(merklDistributionCreator.distributor())) - initialMerklDistributorBoldBalance, campaignAmount, "Merkl Distributor should have campaign amount BOLD"]
      👁️  Def: internal
```
