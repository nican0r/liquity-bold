# Function: testCannotReopenTrove()
...
function testCannotReopenTrove() public {
    ...
    borrowerOperations.openTrove(A, 0, 100 ether, 10000e18, 0, 0, 5e16, 10000e18, C, address(0), address(0));
    vm.stopPrank();
}
```
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testCannotReopenTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [B, 100 ether, 10000e18, 1e17]
  │   👁️  Def: public
  ...
  │             💬 Args: [self]
  │             👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 106)
      💬 Args: [A, ATroveId]
      👁️  Def: public
```
