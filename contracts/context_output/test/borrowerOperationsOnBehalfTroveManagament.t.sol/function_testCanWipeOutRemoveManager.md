# Function: testCanWipeOutRemoveManager()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testCanWipeOutRemoveManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [manager, address(0), "Manager should be wiped out"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(address,address,string) (NodeID: 7)
      💬 Args: [receiver, address(0), "Receiver should be wiped out"]
      👁️  Def: internal
```
