# Function: testSetRemoveManagerWithRemoveManagerAsReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsOnBehalfTroveManagamentTest.testSetRemoveManagerWithRemoveManagerAsReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
