# Function: testBatchLiquidateTrovesPureOffsetUpdatesLastAggInterestUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testBatchLiquidateTrovesPureOffsetUpdatesLastAggInterestUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
