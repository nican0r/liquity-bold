# Function: testClaimAllCollGainsIncreasesAggRecordedDebtByPendingAggInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testClaimAllCollGainsIncreasesAggRecordedDebtByPendingAggInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.claimAllCollGains(address) (NodeID: 29)
  │   💬 Args: [A]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 30)
      💬 Args: [activePool.aggRecordedDebt(), aggRecordedDebt_1 + pendingAggInterest]
      👁️  Def: internal
```
