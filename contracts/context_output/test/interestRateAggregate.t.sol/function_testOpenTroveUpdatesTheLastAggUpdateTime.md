# Function: testOpenTroveUpdatesTheLastAggUpdateTime()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testOpenTroveUpdatesTheLastAggUpdateTime() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
