# Function: testAdjustTroveInterestRateWithNoPendingDebtGainIncreasesAggRecordedDebtByPendingAggInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testAdjustTroveInterestRateWithNoPendingDebtGainIncreasesAggRecordedDebtByPendingAggInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
