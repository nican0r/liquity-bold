# Function: testBatchLiquidateTrovesPureRedistChangesAggRecordedInterestCorrectly()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testBatchLiquidateTrovesPureRedistChangesAggRecordedInterestCorrectly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, trovesToLiq]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 24)
