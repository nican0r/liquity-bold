# Function: testClaimAllCollGainsUpdatesLastAggUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testClaimAllCollGainsUpdatesLastAggUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 28)
