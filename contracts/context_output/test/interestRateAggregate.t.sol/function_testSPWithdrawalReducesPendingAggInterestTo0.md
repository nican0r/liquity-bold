# Function: testSPWithdrawalReducesPendingAggInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testSPWithdrawalReducesPendingAggInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 8)
  │   💬 Args: [A, sPdeposit]
  │   👁️  Def: public
