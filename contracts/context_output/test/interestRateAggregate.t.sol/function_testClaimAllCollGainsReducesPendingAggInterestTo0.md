# Function: testClaimAllCollGainsReducesPendingAggInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testClaimAllCollGainsReducesPendingAggInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
