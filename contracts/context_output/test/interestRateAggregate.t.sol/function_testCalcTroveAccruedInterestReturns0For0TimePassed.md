# Function: testCalcTroveAccruedInterestReturns0For0TimePassed()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCalcTroveAccruedInterestReturns0For0TimePassed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
