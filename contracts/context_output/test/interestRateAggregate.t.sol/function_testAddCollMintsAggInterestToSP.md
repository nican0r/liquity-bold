# Function: testAddCollMintsAggInterestToSP()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testAddCollMintsAggInterestToSP() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.addColl(address,uint256,uint256) (NodeID: 8)
