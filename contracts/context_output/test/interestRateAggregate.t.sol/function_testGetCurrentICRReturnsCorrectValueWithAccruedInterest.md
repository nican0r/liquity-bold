# Function: testGetCurrentICRReturnsCorrectValueWithAccruedInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testGetCurrentICRReturnsCorrectValueWithAccruedInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.calcInterest(uint256,uint256) (NodeID: 6)
