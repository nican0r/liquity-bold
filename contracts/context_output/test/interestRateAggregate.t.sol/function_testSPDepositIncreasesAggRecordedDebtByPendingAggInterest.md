# Function: testSPDepositIncreasesAggRecordedDebtByPendingAggInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testSPDepositIncreasesAggRecordedDebtByPendingAggInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
