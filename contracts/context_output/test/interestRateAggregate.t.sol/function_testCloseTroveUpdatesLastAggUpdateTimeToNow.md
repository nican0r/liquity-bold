# Function: testCloseTroveUpdatesLastAggUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCloseTroveUpdatesLastAggUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 10)
  │   💬 Args: [B, BTroveId]
  │   👁️  Def: public
