# Function: testWithdrawBoldUpdatesLastAggUpdateTimeToNow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testWithdrawBoldUpdatesLastAggUpdateTimeToNow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.withdrawBold100pct(address,uint256,uint256) (NodeID: 6)
  │   💬 Args: [A, ATroveId, debtIncrease]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 7)
