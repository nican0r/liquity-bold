# Function: testBatchLiquidateTrovesPureRedistMintsAggInterestToSP()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testBatchLiquidateTrovesPureRedistMintsAggInterestToSP() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: DevTestSetup._getSPYield(uint256) (NodeID: 18)
  │   💬 Args: [pendingAggInterest]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 19)
  │ │   💬 Args: [spYield, 0]
  │ │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256) (NodeID: 20)
  │     💬 Args: [spYield, _aggInterest]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.batchLiquidateTroves(address,uint256[]) (NodeID: 21)
  │   💬 Args: [A, trovesToLiq]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 22)
  │   💬 Args: [troveManager.hasRedistributionGains(ATroveId)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 23)
      💬 Args: [boldBalSP_2 - boldBalSP_1, expectedSPYield]
      👁️  Def: internal
```
