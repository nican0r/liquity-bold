# Function: testCloseTroveReducesAggWeightedDebtSumByTrovesWeightedRecordedDebt()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCloseTroveReducesAggWeightedDebtSumByTrovesWeightedRecordedDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 12)
      💬 Args: [activePool.aggWeightedDebtSum(), aggWeightedDebtSum_1 - weightedTroveDebt]
      👁️  Def: internal
```
