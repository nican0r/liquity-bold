# Function: testCloseTroveAddsPendingAggInterestAndSubtractsRecordedDebtPlusInterestFromAggRecordedDebt()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testCloseTroveAddsPendingAggInterestAndSubtractsRecordedDebtPlusInterestFromAggRecordedDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [entireTroveDebt_B, troveManager.getTroveDebt(BTroveId)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 11)
  │   💬 Args: [B, BTroveId]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 12)
      💬 Args: [activePool.aggRecordedDebt(), (aggRecordedDebt_1 + pendingAggInterest) - entireTroveDebt_B]
      👁️  Def: internal
```
