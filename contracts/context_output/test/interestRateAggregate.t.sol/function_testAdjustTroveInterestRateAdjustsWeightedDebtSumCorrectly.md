# Function: testAdjustTroveInterestRateAdjustsWeightedDebtSumCorrectly()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testAdjustTroveInterestRateAdjustsWeightedDebtSumCorrectly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, ATroveId, newAnnualInterestRate]
  │   👁️  Def: public
