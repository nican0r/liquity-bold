# Function: testRedemptionWithNoRedistGainsChangesAggRecordedDebtCorrectly()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateAggregate.testRedemptionWithNoRedistGainsChangesAggRecordedDebtCorrectly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 43)
      💬 Args: [activePool.aggRecordedDebt(), (aggRecordedDebt_1 + pendingAggInterest) - debt_A]
      👁️  Def: internal
```
