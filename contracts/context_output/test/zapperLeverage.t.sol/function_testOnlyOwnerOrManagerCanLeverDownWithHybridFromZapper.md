# Function: testOnlyOwnerOrManagerCanLeverDownWithHybridFromZapper()
...
### _testOnlyOwnerOrManagerCanLeverDownFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)

- **Kind**: internal
- **Source**: 55741:1800:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testOnlyOwnerOrManagerCanLeverDownFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithHybridFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testOnlyOwnerOrManagerCanLeverDownFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256) (NodeID: 1)
      💬 Args: [leverageZapperUniV3Array[i], ExchangeType.HybridCurveUniV3, i]
      👁️  Def: internal
