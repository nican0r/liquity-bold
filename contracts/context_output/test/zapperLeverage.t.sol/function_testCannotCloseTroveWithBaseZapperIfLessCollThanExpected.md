# Function: testCannotCloseTroveWithBaseZapperIfLessCollThanExpected()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotCloseTroveWithBaseZapperIfLessCollThanExpected() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
