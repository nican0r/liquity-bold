# Function: testCanOpenTroveWithCurve()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCanOpenTroveWithCurve() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCanOpenTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256,address) (NodeID: 1)
      💬 Args: [leverageZapperCurveArray[i], ExchangeType.Curve, i, address(0)]
      👁️  Def: internal
