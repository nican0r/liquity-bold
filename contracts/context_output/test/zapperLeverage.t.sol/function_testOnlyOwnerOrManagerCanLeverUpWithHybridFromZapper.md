# Function: testOnlyOwnerOrManagerCanLeverUpWithHybridFromZapper()
...
### _testOnlyOwnerOrManagerCanLeverUpFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)

- **Kind**: internal
- **Source**: 35193:2140:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testOnlyOwnerOrManagerCanLeverUpFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithHybridFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testOnlyOwnerOrManagerCanLeverUpFromZapper(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256) (NodeID: 1)
