# Function: testOnlyOwnerOrManagerCanCloseTroveWithHybridFromBalancerVault()
...
### _testOnlyOwnerOrManagerCanCloseTroveFromBalancerVault(contract IZapper,uint256)

- **Kind**: internal
- **Source**: 80557:1461:338
- **Link**: `test/zapperLeverage.t.sol:ZapperLeverageMainnet:_testOnlyOwnerOrManagerCanCloseTroveFromBalancerVault(contract IZapper,uint256)`
...
function _testOnlyOwnerOrManagerCanCloseTroveFromBalancerVault(IZapper _zapper, uint256 _branch) internal {
    ...
    bytes memory userData = abi.encode(address(_zapper), IFlashLoanProvider.Operation.CloseTrove, troveId, flashLoanAmount, minExpectedCollateral);
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithHybridFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testOnlyOwnerOrManagerCanCloseTroveFromBalancerVault(contract IZapper,uint256) (NodeID: 1)
      💬 Args: [leverageZapperHybridArray[i], i]
      👁️  Def: internal
