# Function: testOnlyOwnerOrManagerCanCloseTroveWithHybridFromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithHybridFromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
