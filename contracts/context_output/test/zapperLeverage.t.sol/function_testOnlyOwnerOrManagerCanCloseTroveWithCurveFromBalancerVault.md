# Function: testOnlyOwnerOrManagerCanCloseTroveWithCurveFromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithCurveFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
