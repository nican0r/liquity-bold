# Function: testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithBaseZapperFromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
