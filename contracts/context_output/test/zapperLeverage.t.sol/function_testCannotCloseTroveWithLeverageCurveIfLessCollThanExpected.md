# Function: testCannotCloseTroveWithLeverageCurveIfLessCollThanExpected()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotCloseTroveWithLeverageCurveIfLessCollThanExpected() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCannotCloseTroveIfLessCollThanExpected(contract IZapper,uint256) (NodeID: 1)
      💬 Args: [IZapper(leverageZapperCurveArray[i]), i]
      👁️  Def: internal
