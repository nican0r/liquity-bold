# Function: testCanOpenTroveAndJoinBatchWithCurve()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCanOpenTroveAndJoinBatchWithCurve() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  └─ [1] ⚙️ FUNCTION: ZapperLeverageMainnet._testCanOpenTrove(contract ILeverageZapper,enum ZapperLeverageMainnet.ExchangeType,uint256,address) (NodeID: 2)
      💬 Args: [leverageZapperCurveArray[i], ExchangeType.Curve, i, B]
      👁️  Def: internal
