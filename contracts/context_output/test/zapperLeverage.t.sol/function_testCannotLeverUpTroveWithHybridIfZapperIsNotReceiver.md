# Function: testCannotLeverUpTroveWithHybridIfZapperIsNotReceiver()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testCannotLeverUpTroveWithHybridIfZapperIsNotReceiver() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
