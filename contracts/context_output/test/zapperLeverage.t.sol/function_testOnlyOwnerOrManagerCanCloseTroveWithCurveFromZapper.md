# Function: testOnlyOwnerOrManagerCanCloseTroveWithCurveFromZapper()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithCurveFromZapper() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
