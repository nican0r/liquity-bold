# Function: testOnlyOwnerOrManagerCanLeverDownWithUniV3FromBalancerFLProvider()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverDownWithUniV3FromBalancerFLProvider() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
