# Function: testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanCloseTroveWithUniV3FromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
