# Function: testOnlyOwnerOrManagerCanLeverUpWithCurveFromBalancerVault()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperLeverageMainnet.testOnlyOwnerOrManagerCanLeverUpWithCurveFromBalancerVault() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
