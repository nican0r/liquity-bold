# Function: testCanAdjustTroveAddCollAndWithdrawBold()
...
```
┌─ [0] ⚙️ FUNCTION: ZapperGasCompTest.testCanAdjustTroveAddCollAndWithdrawBold() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 6)
      💬 Args: [collToken.balanceOf(B), collBalanceBeforeB - collAmount2, "B Coll bal mismatch"]
      👁️  Def: internal
```
