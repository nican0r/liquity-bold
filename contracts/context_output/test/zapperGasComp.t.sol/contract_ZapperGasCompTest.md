...
- **Name**: ZapperGasCompTest
- **Type**: Contract
- **Path**: test/zapperGasComp.t.sol
...
### testCanontWithdrawCollIfZapperIsNotReceiver()

- **Signature**: `testCanontWithdrawCollIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 9047:1117:337
- **Details**: [function_testCanontWithdrawCollIfZapperIsNotReceiver.md](./function_testCanontWithdrawCollIfZapperIsNotReceiver.md)
...
### testCanAdjustTroveAddCollAndWithdrawBold()

- **Signature**: `testCanAdjustTroveAddCollAndWithdrawBold()`
- **Visibility**: external
- **Source Range**: 20207:2106:337
- **Details**: [function_testCanAdjustTroveAddCollAndWithdrawBold.md](./function_testCanAdjustTroveAddCollAndWithdrawBold.md)
...
### testCannotAdjustTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver()

- **Signature**: `testCannotAdjustTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 22319:1454:337
- **Details**: [function_testCannotAdjustTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver.md](./function_testCannotAdjustTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver.md)
