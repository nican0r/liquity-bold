# Function: test_LiquidateEmitsTroveUpdated()
...
function test_LiquidateEmitsTroveUpdated() external {
    ...
    vm.expectEmit();
    emit TroveUpdated(liquidatedTroveId, 0, 0, 0, 0, 0, 0);
...
```
┌─ [0] ⚙️ FUNCTION: TroveEventsTest.test_LiquidateEmitsTroveUpdated() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
