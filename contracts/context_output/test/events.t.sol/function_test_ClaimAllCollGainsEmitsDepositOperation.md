# Function: test_ClaimAllCollGainsEmitsDepositOperation()
...
function test_ClaimAllCollGainsEmitsDepositOperation() external {
    ...
    makeSPWithdrawalNoClaim(A, deposit.recordedBold - deposit.pendingBoldLoss);
    makeSPWithdrawalNoClaim(A, deposit.pendingBoldYieldGain);
    vm.expectEmit();
...
```
┌─ [0] ⚙️ FUNCTION: StabilityPoolEventsTest.test_ClaimAllCollGainsEmitsDepositOperation() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositNoClaim(address,uint256) (NodeID: 40)
  │   💬 Args: [B, 1e18]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalNoClaim(address,uint256) (NodeID: 41)
  │   💬 Args: [A, deposit.recordedBold - deposit.pendingBoldLoss]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalNoClaim(address,uint256) (NodeID: 42)
  │   💬 Args: [A, deposit.pendingBoldYieldGain]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.claimAllCollGains(address) (NodeID: 43)
      💬 Args: [A]
      👁️  Def: public
```
