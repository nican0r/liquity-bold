...
- **Name**: RebasingBatchShares
- **Type**: Contract
- **Path**: test/rebasingBatchShares.t.sol
...
```solidity
bool internal WITH_INTEREST = true
```

### subTractor

```solidity
uint128 internal subTractor = 1
```
...
### testBatchRebaseToSystemInsolvency()

- **Signature**: `testBatchRebaseToSystemInsolvency()`
- **Visibility**: public
- **Source Range**: 416:5255:312
- **Details**: [function_testBatchRebaseToSystemInsolvency.md](./function_testBatchRebaseToSystemInsolvency.md)
...
### testDeflateDebtLeavingSharesConstant()

- **Signature**: `testDeflateDebtLeavingSharesConstant()`
- **Visibility**: public
- **Source Range**: 10819:2310:312
- **Details**: [function_testDeflateDebtLeavingSharesConstant.md](./function_testDeflateDebtLeavingSharesConstant.md)
...
### test_WhenBatchSharesRatioIsTooHigh_CanKickTroveFromBatch()

- **Signature**: `test_WhenBatchSharesRatioIsTooHigh_CanKickTroveFromBatch()`
- **Visibility**: external
- **Source Range**: 13135:3932:312
- **Details**: [function_test_WhenBatchSharesRatioIsTooHigh_CanKickTroveFromBatch.md](./function_test_WhenBatchSharesRatioIsTooHigh_CanKickTroveFromBatch.md)
