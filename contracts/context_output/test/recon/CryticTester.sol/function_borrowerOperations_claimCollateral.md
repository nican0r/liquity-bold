# Function: borrowerOperations_claimCollateral()
...
- **BorrowerOperationsTester::claimCollateral()**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_claimCollateral() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
