# Function: borrowerOperations_withdrawBold(uint256,uint256,uint256)
...
- **BorrowerOperationsTester::withdrawBold(uint256,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_withdrawBold(uint256,uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
