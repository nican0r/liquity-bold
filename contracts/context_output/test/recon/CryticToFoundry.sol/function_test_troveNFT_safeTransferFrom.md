# Function: test_troveNFT_safeTransferFrom()
...
### troveNFT_safeTransferFrom(address,address,uint256)

- **Kind**: internal
- **Source**: 730:154:331
- **Link**: `test/recon/targets/TroveNFTTargets.sol:TroveNFTTargets:troveNFT_safeTransferFrom(address,address,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_troveNFT_safeTransferFrom() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [no args]
  └─ [1] ⚙️ FUNCTION: TroveNFTTargets.troveNFT_safeTransferFrom(address,address,uint256) (NodeID: 4)
