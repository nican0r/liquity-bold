# Function: borrowerOperations_setRemoveManagerWithReceiver(uint256,address,address)
...
- **BorrowerOperationsTester::setRemoveManagerWithReceiver(uint256,address,address)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_setRemoveManagerWithReceiver(uint256,address,address) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
