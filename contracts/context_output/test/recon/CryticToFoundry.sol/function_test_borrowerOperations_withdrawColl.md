# Function: test_borrowerOperations_withdrawColl()
...
### borrowerOperations_withdrawColl(uint256,uint256)

- **Kind**: internal
- **Source**: 6774:174:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_withdrawColl(uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_withdrawColl() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_withdrawColl(uint256,uint256) (NodeID: 5)
      💬 Args: [0, 1e18]
      👁️  Def: public
