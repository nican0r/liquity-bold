# Function: test_borrowerOperations_setInterestIndividualDelegate()
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_setInterestIndividualDelegate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
