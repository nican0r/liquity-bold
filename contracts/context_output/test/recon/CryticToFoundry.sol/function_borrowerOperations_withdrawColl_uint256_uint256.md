# Function: borrowerOperations_withdrawColl(uint256,uint256)
...
- **BorrowerOperationsTester::withdrawColl(uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_withdrawColl(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
