# Function: test_borrowerOperations_addColl()
...
### borrowerOperations_addColl(uint256,uint256)

- **Kind**: internal
- **Source**: 628:156:322
- **Link**: `test/recon/targets/BorrowerOperationsTargets.sol:BorrowerOperationsTargets:borrowerOperations_addColl(uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: CryticToFoundry.test_borrowerOperations_addColl() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [no args]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BorrowerOperationsTargets.borrowerOperations_addColl(uint256,uint256) (NodeID: 5)
      💬 Args: [0, 5e18]
      👁️  Def: public
