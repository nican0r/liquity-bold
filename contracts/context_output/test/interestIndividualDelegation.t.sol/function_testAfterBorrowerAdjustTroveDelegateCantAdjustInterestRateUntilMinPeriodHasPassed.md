# Function: testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
