...
- **Name**: InterestIndividualDelegationTest
- **Type**: Contract
- **Path**: test/interestIndividualDelegation.t.sol
...
### testSetsDelegateProperly()

- **Signature**: `testSetsDelegateProperly()`
- **Visibility**: public
- **Source Range**: 551:473:305
- **Details**: [function_testSetsDelegateProperly.md](./function_testSetsDelegateProperly.md)
...
### testRemovesDelegateProperly()

- **Signature**: `testRemovesDelegateProperly()`
- **Visibility**: public
- **Source Range**: 1030:833:305
- **Details**: [function_testRemovesDelegateProperly.md](./function_testRemovesDelegateProperly.md)
...
### testOnlyBorrowerCanSetDelegate()

- **Signature**: `testOnlyBorrowerCanSetDelegate()`
- **Visibility**: public
- **Source Range**: 1869:672:305
- **Details**: [function_testOnlyBorrowerCanSetDelegate.md](./function_testOnlyBorrowerCanSetDelegate.md)
...
### testOnlyBorrowerCanRemoveDelegate()

- **Signature**: `testOnlyBorrowerCanRemoveDelegate()`
- **Visibility**: public
- **Source Range**: 2547:709:305
- **Details**: [function_testOnlyBorrowerCanRemoveDelegate.md](./function_testOnlyBorrowerCanRemoveDelegate.md)
...
### testDelegateCanSetInterestInTheRange()

- **Signature**: `testDelegateCanSetInterestInTheRange()`
- **Visibility**: public
- **Source Range**: 3262:353:305
- **Details**: [function_testDelegateCanSetInterestInTheRange.md](./function_testDelegateCanSetInterestInTheRange.md)
...
### testDelegateCannotSetInterestBelowMin()

- **Signature**: `testDelegateCannotSetInterestBelowMin()`
- **Visibility**: public
- **Source Range**: 3621:349:305
- **Details**: [function_testDelegateCannotSetInterestBelowMin.md](./function_testDelegateCannotSetInterestBelowMin.md)
...
### testDelegateCannotSetInterestAboveMax()

- **Signature**: `testDelegateCannotSetInterestAboveMax()`
- **Visibility**: public
- **Source Range**: 3976:330:305
- **Details**: [function_testDelegateCannotSetInterestAboveMax.md](./function_testDelegateCannotSetInterestAboveMax.md)
...
### testOwnerCanSetInterestBelowMin()

- **Signature**: `testOwnerCanSetInterestBelowMin()`
- **Visibility**: public
- **Source Range**: 4312:270:305
- **Details**: [function_testOwnerCanSetInterestBelowMin.md](./function_testOwnerCanSetInterestBelowMin.md)
...
### testOwnerCanSetInterestAboveMax()

- **Signature**: `testOwnerCanSetInterestAboveMax()`
- **Visibility**: public
- **Source Range**: 4588:251:305
- **Details**: [function_testOwnerCanSetInterestAboveMax.md](./function_testOwnerCanSetInterestAboveMax.md)
...
### testSetDelegateRevertsIfTroveIsClosed()

- **Signature**: `testSetDelegateRevertsIfTroveIsClosed()`
- **Visibility**: public
- **Source Range**: 4845:790:305
- **Details**: [function_testSetDelegateRevertsIfTroveIsClosed.md](./function_testSetDelegateRevertsIfTroveIsClosed.md)
...
### testSetDelegateRevertsIfTroveIsZombie()

- **Signature**: `testSetDelegateRevertsIfTroveIsZombie()`
- **Visibility**: public
- **Source Range**: 5641:768:305
- **Details**: [function_testSetDelegateRevertsIfTroveIsZombie.md](./function_testSetDelegateRevertsIfTroveIsZombie.md)
...
### testSetDelegateRevertsIfMinTooLow()

- **Signature**: `testSetDelegateRevertsIfMinTooLow()`
- **Visibility**: public
- **Source Range**: 6415:577:305
- **Details**: [function_testSetDelegateRevertsIfMinTooLow.md](./function_testSetDelegateRevertsIfMinTooLow.md)
...
### testSetDelegateRevertsIfMaxTooHigh()

- **Signature**: `testSetDelegateRevertsIfMaxTooHigh()`
- **Visibility**: public
- **Source Range**: 6998:633:305
- **Details**: [function_testSetDelegateRevertsIfMaxTooHigh.md](./function_testSetDelegateRevertsIfMaxTooHigh.md)
...
### testSetDelegateRevertsIfMinEqMax()

- **Signature**: `testSetDelegateRevertsIfMinEqMax()`
- **Visibility**: public
- **Source Range**: 7637:567:305
- **Details**: [function_testSetDelegateRevertsIfMinEqMax.md](./function_testSetDelegateRevertsIfMinEqMax.md)
...
### testSetDelegateRevertsIfMinGtMax()

- **Signature**: `testSetDelegateRevertsIfMinGtMax()`
- **Visibility**: public
- **Source Range**: 8210:567:305
- **Details**: [function_testSetDelegateRevertsIfMinGtMax.md](./function_testSetDelegateRevertsIfMinGtMax.md)
...
### testSetDelegateRevertsIfNewInterestRateNotInRangeBelow()

- **Signature**: `testSetDelegateRevertsIfNewInterestRateNotInRangeBelow()`
- **Visibility**: public
- **Source Range**: 8783:889:305
- **Details**: [function_testSetDelegateRevertsIfNewInterestRateNotInRangeBelow.md](./function_testSetDelegateRevertsIfNewInterestRateNotInRangeBelow.md)
...
### testSetDelegateRevertsIfNewInterestRateNotInRangeAbove()

- **Signature**: `testSetDelegateRevertsIfNewInterestRateNotInRangeAbove()`
- **Visibility**: public
- **Source Range**: 9678:914:305
- **Details**: [function_testSetDelegateRevertsIfNewInterestRateNotInRangeAbove.md](./function_testSetDelegateRevertsIfNewInterestRateNotInRangeAbove.md)
...
### testSetDelegateRemovesBatchManager()

- **Signature**: `testSetDelegateRemovesBatchManager()`
- **Visibility**: public
- **Source Range**: 10598:1497:305
- **Details**: [function_testSetDelegateRemovesBatchManager.md](./function_testSetDelegateRemovesBatchManager.md)
...
### testInterestUpdateByDelegatePremature()

- **Signature**: `testInterestUpdateByDelegatePremature()`
- **Visibility**: public
- **Source Range**: 12101:675:305
- **Details**: [function_testInterestUpdateByDelegatePremature.md](./function_testInterestUpdateByDelegatePremature.md)
...
### testInterestUpdateByDelegateAfterCooldown()

- **Signature**: `testInterestUpdateByDelegateAfterCooldown()`
- **Visibility**: public
- **Source Range**: 12782:641:305
- **Details**: [function_testInterestUpdateByDelegateAfterCooldown.md](./function_testInterestUpdateByDelegateAfterCooldown.md)
...
### testBorrowerCanSetDelegatesMinInterestRateChangePeriod()

- **Signature**: `testBorrowerCanSetDelegatesMinInterestRateChangePeriod()`
- **Visibility**: public
- **Source Range**: 13429:836:305
- **Details**: [function_testBorrowerCanSetDelegatesMinInterestRateChangePeriod.md](./function_testBorrowerCanSetDelegatesMinInterestRateChangePeriod.md)
...
### testAfterOpenTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed()

- **Signature**: `testAfterOpenTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 14271:758:305
- **Details**: [function_testAfterOpenTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed.md](./function_testAfterOpenTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed.md)
...
### testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed()

- **Signature**: `testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 15035:892:305
- **Details**: [function_testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed.md](./function_testAfterBorrowerAdjustTroveDelegateCantAdjustInterestRateUntilMinPeriodHasPassed.md)
...
### testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed()

- **Signature**: `testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 15933:928:305
- **Details**: [function_testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed.md](./function_testAfterDelegateAdjustsRateCantAdjustInterestRateUntilMinPeriodHasPassed.md)
...
### testAfterOpenTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed()

- **Signature**: `testAfterOpenTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 16879:809:305
- **Details**: [function_testAfterOpenTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed.md](./function_testAfterOpenTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed.md)
...
### testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed()

- **Signature**: `testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 17694:943:305
- **Details**: [function_testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed.md](./function_testAfterBorrowerAdjustTroveDelegateCanAdjustInterestRateAfterMinPeriodHasPassed.md)
...
### testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed()

- **Signature**: `testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed()`
- **Visibility**: public
- **Source Range**: 18643:1022:305
- **Details**: [function_testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed.md](./function_testAfterDelegateAdjustsRateTheyCanAdjustInterestRateAgainAfterMinPeriodHasPassed.md)
