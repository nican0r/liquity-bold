# Function: testOnlyBorrowerCanSetDelegate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testOnlyBorrowerCanSetDelegate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.openTroveNoHints100pct(address,uint256,uint256,uint256) (NodeID: 1)
      💬 Args: [A, 100e18, 2000e18, 5e16]
      👁️  Def: public
