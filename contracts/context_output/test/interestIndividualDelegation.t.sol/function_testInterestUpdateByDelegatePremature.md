# Function: testInterestUpdateByDelegatePremature()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testInterestUpdateByDelegatePremature() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.predictAdjustInterestRateUpfrontFee(uint256,uint256) (NodeID: 5)
  │   💬 Args: [troveId, newAnnualInterestRate]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 6)
  │   💬 Args: [troveManager.getTroveDebt(troveId), recordedDebtBefore + upfrontFee]
  │   👁️  Def: internal
