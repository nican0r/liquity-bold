# Function: testSetDelegateRemovesBatchManager()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testSetDelegateRemovesBatchManager() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 8)
      💬 Args: [troveManager.getTroveAnnualInterestRate(troveId), newAnnualInterestRate, "Wrong interest rate"]
      👁️  Def: internal
```
