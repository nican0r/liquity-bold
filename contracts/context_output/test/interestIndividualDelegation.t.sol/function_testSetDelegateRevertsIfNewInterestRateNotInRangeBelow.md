# Function: testSetDelegateRevertsIfNewInterestRateNotInRangeBelow()
...
```
┌─ [0] ⚙️ FUNCTION: InterestIndividualDelegationTest.testSetDelegateRevertsIfNewInterestRateNotInRangeBelow() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
