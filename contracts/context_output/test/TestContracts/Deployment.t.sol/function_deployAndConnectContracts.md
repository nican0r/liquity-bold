...
- **Kind**: internal
- **Source**: 7919:936:260
- **Link**: `test/TestContracts/Deployment.t.sol:TestDeployer:deployAndConnectContracts(struct TestDeployer.TroveManagerParams)`
...
```
┌─ [0] ⚙️ FUNCTION: TestDeployer.deployAndConnectContracts() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  └─ [1] ⚙️ FUNCTION: TestDeployer.deployAndConnectContracts(struct TestDeployer.TroveManagerParams) (NodeID: 1)
      💬 Args: [TroveManagerParams(150e16, 110e16, 10e16, 110e16, 5e16, 10e16)]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: TestDeployer.deployAndConnectContractsMultiColl(struct TestDeployer.TroveManagerParams[]) (NodeID: 2)
        💬 Args: [troveManagerParamsArray]
        👁️  Def: public
      └─ [3] ⚙️ FUNCTION: TestDeployer.deployAndConnectContracts(struct TestDeployer.TroveManagerParams[],contract IWETH) (NodeID: 3)
          💬 Args: [troveManagerParamsArray, WETH]
          👁️  Def: public
        ├─ [4] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 4)
        │   💬 Args: [address(this), vars.bytecode, SALT]
        │   👁️  Def: public
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 5)
        │   💬 Args: [troveManagerParamsArray[0]]
        │   👁️  Def: internal
        │ └─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 6)
        │     💬 Args: [address(this), getBytecode(type(TroveManagerTester).creationCode, address(addressesRegistry)), SALT]
        │     👁️  Def: public
        │   └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 7)
        │       💬 Args: [type(TroveManagerTester).creationCode, address(addressesRegistry)]
        │       👁️  Def: public
        ├─ [4] ⚙️ FUNCTION: TestDeployer._nameToken(uint256) (NodeID: 8)
        │   💬 Args: [vars.i]
        │   👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: TestDeployer._symboltoken(uint256) (NodeID: 9)
        │   💬 Args: [vars.i]
        │   👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 10)
        │   💬 Args: [troveManagerParamsArray[vars.i]]
        │   👁️  Def: internal
        │ └─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 11)
        │     💬 Args: [address(this), getBytecode(type(TroveManagerTester).creationCode, address(addressesRegistry)), SALT]
        │     👁️  Def: public
        │   └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 12)
        │       💬 Args: [type(TroveManagerTester).creationCode, address(addressesRegistry)]
        │       👁️  Def: public
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 13)
        ...
        │   👁️  Def: internal
        │ ├─ [5] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 14)
        │ │   💬 Args: [SALT]
        │ │   👁️  Def: public
        │ │ ├─ [6] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 15)
        │ │ │   💬 Args: [no args]
        │ │ │   👁️  Def: internal
        │ │ ├─ [6] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 16)
        │ │ │   💬 Args: [no args]
        │ │ │   👁️  Def: internal
        │ │ │ └─ [7] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 17)
        │ │ │     💬 Args: [data]
        │ │ │     👁️  Def: internal
        │ │ └─ [6] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 18)
        │ │     💬 Args: [_salt]
        │ │     👁️  Def: internal
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 19)
        │ │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 20)
        │ │     💬 Args: [type(MetadataNFT).creationCode, address(initializedFixedAssetReader)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 21)
        │ │   💬 Args: [address(this), getBytecode(type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 22)
        │ │     💬 Args: [type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 23)
        │ │   💬 Args: [address(this), getBytecode(type(TroveNFT).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 24)
        │ │     💬 Args: [type(TroveNFT).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 25)
        │ │   💬 Args: [address(this), getBytecode(type(StabilityPool).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 26)
        │ │     💬 Args: [type(StabilityPool).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 27)
        │ │   💬 Args: [address(this), getBytecode(type(ActivePool).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 28)
        │ │     💬 Args: [type(ActivePool).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 29)
        │ │   💬 Args: [address(this), getBytecode(type(DefaultPool).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 30)
        │ │     💬 Args: [type(DefaultPool).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 31)
        │ │   💬 Args: [address(this), getBytecode(type(GasPool).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 32)
        │ │     💬 Args: [type(GasPool).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 33)
        │ │   💬 Args: [address(this), getBytecode(type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 34)
        │ │     💬 Args: [type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 35)
        │ │   💬 Args: [address(this), getBytecode(type(SortedTroves).creationCode, address(contracts.addressesRegistry)), SALT]
        │ │   👁️  Def: public
        │ │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 36)
        │ │     💬 Args: [type(SortedTroves).creationCode, address(contracts.addressesRegistry)]
        │ │     👁️  Def: public
        │ └─ [5] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 37)
        ...
        │     👁️  Def: internal
        │   ├─ [6] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 38)
        │   │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
        │   │   👁️  Def: internal
        │   └─ [6] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 39)
        │       💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
        │       👁️  Def: internal
        │     ├─ [7] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 40)
        │     │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
        │     │   👁️  Def: internal
        │     ├─ [7] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 41)
        │     │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
        │     │   👁️  Def: internal
        │     └─ [7] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 42)
        │         💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
        │         👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 43)
            ...
            👁️  Def: internal
          ├─ [5] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 44)
          │   💬 Args: [SALT]
          │   👁️  Def: public
          │ ├─ [6] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 45)
          │ │   💬 Args: [no args]
          │ │   👁️  Def: internal
          │ ├─ [6] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 46)
          │ │   💬 Args: [no args]
          │ │   👁️  Def: internal
          │ │ └─ [7] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 47)
          │ │     💬 Args: [data]
          │ │     👁️  Def: internal
          │ └─ [6] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 48)
          │     💬 Args: [_salt]
          │     👁️  Def: internal
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 49)
          │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 50)
          │     💬 Args: [type(MetadataNFT).creationCode, address(initializedFixedAssetReader)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 51)
          │   💬 Args: [address(this), getBytecode(type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 52)
          │     💬 Args: [type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 53)
          │   💬 Args: [address(this), getBytecode(type(TroveNFT).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 54)
          │     💬 Args: [type(TroveNFT).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 55)
          │   💬 Args: [address(this), getBytecode(type(StabilityPool).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 56)
          │     💬 Args: [type(StabilityPool).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 57)
          │   💬 Args: [address(this), getBytecode(type(ActivePool).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 58)
          │     💬 Args: [type(ActivePool).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 59)
          │   💬 Args: [address(this), getBytecode(type(DefaultPool).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 60)
          │     💬 Args: [type(DefaultPool).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 61)
          │   💬 Args: [address(this), getBytecode(type(GasPool).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 62)
          │     💬 Args: [type(GasPool).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 63)
          │   💬 Args: [address(this), getBytecode(type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 64)
          │     💬 Args: [type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          ├─ [5] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 65)
          │   💬 Args: [address(this), getBytecode(type(SortedTroves).creationCode, address(contracts.addressesRegistry)), SALT]
          │   👁️  Def: public
          │ └─ [6] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 66)
          │     💬 Args: [type(SortedTroves).creationCode, address(contracts.addressesRegistry)]
          │     👁️  Def: public
          └─ [5] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 67)
              💬 Args: [contracts.addressesRegistry, contracts.collToken, _boldToken, _weth, contracts.priceFeed, ICurveStableswapNGPool(address(0)), false, zappers]
              👁️  Def: internal
            ├─ [6] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 68)
            │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
            │   👁️  Def: internal
            └─ [6] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 69)
                💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
                👁️  Def: internal
              ├─ [7] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 70)
              │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
              │   👁️  Def: internal
              ├─ [7] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 71)
              │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
              │   👁️  Def: internal
              └─ [7] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 72)
                  💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
                  👁️  Def: internal
```
