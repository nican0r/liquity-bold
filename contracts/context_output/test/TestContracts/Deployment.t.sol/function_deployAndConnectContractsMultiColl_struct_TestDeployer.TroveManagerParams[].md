# Function: deployAndConnectContractsMultiColl(struct TestDeployer.TroveManagerParams[])
...
```
┌─ [0] ⚙️ FUNCTION: TestDeployer.deployAndConnectContractsMultiColl(struct TestDeployer.TroveManagerParams[]) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: TestDeployer.deployAndConnectContracts(struct TestDeployer.TroveManagerParams[],contract IWETH) (NodeID: 1)
      💬 Args: [troveManagerParamsArray, WETH]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 2)
    │   💬 Args: [address(this), vars.bytecode, SALT]
    │   👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 3)
    │   💬 Args: [troveManagerParamsArray[0]]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 4)
    │     💬 Args: [address(this), getBytecode(type(TroveManagerTester).creationCode, address(addressesRegistry)), SALT]
    │     👁️  Def: public
    │   └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 5)
    │       💬 Args: [type(TroveManagerTester).creationCode, address(addressesRegistry)]
    │       👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer._nameToken(uint256) (NodeID: 6)
    │   💬 Args: [vars.i]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TestDeployer._symboltoken(uint256) (NodeID: 7)
    │   💬 Args: [vars.i]
    │   👁️  Def: internal
    ├─ [2] ⚙️ FUNCTION: TestDeployer._deployAddressesRegistryDev(struct TestDeployer.TroveManagerParams) (NodeID: 8)
    │   💬 Args: [troveManagerParamsArray[vars.i]]
    │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 9)
    │     💬 Args: [address(this), getBytecode(type(TroveManagerTester).creationCode, address(addressesRegistry)), SALT]
    │     👁️  Def: public
    │   └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 10)
    │       💬 Args: [type(TroveManagerTester).creationCode, address(addressesRegistry)]
    │       👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 11)
    ...
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 12)
    │ │   💬 Args: [SALT]
    │ │   👁️  Def: public
    │ │ ├─ [4] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 13)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: internal
    │ │ ├─ [4] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 14)
    │ │ │   💬 Args: [no args]
    │ │ │   👁️  Def: internal
    │ │ │ └─ [5] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 15)
    │ │ │     💬 Args: [data]
    │ │ │     👁️  Def: internal
    │ │ └─ [4] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 16)
    │ │     💬 Args: [_salt]
    │ │     👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 17)
    │ │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 18)
    │ │     💬 Args: [type(MetadataNFT).creationCode, address(initializedFixedAssetReader)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 19)
    │ │   💬 Args: [address(this), getBytecode(type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 20)
    │ │     💬 Args: [type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 21)
    │ │   💬 Args: [address(this), getBytecode(type(TroveNFT).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 22)
    │ │     💬 Args: [type(TroveNFT).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 23)
    │ │   💬 Args: [address(this), getBytecode(type(StabilityPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 24)
    │ │     💬 Args: [type(StabilityPool).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 25)
    │ │   💬 Args: [address(this), getBytecode(type(ActivePool).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 26)
    │ │     💬 Args: [type(ActivePool).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 27)
    │ │   💬 Args: [address(this), getBytecode(type(DefaultPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 28)
    │ │     💬 Args: [type(DefaultPool).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 29)
    │ │   💬 Args: [address(this), getBytecode(type(GasPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 30)
    │ │     💬 Args: [type(GasPool).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 31)
    │ │   💬 Args: [address(this), getBytecode(type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 32)
    │ │     💬 Args: [type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 33)
    │ │   💬 Args: [address(this), getBytecode(type(SortedTroves).creationCode, address(contracts.addressesRegistry)), SALT]
    │ │   👁️  Def: public
    │ │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 34)
    │ │     💬 Args: [type(SortedTroves).creationCode, address(contracts.addressesRegistry)]
    │ │     👁️  Def: public
    │ └─ [3] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 35)
    ...
    │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 36)
    │   │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
    │   │   👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 37)
    │       💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
    │       👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 38)
    │     │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
    │     │   👁️  Def: internal
    │     ├─ [5] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 39)
    │     │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
    │     │   👁️  Def: internal
    │     └─ [5] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 40)
    │         💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
    │         👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: TestDeployer._deployAndConnectCollateralContractsDev(contract IERC20Metadata,contract IBoldToken,contract ICollateralRegistry,contract IWETH,contract IAddressesRegistry,address,contract IHintHelpers,contract IMultiTroveGetter) (NodeID: 41)
        ...
        👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: MetadataDeployment.deployMetadata(bytes32) (NodeID: 42)
      │   💬 Args: [SALT]
      │   👁️  Def: public
      │ ├─ [4] ⚙️ FUNCTION: MetadataDeployment._loadFiles() (NodeID: 43)
      │ │   💬 Args: [no args]
      │ │   👁️  Def: internal
      │ ├─ [4] ⚙️ FUNCTION: MetadataDeployment._storeFile() (NodeID: 44)
      │ │   💬 Args: [no args]
      │ │   👁️  Def: internal
      │ │ └─ [5] ⚙️ FUNCTION: SSTORE2.write(bytes) (NodeID: 45)
      │ │     💬 Args: [data]
      │ │     👁️  Def: internal
      │ └─ [4] ⚙️ FUNCTION: MetadataDeployment._deployFixedAssetReader(bytes32) (NodeID: 46)
      │     💬 Args: [_salt]
      │     👁️  Def: internal
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 47)
      │   💬 Args: [address(this), getBytecode(type(MetadataNFT).creationCode, address(initializedFixedAssetReader)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 48)
      │     💬 Args: [type(MetadataNFT).creationCode, address(initializedFixedAssetReader)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 49)
      │   💬 Args: [address(this), getBytecode(type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 50)
      │     💬 Args: [type(BorrowerOperationsTester).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 51)
      │   💬 Args: [address(this), getBytecode(type(TroveNFT).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 52)
      │     💬 Args: [type(TroveNFT).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 53)
      │   💬 Args: [address(this), getBytecode(type(StabilityPool).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 54)
      │     💬 Args: [type(StabilityPool).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 55)
      │   💬 Args: [address(this), getBytecode(type(ActivePool).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 56)
      │     💬 Args: [type(ActivePool).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 57)
      │   💬 Args: [address(this), getBytecode(type(DefaultPool).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 58)
      │     💬 Args: [type(DefaultPool).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 59)
      │   💬 Args: [address(this), getBytecode(type(GasPool).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 60)
      │     💬 Args: [type(GasPool).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 61)
      │   💬 Args: [address(this), getBytecode(type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 62)
      │     💬 Args: [type(CollSurplusPool).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      ├─ [3] ⚙️ FUNCTION: TestDeployer.getAddress(address,bytes,bytes32) (NodeID: 63)
      │   💬 Args: [address(this), getBytecode(type(SortedTroves).creationCode, address(contracts.addressesRegistry)), SALT]
      │   👁️  Def: public
      │ └─ [4] ⚙️ FUNCTION: TestDeployer.getBytecode(bytes,address) (NodeID: 64)
      │     💬 Args: [type(SortedTroves).creationCode, address(contracts.addressesRegistry)]
      │     👁️  Def: public
      └─ [3] ⚙️ FUNCTION: TestDeployer._deployZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IWETH,contract IPriceFeed,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 65)
          💬 Args: [contracts.addressesRegistry, contracts.collToken, _boldToken, _weth, contracts.priceFeed, ICurveStableswapNGPool(address(0)), false, zappers]
          👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: TestDeployer._deployCurveExchange(contract IERC20,contract IBoldToken,contract IPriceFeed,bool) (NodeID: 66)
        │   💬 Args: [_collToken, _boldToken, _priceFeed, _mainnet]
        │   👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: TestDeployer._deployLeverageZappers(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,contract IExchange,contract ICurveStableswapNGPool,bool,struct TestDeployer.Zappers) (NodeID: 67)
            💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, flashLoanProvider, curveExchange, _usdcCurvePool, lst, zappers]
            👁️  Def: internal
          ├─ [5] ⚙️ FUNCTION: TestDeployer._deployCurveLeverageZapper(contract IAddressesRegistry,contract IFlashLoanProvider,contract IExchange,bool) (NodeID: 68)
          │   💬 Args: [_addressesRegistry, _flashLoanProvider, _curveExchange, _lst]
          │   👁️  Def: internal
          ├─ [5] ⚙️ FUNCTION: TestDeployer._deployUniV3LeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IPriceFeed,contract IFlashLoanProvider,bool) (NodeID: 69)
          │   💬 Args: [_addressesRegistry, _collToken, _boldToken, _priceFeed, _flashLoanProvider, _lst]
          │   👁️  Def: internal
          └─ [5] ⚙️ FUNCTION: TestDeployer._deployHybridLeverageZapper(contract IAddressesRegistry,contract IERC20,contract IBoldToken,contract IFlashLoanProvider,contract ICurveStableswapNGPool,bool) (NodeID: 70)
              💬 Args: [_addressesRegistry, _collToken, _boldToken, _flashLoanProvider, _usdcCurvePool, _lst]
              👁️  Def: internal
```
