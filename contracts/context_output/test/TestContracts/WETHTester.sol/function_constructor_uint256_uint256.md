# Function: constructor(uint256,uint256)
...
- **Kind**: internal
- **Source**: 570:228:262
- **Link**: `test/TestContracts/ERC20Faucet.sol:ERC20Faucet:constructor(string,string,uint256,uint256)`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: WETHTester.constructor(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: WETHTester
  └─ [1] 🏗️ CONSTRUCTOR: ERC20Faucet.constructor(string,string,uint256,uint256) (NodeID: 1)
      💬 Args: ["Wrapped Ether Tester", "WETH", _tapAmount, _tapPeriod]
      🏗️  Contract: ERC20Faucet
    ├─ [2] 🏗️ CONSTRUCTOR: ERC20.constructor(string,string) (NodeID: 2)
    │   💬 Args: ["Wrapped Ether Tester", "WETH"]
    │   🏗️  Contract: ERC20
    └─ [2] 🏗️ CONSTRUCTOR: ERC20Permit.constructor(string) (NodeID: 3)
        💬 Args: ["Wrapped Ether Tester"]
        🏗️  Contract: ERC20Permit
      └─ [3] 🏗️ CONSTRUCTOR: EIP712.constructor(string,string) (NodeID: 4)
          💬 Args: ["Wrapped Ether Tester", "1"]
          🏗️  Contract: EIP712
        ├─ [4] ⚙️ FUNCTION: ShortStrings.toShortStringWithFallback(string,string) (NodeID: 5)
        │   💬 Args: [name, _nameFallback]
        │   👁️  Def: internal
        │ ├─ [5] ⚙️ FUNCTION: ShortStrings.toShortString(string) (NodeID: 6)
        │ │   💬 Args: [value]
        │ │   👁️  Def: internal
        │ └─ [5] ⚙️ FUNCTION: StorageSlot.getStringSlot(string) (NodeID: 7)
        │     💬 Args: [store]
        │     👁️  Def: internal
        ├─ [4] ⚙️ FUNCTION: ShortStrings.toShortStringWithFallback(string,string) (NodeID: 8)
        │   💬 Args: [version, _versionFallback]
        │   👁️  Def: internal
        │ ├─ [5] ⚙️ FUNCTION: ShortStrings.toShortString(string) (NodeID: 9)
        │ │   💬 Args: [value]
        │ │   👁️  Def: internal
        │ └─ [5] ⚙️ FUNCTION: StorageSlot.getStringSlot(string) (NodeID: 10)
        │     💬 Args: [store]
        │     👁️  Def: internal
        └─ [4] ⚙️ FUNCTION: EIP712._buildDomainSeparator() (NodeID: 11)
            💬 Args: [no args]
            👁️  Def: private
```
