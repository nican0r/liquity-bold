...
- **Kind**: internal
- **Source**: 1600:87:127
- **Link**: `src/BoldToken.sol:BoldToken:constructor(address)`
...
```
┌─ [0] 🏗️ CONSTRUCTOR: BoldTokenTester.constructor(address) (NodeID: 0)
    💬 Args: [no args]
    🏗️  Contract: BoldTokenTester
  └─ [1] 🏗️ CONSTRUCTOR: BoldToken.constructor(address) (NodeID: 1)
      💬 Args: [_owner]
      🏗️  Contract: BoldToken
    ├─ [2] 🏗️ CONSTRUCTOR: ERC20Permit.constructor(string) (NodeID: 2)
    │   💬 Args: [_NAME]
    │   🏗️  Contract: ERC20Permit
    │ └─ [3] 🏗️ CONSTRUCTOR: EIP712.constructor(string,string) (NodeID: 3)
    │     💬 Args: [_NAME, "1"]
    │     🏗️  Contract: EIP712
    │   ├─ [4] ⚙️ FUNCTION: ShortStrings.toShortStringWithFallback(string,string) (NodeID: 4)
    │   │   💬 Args: [name, _nameFallback]
    │   │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: ShortStrings.toShortString(string) (NodeID: 5)
    │   │ │   💬 Args: [value]
    │   │ │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: StorageSlot.getStringSlot(string) (NodeID: 6)
    │   │     💬 Args: [store]
    │   │     👁️  Def: internal
    │   ├─ [4] ⚙️ FUNCTION: ShortStrings.toShortStringWithFallback(string,string) (NodeID: 7)
    │   │   💬 Args: [version, _versionFallback]
    │   │   👁️  Def: internal
    │   │ ├─ [5] ⚙️ FUNCTION: ShortStrings.toShortString(string) (NodeID: 8)
    │   │ │   💬 Args: [value]
    │   │ │   👁️  Def: internal
    │   │ └─ [5] ⚙️ FUNCTION: StorageSlot.getStringSlot(string) (NodeID: 9)
    │   │     💬 Args: [store]
    │   │     👁️  Def: internal
    │   └─ [4] ⚙️ FUNCTION: EIP712._buildDomainSeparator() (NodeID: 10)
    │       💬 Args: [no args]
    │       👁️  Def: private
    ├─ [2] 🏗️ CONSTRUCTOR: ERC20.constructor(string,string) (NodeID: 11)
    │   💬 Args: [_NAME, _SYMBOL]
    │   🏗️  Contract: ERC20
    └─ [2] 🏗️ CONSTRUCTOR: Ownable.constructor(address) (NodeID: 12)
        💬 Args: [_owner]
        🏗️  Contract: Ownable
```
