...
- **Name**: BoldTokenTester
- **Type**: Contract
- **Path**: test/TestContracts/BoldTokenTester.sol
...
### _NAME (inherited from BoldToken)

```solidity
string internal constant _NAME = "BOLD Stablecoin"
```

### _SYMBOL (inherited from BoldToken)

```solidity
string internal constant _SYMBOL = "BOLD"
```

### collateralRegistryAddress (inherited from BoldToken)

```solidity
address public collateralRegistryAddress
```

### troveManagerAddresses (inherited from BoldToken)

```solidity
mapping(address => bool) internal troveManagerAddresses
```

### stabilityPoolAddresses (inherited from BoldToken)

```solidity
mapping(address => bool) internal stabilityPoolAddresses
```

### borrowerOperationsAddresses (inherited from BoldToken)

```solidity
mapping(address => bool) internal borrowerOperationsAddresses
```

### activePoolAddresses (inherited from BoldToken)
...
### CollateralRegistryAddressChanged (inherited from BoldToken)

```solidity
event CollateralRegistryAddressChanged(address _newCollateralRegistryAddress);
```

### TroveManagerAddressAdded (inherited from BoldToken)

```solidity
event TroveManagerAddressAdded(address _newTroveManagerAddress);
```

### StabilityPoolAddressAdded (inherited from BoldToken)

```solidity
event StabilityPoolAddressAdded(address _newStabilityPoolAddress);
```

### BorrowerOperationsAddressAdded (inherited from BoldToken)

```solidity
event BorrowerOperationsAddressAdded(address _newBorrowerOperationsAddress);
```

### ActivePoolAddressAdded (inherited from BoldToken)
...
### unprotectedMint(address,uint256)

- **Signature**: `unprotectedMint(address,uint256)`
- **Visibility**: external
- **Source Range**: 185:110:255
- **Details**: [function_unprotectedMint_address_uint256.md](./function_unprotectedMint_address_uint256.md)
...
### setBranchAddresses(address,address,address,address) (inherited from BoldToken)
...
### setCollateralRegistry(address) (inherited from BoldToken)
...
### mint(address,uint256) (inherited from BoldToken)
...
### burn(address,uint256) (inherited from BoldToken)
...
### sendToPool(address,address,uint256) (inherited from BoldToken)
...
### returnFromPool(address,address,uint256) (inherited from BoldToken)
