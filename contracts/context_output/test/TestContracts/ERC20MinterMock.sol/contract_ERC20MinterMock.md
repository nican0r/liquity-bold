...
- **Name**: ERC20MinterMock
- **Type**: Contract
- **Path**: test/TestContracts/ERC20MinterMock.sol
...
### MINTER_ROLE (inherited from ERC20PresetMinterPauser)

```solidity
bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE")
```

### PAUSER_ROLE (inherited from ERC20PresetMinterPauser)
...
### mint(address,uint256) (inherited from ERC20PresetMinterPauser)
...
### pause() (inherited from ERC20PresetMinterPauser)
...
### unpause() (inherited from ERC20PresetMinterPauser)
