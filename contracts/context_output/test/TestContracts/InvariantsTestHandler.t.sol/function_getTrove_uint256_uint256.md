# Function: getTrove(uint256,uint256)
...
- **Kind**: internal
- **Source**: 14841:664:270
- **Link**: `test/TestContracts/InvariantsTestHandler.t.sol:InvariantsTestHandler:getTroveById(uint256,uint256)`
...
```
┌─ [0] ⚙️ FUNCTION: InvariantsTestHandler.getTrove(uint256,uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: EnumerableSetMethods.get(struct EnumerableSet,uint256) (NodeID: 1)
  │   💬 Args: [_troveIds[i], j]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: InvariantsTestHandler.getTroveById(uint256,uint256) (NodeID: 2)
      💬 Args: [i, troveId]
      👁️  Def: public
    ├─ [2] ⚙️ FUNCTION: TroveMethods.applyPending(struct Trove) (NodeID: 3)
    │   💬 Args: [trove]
    │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TroveMethods.applyPendingRedist(struct Trove) (NodeID: 4)
    │ │   💬 Args: [trove]
    │ │   👁️  Def: internal
    │ ├─ [3] ⚙️ FUNCTION: TroveMethods.applyPendingInterest(struct Trove) (NodeID: 5)
    │ │   💬 Args: [trove]
    │ │   👁️  Def: internal
    │ └─ [3] ⚙️ FUNCTION: TroveMethods.applyPendingBatchManagementFee(struct Trove) (NodeID: 6)
    │     💬 Args: [trove]
    │     👁️  Def: internal
    └─ [2] ⚙️ FUNCTION: InvariantsTestHandler._isZombie(uint256,uint256) (NodeID: 7)
        💬 Args: [i, troveId]
        👁️  Def: internal
