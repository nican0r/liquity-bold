# Function: testSetLastGoodPriceOnDeploymentRETH()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testSetLastGoodPriceOnDeploymentRETH() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 1)
  │   💬 Args: [lastGoodPriceReth, 0]
  │   👁️  Def: internal
  ...
  │   💬 Args: [expectedMarketPrice, expectedCanonicalPrice]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 8)
      💬 Args: [lastGoodPriceReth, expectedPrice]
      👁️  Def: internal
```
