# Function: testRETHPriceFeedReturnsLastGoodPriceWhenETHUSDOracleFails()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testRETHPriceFeedReturnsLastGoodPriceWhenETHUSDOracleFails() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
