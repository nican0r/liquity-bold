# Function: testSetLastGoodPriceOnDeploymentWSTETH()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testSetLastGoodPriceOnDeploymentWSTETH() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 1)
  │   💬 Args: [lastGoodPriceWsteth, 0]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 4)
      💬 Args: [lastGoodPriceWsteth, expectedStoredPrice]
      👁️  Def: internal
```
