# Function: testWETHPriceFeedShutsDownWhenETHUSDOracleFails()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testWETHPriceFeedShutsDownWhenETHUSDOracleFails() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [contractsArray[0].troveManager.shutdownTime(), 0]
  │   👁️  Def: internal
