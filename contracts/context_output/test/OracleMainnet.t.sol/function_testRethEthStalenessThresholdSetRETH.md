# Function: testRethEthStalenessThresholdSetRETH()
...
```
┌─ [0] ⚙️ FUNCTION: OraclesMainnet.testRethEthStalenessThresholdSetRETH() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 1)
      💬 Args: [storedRethEthStaleness, _48_HOURS]
      👁️  Def: internal
```
