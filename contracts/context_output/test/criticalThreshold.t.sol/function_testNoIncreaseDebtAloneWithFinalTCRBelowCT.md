# Function: testNoIncreaseDebtAloneWithFinalTCRBelowCT()
...
- **CriticalThresholdTest::withdrawBold100pct(address,uint256,uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testNoIncreaseDebtAloneWithFinalTCRBelowCT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
