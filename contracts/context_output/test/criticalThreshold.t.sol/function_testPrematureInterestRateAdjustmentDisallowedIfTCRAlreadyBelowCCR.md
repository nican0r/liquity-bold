# Function: testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR()
...
```
┌─ [0] ⚙️ FUNCTION: CriticalThresholdTest.testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
