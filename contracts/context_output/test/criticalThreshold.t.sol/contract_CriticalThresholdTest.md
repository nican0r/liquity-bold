...
- **Name**: CriticalThresholdTest
- **Type**: Contract
- **Path**: test/criticalThreshold.t.sol
...
### testTrovesAreNotLiquidatedBetweenMCRAndCT()

- **Signature**: `testTrovesAreNotLiquidatedBetweenMCRAndCT()`
- **Visibility**: public
- **Source Range**: 705:465:301
- **Details**: [function_testTrovesAreNotLiquidatedBetweenMCRAndCT.md](./function_testTrovesAreNotLiquidatedBetweenMCRAndCT.md)
...
### testNoNewTrovesWithFinalTCRBelowCT()

- **Signature**: `testNoNewTrovesWithFinalTCRBelowCT()`
- **Visibility**: public
- **Source Range**: 1176:230:301
- **Details**: [function_testNoNewTrovesWithFinalTCRBelowCT.md](./function_testNoNewTrovesWithFinalTCRBelowCT.md)
...
### testNewTrovesWithFinalTCRAboveCT()

- **Signature**: `testNewTrovesWithFinalTCRAboveCT()`
- **Visibility**: public
- **Source Range**: 1412:285:301
- **Details**: [function_testNewTrovesWithFinalTCRAboveCT.md](./function_testNewTrovesWithFinalTCRAboveCT.md)
...
### testNoIncreaseDebtAloneWithFinalTCRBelowCT()

- **Signature**: `testNoIncreaseDebtAloneWithFinalTCRBelowCT()`
- **Visibility**: public
- **Source Range**: 1703:362:301
- **Details**: [function_testNoIncreaseDebtAloneWithFinalTCRBelowCT.md](./function_testNoIncreaseDebtAloneWithFinalTCRBelowCT.md)
...
### testNoIncreaseDebtWithAddCollWithFinalTCRBelowCT()

- **Signature**: `testNoIncreaseDebtWithAddCollWithFinalTCRBelowCT()`
- **Visibility**: public
- **Source Range**: 2071:309:301
- **Details**: [function_testNoIncreaseDebtWithAddCollWithFinalTCRBelowCT.md](./function_testNoIncreaseDebtWithAddCollWithFinalTCRBelowCT.md)
...
### testIncreaseDebtWithAddCollWithFinalTCRAboveCT()

- **Signature**: `testIncreaseDebtWithAddCollWithFinalTCRAboveCT()`
- **Visibility**: public
- **Source Range**: 2386:308:301
- **Details**: [function_testIncreaseDebtWithAddCollWithFinalTCRAboveCT.md](./function_testIncreaseDebtWithAddCollWithFinalTCRAboveCT.md)
...
### testNoIncreaseDebtWithWithdrawCollBelowCT()

- **Signature**: `testNoIncreaseDebtWithWithdrawCollBelowCT()`
- **Visibility**: public
- **Source Range**: 2700:245:301
- **Details**: [function_testNoIncreaseDebtWithWithdrawCollBelowCT.md](./function_testNoIncreaseDebtWithWithdrawCollBelowCT.md)
...
### testWithdrawCollAlongWithRepaymentBelowCT()

- **Signature**: `testWithdrawCollAlongWithRepaymentBelowCT()`
- **Visibility**: public
- **Source Range**: 2951:339:301
- **Details**: [function_testWithdrawCollAlongWithRepaymentBelowCT.md](./function_testWithdrawCollAlongWithRepaymentBelowCT.md)
...
### testNoCollWithdrawalWithLowRepaymentBelowCT()

- **Signature**: `testNoCollWithdrawalWithLowRepaymentBelowCT()`
- **Visibility**: public
- **Source Range**: 3296:311:301
- **Details**: [function_testNoCollWithdrawalWithLowRepaymentBelowCT.md](./function_testNoCollWithdrawalWithLowRepaymentBelowCT.md)
...
### testNoCollWithdrawalWithNoRepaymentBelowCT()

- **Signature**: `testNoCollWithdrawalWithNoRepaymentBelowCT()`
- **Visibility**: public
- **Source Range**: 3613:403:301
- **Details**: [function_testNoCollWithdrawalWithNoRepaymentBelowCT.md](./function_testNoCollWithdrawalWithNoRepaymentBelowCT.md)
...
### testNoPrematureInterestRateAdjustmentIfItWouldPullTCRBelowCCR()

- **Signature**: `testNoPrematureInterestRateAdjustmentIfItWouldPullTCRBelowCCR()`
- **Visibility**: public
- **Source Range**: 4022:668:301
- **Details**: [function_testNoPrematureInterestRateAdjustmentIfItWouldPullTCRBelowCCR.md](./function_testNoPrematureInterestRateAdjustmentIfItWouldPullTCRBelowCCR.md)
...
### testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR()

- **Signature**: `testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR()`
- **Visibility**: public
- **Source Range**: 4696:269:301
- **Details**: [function_testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR.md](./function_testPrematureInterestRateAdjustmentDisallowedIfTCRAlreadyBelowCCR.md)
...
### testNoAdjustmentIfFinalICRLtMCRFromAbove100AddingColl()

- **Signature**: `testNoAdjustmentIfFinalICRLtMCRFromAbove100AddingColl()`
- **Visibility**: public
- **Source Range**: 4971:666:301
- **Details**: [function_testNoAdjustmentIfFinalICRLtMCRFromAbove100AddingColl.md](./function_testNoAdjustmentIfFinalICRLtMCRFromAbove100AddingColl.md)
...
### testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying()

- **Signature**: `testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying()`
- **Visibility**: public
- **Source Range**: 5643:684:301
- **Details**: [function_testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying.md](./function_testNoAdjustmentIfFinalICRLtMCRFromAbove100Repaying.md)
...
### testNoAdjustmentIfFinalICRLtMCRFromBelow100AddingColl()

- **Signature**: `testNoAdjustmentIfFinalICRLtMCRFromBelow100AddingColl()`
- **Visibility**: public
- **Source Range**: 6333:596:301
- **Details**: [function_testNoAdjustmentIfFinalICRLtMCRFromBelow100AddingColl.md](./function_testNoAdjustmentIfFinalICRLtMCRFromBelow100AddingColl.md)
...
### testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying()

- **Signature**: `testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying()`
- **Visibility**: public
- **Source Range**: 6935:614:301
- **Details**: [function_testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying.md](./function_testNoAdjustmentIfFinalICRLtMCRFromBelow100Repaying.md)
