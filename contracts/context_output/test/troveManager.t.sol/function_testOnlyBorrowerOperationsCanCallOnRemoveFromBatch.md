# Function: testOnlyBorrowerOperationsCanCallOnRemoveFromBatch()
...
- **ITroveManagerTester::onRemoveFromBatch(uint256,uint256,uint256,struct TroveChange,address,uint256,uint256,uint256)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallOnRemoveFromBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
