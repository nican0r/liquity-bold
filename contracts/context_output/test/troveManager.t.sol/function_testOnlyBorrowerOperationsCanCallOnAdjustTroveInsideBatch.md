# Function: testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch()
...
- **ITroveManagerTester::onAdjustTroveInsideBatch(uint256,uint256,uint256,struct TroveChange,address,uint256,uint256)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
