...
- **Name**: TroveManagerTest
- **Type**: Contract
- **Path**: test/troveManager.t.sol
...
### testOnlyCollateralRegistryCanCallRedeem()

- **Signature**: `testOnlyCollateralRegistryCanCallRedeem()`
- **Visibility**: public
- **Source Range**: 150:256:335
- **Details**: [function_testOnlyCollateralRegistryCanCallRedeem.md](./function_testOnlyCollateralRegistryCanCallRedeem.md)
...
### testOnlyBorrowerOperationsCanCallShutdown()

- **Signature**: `testOnlyBorrowerOperationsCanCallShutdown()`
- **Visibility**: public
- **Source Range**: 412:226:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallShutdown.md](./function_testOnlyBorrowerOperationsCanCallShutdown.md)
...
### testOnlyBorrowerOperationsCanCallOnOpenTrove()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnOpenTrove()`
- **Visibility**: public
- **Source Range**: 644:313:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnOpenTrove.md](./function_testOnlyBorrowerOperationsCanCallOnOpenTrove.md)
...
### testOnlyBorrowerOperationsCanCallOnOpenTroveAndJoinBatch()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnOpenTroveAndJoinBatch()`
- **Visibility**: public
- **Source Range**: 963:353:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnOpenTroveAndJoinBatch.md](./function_testOnlyBorrowerOperationsCanCallOnOpenTroveAndJoinBatch.md)
...
### testOnlyBorrowerOperationsCanCallSetTroveStatusToActive()

- **Signature**: `testOnlyBorrowerOperationsCanCallSetTroveStatusToActive()`
- **Visibility**: public
- **Source Range**: 1322:273:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallSetTroveStatusToActive.md](./function_testOnlyBorrowerOperationsCanCallSetTroveStatusToActive.md)
...
### testOnlyBorrowerOperationsCanCallOnAdjustTroveInterestRate()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnAdjustTroveInterestRate()`
- **Visibility**: public
- **Source Range**: 1601:357:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnAdjustTroveInterestRate.md](./function_testOnlyBorrowerOperationsCanCallOnAdjustTroveInterestRate.md)
...
### testOnlyBorrowerOperationsCanCallOnAdjustTrove()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnAdjustTrove()`
- **Visibility**: public
- **Source Range**: 1964:327:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnAdjustTrove.md](./function_testOnlyBorrowerOperationsCanCallOnAdjustTrove.md)
...
### testOnlyBorrowerOperationsCanCallOnCloseTrove()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnCloseTrove()`
- **Visibility**: public
- **Source Range**: 2297:328:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnCloseTrove.md](./function_testOnlyBorrowerOperationsCanCallOnCloseTrove.md)
...
### testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch()`
- **Visibility**: public
- **Source Range**: 2631:371:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch.md](./function_testOnlyBorrowerOperationsCanCallOnAdjustTroveInsideBatch.md)
...
### testOnlyBorrowerOperationsCanCallOnApplyTroveInterest()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnApplyTroveInterest()`
- **Visibility**: public
- **Source Range**: 3008:363:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnApplyTroveInterest.md](./function_testOnlyBorrowerOperationsCanCallOnApplyTroveInterest.md)
...
### testOnlyBorrowerOperationsCanCallOnRegisterBatchManager()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnRegisterBatchManager()`
- **Visibility**: public
- **Source Range**: 3377:267:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnRegisterBatchManager.md](./function_testOnlyBorrowerOperationsCanCallOnRegisterBatchManager.md)
...
### testOnlyBorrowerOperationsCanCallOnLowerBatchManagerAnnualFee()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnLowerBatchManagerAnnualFee()`
- **Visibility**: public
- **Source Range**: 3650:292:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnLowerBatchManagerAnnualFee.md](./function_testOnlyBorrowerOperationsCanCallOnLowerBatchManagerAnnualFee.md)
...
### testOnlyBorrowerOperationsCanCallOnSetBatchManagerAnnualInterestRate()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnSetBatchManagerAnnualInterestRate()`
- **Visibility**: public
- **Source Range**: 3948:314:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnSetBatchManagerAnnualInterestRate.md](./function_testOnlyBorrowerOperationsCanCallOnSetBatchManagerAnnualInterestRate.md)
...
### testOnlyBorrowerOperationsCanCallOnSetInterestBatchManager()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnSetInterestBatchManager()`
- **Visibility**: public
- **Source Range**: 4268:334:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnSetInterestBatchManager.md](./function_testOnlyBorrowerOperationsCanCallOnSetInterestBatchManager.md)
...
### testOnlyBorrowerOperationsCanCallOnRemoveFromBatch()

- **Signature**: `testOnlyBorrowerOperationsCanCallOnRemoveFromBatch()`
- **Visibility**: public
- **Source Range**: 4608:363:335
- **Details**: [function_testOnlyBorrowerOperationsCanCallOnRemoveFromBatch.md](./function_testOnlyBorrowerOperationsCanCallOnRemoveFromBatch.md)
...
### testLiquidateLastTroveReverts()

- **Signature**: `testLiquidateLastTroveReverts()`
- **Visibility**: public
- **Source Range**: 4977:372:335
- **Details**: [function_testLiquidateLastTroveReverts.md](./function_testLiquidateLastTroveReverts.md)
...
### testRedeemSkipTrovesUnder100pct()

- **Signature**: `testRedeemSkipTrovesUnder100pct()`
- **Visibility**: public
- **Source Range**: 5355:1824:335
- **Details**: [function_testRedeemSkipTrovesUnder100pct.md](./function_testRedeemSkipTrovesUnder100pct.md)
...
### testInitialRedemptionBaseRate()

- **Signature**: `testInitialRedemptionBaseRate()`
- **Visibility**: public
- **Source Range**: 7185:128:335
- **Details**: [function_testInitialRedemptionBaseRate.md](./function_testInitialRedemptionBaseRate.md)
...
### testRedemptionBaseRateAfter2Weeks()

- **Signature**: `testRedemptionBaseRateAfter2Weeks()`
- **Visibility**: public
- **Source Range**: 7319:655:335
- **Details**: [function_testRedemptionBaseRateAfter2Weeks.md](./function_testRedemptionBaseRateAfter2Weeks.md)
...
### testLiquidationSucceedsEvenWhenEncounteringInactiveTroves()

- **Signature**: `testLiquidationSucceedsEvenWhenEncounteringInactiveTroves()`
- **Visibility**: public
- **Source Range**: 7980:988:335
- **Details**: [function_testLiquidationSucceedsEvenWhenEncounteringInactiveTroves.md](./function_testLiquidationSucceedsEvenWhenEncounteringInactiveTroves.md)
