# Function: testOnlyBorrowerOperationsCanCallOnApplyTroveInterest()
...
- **ITroveManagerTester::onApplyTroveInterest(uint256,uint256,uint256,address,uint256,uint256,struct TroveChange)**
- **Vm::stopPrank()**

## Call Tree

```
┌─ [0] ⚙️ FUNCTION: TroveManagerTest.testOnlyBorrowerOperationsCanCallOnApplyTroveInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
