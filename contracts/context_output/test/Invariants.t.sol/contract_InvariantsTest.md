...
### adam (inherited from BaseInvariantTest)

```solidity
address internal constant adam = 0x1111111111111111111111111111111111111111
```

### barb (inherited from BaseInvariantTest)

```solidity
address internal constant barb = 0x2222222222222222222222222222222222222222
```

### carl (inherited from BaseInvariantTest)

```solidity
address internal constant carl = 0x3333333333333333333333333333333333333333
```

### dana (inherited from BaseInvariantTest)

```solidity
address internal constant dana = 0x4444444444444444444444444444444444444444
```

### eric (inherited from BaseInvariantTest)

```solidity
address internal constant eric = 0x5555555555555555555555555555555555555555
```

### fran (inherited from BaseInvariantTest)

```solidity
address internal constant fran = 0x6666666666666666666666666666666666666666
```

### gabe (inherited from BaseInvariantTest)

```solidity
address internal constant gabe = 0x7777777777777777777777777777777777777777
```

### hope (inherited from BaseInvariantTest)

```solidity
address internal constant hope = 0x8888888888888888888888888888888888888888
```

### actors (inherited from BaseInvariantTest)
...
```solidity
InvariantsTestHandler internal handler
```

**InvariantsTestHandler**: [test/TestContracts/InvariantsTestHandler.t.sol/contract_InvariantsTestHandler.md]

### seenBatches

```solidity
BatchIdSet internal seenBatches
```
...
### Actor (inherited from BaseInvariantTest)
...
### invariant_FundsAreSwept()

- **Signature**: `invariant_FundsAreSwept()`
- **Visibility**: external
- **Source Range**: 4655:871:243
- **Details**: [function_invariant_FundsAreSwept.md](./function_invariant_FundsAreSwept.md)
...
### invariant_SystemStateMatchesGhostState()

- **Signature**: `invariant_SystemStateMatchesGhostState()`
- **Visibility**: external
- **Source Range**: 5532:4349:243
- **Details**: [function_invariant_SystemStateMatchesGhostState.md](./function_invariant_SystemStateMatchesGhostState.md)
...
### invariant_OnlyActiveTrovesInSortedTroves()

- **Signature**: `invariant_OnlyActiveTrovesInSortedTroves()`
- **Visibility**: external
- **Source Range**: 9887:1008:243
- **Details**: [function_invariant_OnlyActiveTrovesInSortedTroves.md](./function_invariant_OnlyActiveTrovesInSortedTroves.md)
...
### invariant_AllBoldBackedByTroveDebt()

- **Signature**: `invariant_AllBoldBackedByTroveDebt()`
- **Visibility**: external
- **Source Range**: 10901:1628:243
- **Details**: [function_invariant_AllBoldBackedByTroveDebt.md](./function_invariant_AllBoldBackedByTroveDebt.md)
...
### invariant_AllCollClaimable()

- **Signature**: `invariant_AllCollClaimable()`
- **Visibility**: external
- **Source Range**: 12535:654:243
- **Details**: [function_invariant_AllCollClaimable.md](./function_invariant_AllCollClaimable.md)
...
### invariant_StabilityPool_AllBoldClaimable_ExceptYieldReceivedWhileEmpty()

- **Signature**: `invariant_StabilityPool_AllBoldClaimable_ExceptYieldReceivedWhileEmpty()`
- **Visibility**: external
- **Source Range**: 13195:1264:243
- **Details**: [function_invariant_StabilityPool_AllBoldClaimable_ExceptYieldReceivedWhileEmpty.md](./function_invariant_StabilityPool_AllBoldClaimable_ExceptYieldReceivedWhileEmpty.md)
...
### invariant_StabilityPool_AllCollClaimable()

- **Signature**: `invariant_StabilityPool_AllCollClaimable()`
- **Visibility**: external
- **Source Range**: 14465:648:243
- **Details**: [function_invariant_StabilityPool_AllCollClaimable.md](./function_invariant_StabilityPool_AllCollClaimable.md)
...
### invariant_SortedTroves_OrderedByInterestRate()

- **Signature**: `invariant_SortedTroves_OrderedByInterestRate()`
- **Visibility**: external
- **Source Range**: 15119:1915:243
- **Details**: [function_invariant_SortedTroves_OrderedByInterestRate.md](./function_invariant_SortedTroves_OrderedByInterestRate.md)
...
### invariant_SortedTroves_BatchesAreContiguous()

- **Signature**: `invariant_SortedTroves_BatchesAreContiguous()`
- **Visibility**: external
- **Source Range**: 17040:1684:243
- **Details**: [function_invariant_SortedTroves_BatchesAreContiguous.md](./function_invariant_SortedTroves_BatchesAreContiguous.md)
...
### constructor() (inherited from BaseInvariantTest)
