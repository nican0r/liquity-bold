# Function: testAdjustTroveInterestRateSetsReducesPendingInterestTo0()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testAdjustTroveInterestRateSetsReducesPendingInterestTo0() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
