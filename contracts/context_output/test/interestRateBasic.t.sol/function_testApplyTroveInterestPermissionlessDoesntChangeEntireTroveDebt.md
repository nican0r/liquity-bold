# Function: testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 7)
      💬 Args: [entireTroveDebt_2, entireTroveDebt_1]
      👁️  Def: internal
```
