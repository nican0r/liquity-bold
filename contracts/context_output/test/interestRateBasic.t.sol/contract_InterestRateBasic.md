...
- **Name**: InterestRateBasic
- **Type**: Contract
- **Path**: test/interestRateBasic.t.sol
...
### testOpenTroveSetsInterestRate()

- **Signature**: `testOpenTroveSetsInterestRate()`
- **Visibility**: public
- **Source Range**: 151:402:307
- **Details**: [function_testOpenTroveSetsInterestRate.md](./function_testOpenTroveSetsInterestRate.md)
...
### testOpenTroveSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testOpenTroveSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 559:685:307
- **Details**: [function_testOpenTroveSetsTroveLastDebtUpdateTimeToNow.md](./function_testOpenTroveSetsTroveLastDebtUpdateTimeToNow.md)
...
### testOpenTroveInsertsToCorrectPositionInSortedList()

- **Signature**: `testOpenTroveInsertsToCorrectPositionInSortedList()`
- **Visibility**: public
- **Source Range**: 1250:1766:307
- **Details**: [function_testOpenTroveInsertsToCorrectPositionInSortedList.md](./function_testOpenTroveInsertsToCorrectPositionInSortedList.md)
...
### testRevertWhenAdjustInterestRateFromNonOwner()

- **Signature**: `testRevertWhenAdjustInterestRateFromNonOwner()`
- **Visibility**: public
- **Source Range**: 3505:540:307
- **Details**: [function_testRevertWhenAdjustInterestRateFromNonOwner.md](./function_testRevertWhenAdjustInterestRateFromNonOwner.md)
...
### testAdjustTroveInterestRateSetsCorrectNewRate()

- **Signature**: `testAdjustTroveInterestRateSetsCorrectNewRate()`
- **Visibility**: public
- **Source Range**: 4849:1063:307
- **Details**: [function_testAdjustTroveInterestRateSetsCorrectNewRate.md](./function_testAdjustTroveInterestRateSetsCorrectNewRate.md)
...
### testAdjustTroveInterestRateSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testAdjustTroveInterestRateSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 5918:475:307
- **Details**: [function_testAdjustTroveInterestRateSetsTroveLastDebtUpdateTimeToNow.md](./function_testAdjustTroveInterestRateSetsTroveLastDebtUpdateTimeToNow.md)
...
### testAdjustTroveInterestRateSetsReducesPendingInterestTo0()

- **Signature**: `testAdjustTroveInterestRateSetsReducesPendingInterestTo0()`
- **Visibility**: public
- **Source Range**: 6399:440:307
- **Details**: [function_testAdjustTroveInterestRateSetsReducesPendingInterestTo0.md](./function_testAdjustTroveInterestRateSetsReducesPendingInterestTo0.md)
...
### testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature()

- **Signature**: `testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature()`
- **Visibility**: public
- **Source Range**: 6845:957:307
- **Details**: [function_testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature.md](./function_testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature.md)
...
### testAdjustTroveInterestRateIncreasesRecordedDebtByAccruedInterestAndUpfrontFee()

- **Signature**: `testAdjustTroveInterestRateIncreasesRecordedDebtByAccruedInterestAndUpfrontFee()`
- **Visibility**: public
- **Source Range**: 7808:1496:307
- **Details**: [function_testAdjustTroveInterestRateIncreasesRecordedDebtByAccruedInterestAndUpfrontFee.md](./function_testAdjustTroveInterestRateIncreasesRecordedDebtByAccruedInterestAndUpfrontFee.md)
...
### testAdjustTroveInterestRateInsertsToCorrectPositionInSortedList()

- **Signature**: `testAdjustTroveInterestRateInsertsToCorrectPositionInSortedList()`
- **Visibility**: public
- **Source Range**: 9310:2082:307
- **Details**: [function_testAdjustTroveInterestRateInsertsToCorrectPositionInSortedList.md](./function_testAdjustTroveInterestRateInsertsToCorrectPositionInSortedList.md)
...
### testAdjustTroveDoesNotChangeListPositions()

- **Signature**: `testAdjustTroveDoesNotChangeListPositions()`
- **Visibility**: public
- **Source Range**: 11398:1820:307
- **Details**: [function_testAdjustTroveDoesNotChangeListPositions.md](./function_testAdjustTroveDoesNotChangeListPositions.md)
...
### testWithdrawBoldSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testWithdrawBoldSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 13253:634:307
- **Details**: [function_testWithdrawBoldSetsTroveLastDebtUpdateTimeToNow.md](./function_testWithdrawBoldSetsTroveLastDebtUpdateTimeToNow.md)
...
### testWithdrawBoldReducesTroveAccruedInterestTo0()

- **Signature**: `testWithdrawBoldReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 13893:601:307
- **Details**: [function_testWithdrawBoldReducesTroveAccruedInterestTo0.md](./function_testWithdrawBoldReducesTroveAccruedInterestTo0.md)
...
### testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee()

- **Signature**: `testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee()`
- **Visibility**: public
- **Source Range**: 14500:889:307
- **Details**: [function_testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee.md](./function_testWithdrawBoldIncreasesEntireTroveDebtByWithdrawnAmountPlusUpfrontFee.md)
...
### testWithdrawBoldIncreasesRecordedTroveDebtByAccruedInterestPlusWithdrawnAmountPlusUpfrontFee()
...
- **Details**: [function_testWithdrawBoldIncreasesRecordedTroveDebtByAccruedInterestPlusWithdrawnAmountPlusUpfrontFee.md](./function_testWithdrawBoldIncreasesRecordedTroveDebtByAccruedInterestPlusWithdrawnAmountPlusUpfrontFee.md)
...
### testRepayBoldSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testRepayBoldSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 16370:617:307
- **Details**: [function_testRepayBoldSetsTroveLastDebtUpdateTimeToNow.md](./function_testRepayBoldSetsTroveLastDebtUpdateTimeToNow.md)
...
### testRepayBoldReducesTroveAccruedInterestTo0()

- **Signature**: `testRepayBoldReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 16993:583:307
- **Details**: [function_testRepayBoldReducesTroveAccruedInterestTo0.md](./function_testRepayBoldReducesTroveAccruedInterestTo0.md)
...
### testRepayBoldReducesEntireTroveDebtByRepaidAmount()

- **Signature**: `testRepayBoldReducesEntireTroveDebtByRepaidAmount()`
- **Visibility**: public
- **Source Range**: 17582:719:307
- **Details**: [function_testRepayBoldReducesEntireTroveDebtByRepaidAmount.md](./function_testRepayBoldReducesEntireTroveDebtByRepaidAmount.md)
...
### testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount()

- **Signature**: `testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount()`
- **Visibility**: public
- **Source Range**: 18307:749:307
- **Details**: [function_testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount.md](./function_testRepayBoldChangesRecordedTroveDebtByAccruedInterestMinusRepaidAmount.md)
...
### testAddCollSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testAddCollSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 19086:610:307
- **Details**: [function_testAddCollSetsTroveLastDebtUpdateTimeToNow.md](./function_testAddCollSetsTroveLastDebtUpdateTimeToNow.md)
...
### testAddCollReducesTroveAccruedInterestTo0()

- **Signature**: `testAddCollReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 19702:576:307
- **Details**: [function_testAddCollReducesTroveAccruedInterestTo0.md](./function_testAddCollReducesTroveAccruedInterestTo0.md)
...
### testAddCollDoesntChangeEntireTroveDebt()

- **Signature**: `testAddCollDoesntChangeEntireTroveDebt()`
- **Visibility**: public
- **Source Range**: 20284:687:307
- **Details**: [function_testAddCollDoesntChangeEntireTroveDebt.md](./function_testAddCollDoesntChangeEntireTroveDebt.md)
...
### testAddCollIncreasesRecordedTroveDebtByAccruedInterest()

- **Signature**: `testAddCollIncreasesRecordedTroveDebtByAccruedInterest()`
- **Visibility**: public
- **Source Range**: 20977:771:307
- **Details**: [function_testAddCollIncreasesRecordedTroveDebtByAccruedInterest.md](./function_testAddCollIncreasesRecordedTroveDebtByAccruedInterest.md)
...
### testWithdrawCollSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testWithdrawCollSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 21783:625:307
- **Details**: [function_testWithdrawCollSetsTroveLastDebtUpdateTimeToNow.md](./function_testWithdrawCollSetsTroveLastDebtUpdateTimeToNow.md)
...
### testWithdrawCollReducesTroveAccruedInterestTo0()

- **Signature**: `testWithdrawCollReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 22414:591:307
- **Details**: [function_testWithdrawCollReducesTroveAccruedInterestTo0.md](./function_testWithdrawCollReducesTroveAccruedInterestTo0.md)
...
### testWithdrawCollDoesntChangeEntireTroveDebt()

- **Signature**: `testWithdrawCollDoesntChangeEntireTroveDebt()`
- **Visibility**: public
- **Source Range**: 23011:702:307
- **Details**: [function_testWithdrawCollDoesntChangeEntireTroveDebt.md](./function_testWithdrawCollDoesntChangeEntireTroveDebt.md)
...
### testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest()

- **Signature**: `testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest()`
- **Visibility**: public
- **Source Range**: 23719:786:307
- **Details**: [function_testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest.md](./function_testWithdrawCollIncreasesRecordedTroveDebtByAccruedInterest.md)
...
### testApplyTroveInterestPermissionlessSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testApplyTroveInterestPermissionlessSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 24544:772:307
- **Details**: [function_testApplyTroveInterestPermissionlessSetsTroveLastDebtUpdateTimeToNow.md](./function_testApplyTroveInterestPermissionlessSetsTroveLastDebtUpdateTimeToNow.md)
...
### testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0()

- **Signature**: `testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 25322:738:307
- **Details**: [function_testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0.md](./function_testApplyTroveInterestPermissionlessReducesTroveAccruedInterestTo0.md)
...
### testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt()

- **Signature**: `testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt()`
- **Visibility**: public
- **Source Range**: 26066:849:307
- **Details**: [function_testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt.md](./function_testApplyTroveInterestPermissionlessDoesntChangeEntireTroveDebt.md)
...
### testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest()

- **Signature**: `testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest()`
- **Visibility**: public
- **Source Range**: 26921:933:307
- **Details**: [function_testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest.md](./function_testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest.md)
...
### testApplyTroveInterestPermissionlessUpdatesRedistribution()

- **Signature**: `testApplyTroveInterestPermissionlessUpdatesRedistribution()`
- **Visibility**: public
- **Source Range**: 27860:1630:307
- **Details**: [function_testApplyTroveInterestPermissionlessUpdatesRedistribution.md](./function_testApplyTroveInterestPermissionlessUpdatesRedistribution.md)
...
### testApplyTroveInterestPermissionlessRevertsIfTroveHasZeroDebt()

- **Signature**: `testApplyTroveInterestPermissionlessRevertsIfTroveHasZeroDebt()`
- **Visibility**: public
- **Source Range**: 29496:1215:307
- **Details**: [function_testApplyTroveInterestPermissionlessRevertsIfTroveHasZeroDebt.md](./function_testApplyTroveInterestPermissionlessRevertsIfTroveHasZeroDebt.md)
...
### testRedemptionSetsTroveLastDebtUpdateTimeToNow()

- **Signature**: `testRedemptionSetsTroveLastDebtUpdateTimeToNow()`
- **Visibility**: public
- **Source Range**: 30745:606:307
- **Details**: [function_testRedemptionSetsTroveLastDebtUpdateTimeToNow.md](./function_testRedemptionSetsTroveLastDebtUpdateTimeToNow.md)
...
### testRedemptionReducesTroveAccruedInterestTo0()

- **Signature**: `testRedemptionReducesTroveAccruedInterestTo0()`
- **Visibility**: public
- **Source Range**: 31357:572:307
- **Details**: [function_testRedemptionReducesTroveAccruedInterestTo0.md](./function_testRedemptionReducesTroveAccruedInterestTo0.md)
...
### testRedemptionReducesEntireTroveDebtByRedeemedAmount()

- **Signature**: `testRedemptionReducesEntireTroveDebtByRedeemedAmount()`
- **Visibility**: public
- **Source Range**: 31935:710:307
- **Details**: [function_testRedemptionReducesEntireTroveDebtByRedeemedAmount.md](./function_testRedemptionReducesEntireTroveDebtByRedeemedAmount.md)
...
### testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount()

- **Signature**: `testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount()`
- **Visibility**: public
- **Source Range**: 32651:745:307
- **Details**: [function_testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount.md](./function_testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount.md)
...
### testOpenTroveMintsUpfrontFeeToInterestReceivers()

- **Signature**: `testOpenTroveMintsUpfrontFeeToInterestReceivers()`
- **Visibility**: public
- **Source Range**: 33430:601:307
- **Details**: [function_testOpenTroveMintsUpfrontFeeToInterestReceivers.md](./function_testOpenTroveMintsUpfrontFeeToInterestReceivers.md)
