# Function: testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testApplyTroveInterestPermissionlessIncreasesRecordedTroveDebtByAccruedInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 5)
  │   💬 Args: [B, ATroveId]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 6)
      💬 Args: [recordedTroveDebt_2, recordedTroveDebt_1 + accruedTroveInterest]
      👁️  Def: internal
```
