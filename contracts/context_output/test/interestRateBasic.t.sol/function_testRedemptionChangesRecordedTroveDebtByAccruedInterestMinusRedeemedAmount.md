# Function: testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRedemptionChangesRecordedTroveDebtByAccruedInterestMinusRedeemedAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 41)
      💬 Args: [postRedeem.recordedDebt, (preRedeem.recordedDebt + preRedeem.accruedInterest) - redeemAmount]
      👁️  Def: internal
```
