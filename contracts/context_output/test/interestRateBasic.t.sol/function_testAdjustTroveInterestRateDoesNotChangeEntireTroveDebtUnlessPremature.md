# Function: testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testAdjustTroveInterestRateDoesNotChangeEntireTroveDebtUnlessPremature() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [entireTroveDebt_1, entireTroveDebt_2]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 8)
      💬 Args: [entireTroveDebt_3, entireTroveDebt_2]
      👁️  Def: internal
```
