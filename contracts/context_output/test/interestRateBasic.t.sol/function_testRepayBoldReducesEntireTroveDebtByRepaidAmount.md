# Function: testRepayBoldReducesEntireTroveDebtByRepaidAmount()
...
```
┌─ [0] ⚙️ FUNCTION: InterestRateBasic.testRepayBoldReducesEntireTroveDebtByRepaidAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 6)
      💬 Args: [entireTroveDebt_2, entireTroveDebt_1 - boldRepayment]
      👁️  Def: internal
```
