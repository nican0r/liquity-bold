# Function: testRemovesBatchManagerProperlyWithDifferentNewInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testRemovesBatchManagerProperlyWithDifferentNewInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
