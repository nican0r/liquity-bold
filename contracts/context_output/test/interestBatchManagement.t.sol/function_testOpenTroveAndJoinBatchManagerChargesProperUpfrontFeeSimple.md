# Function: testOpenTroveAndJoinBatchManagerChargesProperUpfrontFeeSimple()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testOpenTroveAndJoinBatchManagerChargesProperUpfrontFeeSimple() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 12)
      💬 Args: [CTroveEntireDebt - initialDebt, expectedUpfrontFeeC, 100, "Wrong upfront fee for C"]
      👁️  Def: internal
```
