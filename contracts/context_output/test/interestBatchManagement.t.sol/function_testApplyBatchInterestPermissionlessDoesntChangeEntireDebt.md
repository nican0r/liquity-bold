# Function: testApplyBatchInterestPermissionlessDoesntChangeEntireDebt()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testApplyBatchInterestPermissionlessDoesntChangeEntireDebt() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [entireBatchDebt_2, entireBatchDebt_1, "Batch entire debt mismatch"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 10)
      💬 Args: [entireTroveDebt_2, entireTroveDebt_1, "Trove entire debt mismatch"]
      👁️  Def: internal
```
