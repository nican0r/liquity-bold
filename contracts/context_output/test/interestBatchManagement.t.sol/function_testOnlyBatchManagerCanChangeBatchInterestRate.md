# Function: testOnlyBatchManagerCanChangeBatchInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testOnlyBatchManagerCanChangeBatchInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
