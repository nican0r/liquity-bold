# Function: testJoinABatchWithSameInterestAndLeaveToSameInterestChargesUpfrontFeeOnlyOnce()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testJoinABatchWithSameInterestAndLeaveToSameInterestChargesUpfrontFeeOnlyOnce() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
