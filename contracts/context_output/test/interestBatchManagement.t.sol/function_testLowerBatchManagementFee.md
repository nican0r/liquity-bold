# Function: testLowerBatchManagementFee()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testLowerBatchManagementFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
      💬 Args: [batch.annualManagementFee, 10e14, "Wrong batch management fee"]
      👁️  Def: internal
```
