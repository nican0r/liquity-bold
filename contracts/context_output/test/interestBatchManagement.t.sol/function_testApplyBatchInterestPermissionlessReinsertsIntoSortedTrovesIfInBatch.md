# Function: testApplyBatchInterestPermissionlessReinsertsIntoSortedTrovesIfInBatch()
...
function testApplyBatchInterestPermissionlessReinsertsIntoSortedTrovesIfInBatch() public {
    ...
    assertEq(uint8(troveManager.getTroveStatus(ATroveId)), uint8(ITroveManager.Status.active), "A should not be zombie");
    assertEq(sortedTroves.contains(ATroveId), true, "SortedTroves should have trove A ");
    assertEq(sortedTroves.isBatchedNode(ATroveId), true, "A should be batched in SortedTroves");
...
- **ISortedTroves::isBatchedNode(uint256)**
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testApplyBatchInterestPermissionlessReinsertsIntoSortedTrovesIfInBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [sortedTroves.contains(ATroveId), true, "SortedTroves should have trove A "]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 7)
  │   💬 Args: [sortedTroves.isBatchedNode(ATroveId), true, "A should be batched in SortedTroves"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 8)
  │   💬 Args: [A, 500e18]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 9)
  │   💬 Args: [uint8(troveManager.getTroveStatus(ATroveId)), uint8(ITroveManager.Status.zombie)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 10)
  │   💬 Args: [C, ATroveId]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 11)
  │   💬 Args: [uint8(troveManager.getTroveStatus(ATroveId)), uint8(ITroveManager.Status.active), "A should not be zombie"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(bool,bool,string) (NodeID: 12)
  │   💬 Args: [sortedTroves.contains(ATroveId), true, "SortedTroves should have trove A "]
  │   👁️  Def: internal
  ...
  │   💬 Args: [batchManagerAddress, B, "Wrong batch manager in BO"]
  │   👁️  Def: internal
