# Function: testLowerBatchManagementFeeDoesNotApplyRedistributionGains()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testLowerBatchManagementFeeDoesNotApplyRedistributionGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
      💬 Args: [troveData.recordedDebt, troveRecordedDebtBefore, "Recorded debt should stay the same"]
      👁️  Def: internal
```
