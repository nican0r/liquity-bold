# Function: testOnlyBatchManagerCanLowerBatchManagementFee()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testOnlyBatchManagerCanLowerBatchManagementFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
