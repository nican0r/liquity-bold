# Function: testChangeBatchInterestRate()
...
- **Vm::stopPrank()**
- **ITroveManagerTester::getBatchAnnualInterestRate(address)**
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testChangeBatchInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [ATroveEntireDebtBefore, ATroveRecordedDebtBefore, "Trove entire debt should be greater than recorded"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 8)
  │   💬 Args: [batchEntireDebtBefore, batchRecordedDebtBefore, "Batch entire debt should be greater than recorded"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 9)
  │   💬 Args: [troveManager.getTroveDebt(troveId), ATroveEntireDebtBefore, "Interest was not applied to trove"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 10)
  │   💬 Args: [troveManager.getTroveDebt(troveId), troveManager.getTroveEntireDebt(troveId), "Trove recorded debt should be equal to entire"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 11)
  │   💬 Args: [batch.recordedDebt, batchEntireDebtBefore, "Interest was not applied to batch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 12)
  │   💬 Args: [batch.recordedDebt, batch.entireDebtWithoutRedistribution, "Batch recorded debt should be equal to entire"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 13)
      💬 Args: [troveManager.getBatchAnnualInterestRate(B), 6e16, "Wrong batch interest rate"]
      👁️  Def: internal
```
