# Function: testSwitchBatchManagerChargesUpfrontFeeIfJoinedOldLessThanCooldownAgo()
...
```
┌─ [0] ⚙️ FUNCTION: InterestBatchManagementTest.testSwitchBatchManagerChargesUpfrontFeeIfJoinedOldLessThanCooldownAgo() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
