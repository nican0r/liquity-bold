...
- **Name**: MulticollateralTest
- **Type**: Contract
- **Path**: test/multicollateral.t.sol
...
- **Details**: [function_makeMulticollateralSPDepositAndClaim_uint256_address_uint256.md](./function_makeMulticollateralSPDepositAndClaim_uint256_address_uint256.md)
...
### testMultiCollateralDeployment()

- **Signature**: `testMultiCollateralDeployment()`
- **Visibility**: public
- **Source Range**: 4445:956:311
- **Details**: [function_testMultiCollateralDeployment.md](./function_testMultiCollateralDeployment.md)
...
### testMultiCollateralRedemption()

- **Signature**: `testMultiCollateralRedemption()`
- **Visibility**: public
- **Source Range**: 5820:5824:311
- **Details**: [function_testMultiCollateralRedemption.md](./function_testMultiCollateralRedemption.md)
...
### testMultiCollateralRedemptionFuzz(uint256,uint256,uint256,uint256,uint256)

- **Signature**: `testMultiCollateralRedemptionFuzz(uint256,uint256,uint256,uint256,uint256)`
- **Visibility**: public
- **Source Range**: 11650:886:311
- **Details**: [function_testMultiCollateralRedemptionFuzz_uint256_uint256_uint256_uint256_uint256.md](./function_testMultiCollateralRedemptionFuzz_uint256_uint256_uint256_uint256_uint256.md)
...
### testMultiCollateralRedemptionMaxSPAmount()

- **Signature**: `testMultiCollateralRedemptionMaxSPAmount()`
- **Visibility**: public
- **Source Range**: 12542:377:311
- **Details**: [function_testMultiCollateralRedemptionMaxSPAmount.md](./function_testMultiCollateralRedemptionMaxSPAmount.md)
...
### testMultiCollRedemptionIncreasesRedeemerETHBalanceByCorrespondingETHLessTheETHFee()

- **Signature**: `testMultiCollRedemptionIncreasesRedeemerETHBalanceByCorrespondingETHLessTheETHFee()`
- **Visibility**: public
- **Source Range**: 19178:5350:311
- **Details**: [function_testMultiCollRedemptionIncreasesRedeemerETHBalanceByCorrespondingETHLessTheETHFee.md](./function_testMultiCollRedemptionIncreasesRedeemerETHBalanceByCorrespondingETHLessTheETHFee.md)
...
### testMultiCollateralRedemptionWithZeroUnbacked()

- **Signature**: `testMultiCollateralRedemptionWithZeroUnbacked()`
- **Visibility**: public
- **Source Range**: 24534:6121:311
- **Details**: [function_testMultiCollateralRedemptionWithZeroUnbacked.md](./function_testMultiCollateralRedemptionWithZeroUnbacked.md)
...
### testMultiCollateralRedemptionWithZeroUnbackedLowSCRButNoShutdown()

- **Signature**: `testMultiCollateralRedemptionWithZeroUnbackedLowSCRButNoShutdown()`
- **Visibility**: public
- **Source Range**: 30661:6298:311
- **Details**: [function_testMultiCollateralRedemptionWithZeroUnbackedLowSCRButNoShutdown.md](./function_testMultiCollateralRedemptionWithZeroUnbackedLowSCRButNoShutdown.md)
