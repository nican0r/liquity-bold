...
- **Name**: DebtInFrontHelperTest
- **Type**: Contract
- **Path**: test/DebtInFrontHelper.t.sol
...
```solidity
IDebtInFrontHelper internal debtInFrontHelper
```
...
### test_GetDebtBetweenInterestRates(uint256[8],uint256,uint256,uint8)

- **Signature**: `test_GetDebtBetweenInterestRates(uint256[8],uint256,uint256,uint8)`
- **Visibility**: external
- **Source Range**: 511:1839:230
- **Details**: [function_test_GetDebtBetweenInterestRates_uint256[8]_uint256_uint256_uint8.md](./function_test_GetDebtBetweenInterestRates_uint256[8]_uint256_uint256_uint8.md)
...
### test_GetDebtBetweenInterestRateAndTrove(uint256[8],uint256,uint256,uint8)

- **Signature**: `test_GetDebtBetweenInterestRateAndTrove(uint256[8],uint256,uint256,uint8)`
- **Visibility**: external
- **Source Range**: 2356:1872:230
- **Details**: [function_test_GetDebtBetweenInterestRateAndTrove_uint256[8]_uint256_uint256_uint8.md](./function_test_GetDebtBetweenInterestRateAndTrove_uint256[8]_uint256_uint256_uint8.md)

**Signature:**
```solidity
function test_GetDebtBetweenInterestRateAndTrove(uint256[8] memory debt, uint256 troveIdToStopAt, uint256 hintId, uint8 numTrials) external;
```
