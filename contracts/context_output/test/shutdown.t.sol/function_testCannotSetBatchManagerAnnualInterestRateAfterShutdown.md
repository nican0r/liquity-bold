# Function: testCannotSetBatchManagerAnnualInterestRateAfterShutdown()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testCannotSetBatchManagerAnnualInterestRateAfterShutdown() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
