# Function: testCannotUrgentRedeemWithoutShutdown()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testCannotUrgentRedeemWithoutShutdown() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: ShutdownTest.openMulticollateralTroveNoHints100pctWithIndex(uint256,address,uint256,uint256,uint256,uint256) (NodeID: 5)
  ...
  │       💬 Args: [debt * avgInterestRate, UPFRONT_INTEREST_PERIOD]
  │       👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.uintToArray(uint256) (NodeID: 8)
      💬 Args: [troveId]
      👁️  Def: public
```
