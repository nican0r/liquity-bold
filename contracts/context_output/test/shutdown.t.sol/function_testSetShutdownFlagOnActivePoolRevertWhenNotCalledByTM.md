# Function: testSetShutdownFlagOnActivePoolRevertWhenNotCalledByTM()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testSetShutdownFlagOnActivePoolRevertWhenNotCalledByTM() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
