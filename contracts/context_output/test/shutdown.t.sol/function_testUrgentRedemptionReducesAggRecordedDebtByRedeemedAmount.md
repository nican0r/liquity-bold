# Function: testUrgentRedemptionReducesAggRecordedDebtByRedeemedAmount()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testUrgentRedemptionReducesAggRecordedDebtByRedeemedAmount() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
