# Function: testUrgentRedemptionReducesAggWeightedDebtSumByNetWeightedAmountRemoved()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testUrgentRedemptionReducesAggWeightedDebtSumByNetWeightedAmountRemoved() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [aggWeightedDebtSum_t0, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.uintToArray(uint256) (NodeID: 14)
  │   💬 Args: [troveId3]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 15)
      💬 Args: [contractsArray[0].activePool.aggWeightedDebtSum(), aggWeightedDebtSum_t0 - netWeightedDebtRemoved]
      👁️  Def: internal
```
