# Function: testUrgentRedemptionMintsNoInterestToSP()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testUrgentRedemptionMintsNoInterestToSP() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 13)
      💬 Args: [spBoldBal_t1, spBoldBal_t0]
      👁️  Def: internal
```
