# Function: testSetShutdownSetsShutdownFlagsAndTime()
...
```
┌─ [0] ⚙️ FUNCTION: ShutdownTest.testSetShutdownSetsShutdownFlagsAndTime() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [debt * avgInterestRate, UPFRONT_INTEREST_PERIOD]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 10)
  │   💬 Args: [contractsArray[0].borrowerOperations.hasBeenShutDown()]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertFalse(bool) (NodeID: 11)
  │   💬 Args: [contractsArray[0].activePool.hasBeenShutDown()]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 12)
  │   💬 Args: [troveManager.shutdownTime(), 0]
  │   👁️  Def: internal
  ...
  │   💬 Args: [contractsArray[0].borrowerOperations.hasBeenShutDown()]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 15)
  │   💬 Args: [contractsArray[0].activePool.hasBeenShutDown()]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 16)
      💬 Args: [troveManager.shutdownTime(), block.timestamp]
      👁️  Def: internal
```
