# Function: testRedemptionIncludesAccruedTroveInterest()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemptionIncludesAccruedTroveInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [trove_A.accruedInterest, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 41)
  │   💬 Args: [trove_A.redistBoldDebtGain, 0]
  │   👁️  Def: internal
