# Function: testRedemption3TroveLeavesCollFeesInTroves()
...
function testRedemption3TroveLeavesCollFeesInTroves() public {
    ...
    uint256 expectedRemainingColl_A = (troveManager.getTroveEntireColl(troveIDs.A) - correspondingColl.A) + predictedCollFee_A;
    uint256 expectedRemainingColl_B = (troveManager.getTroveEntireColl(troveIDs.B) - correspondingColl.B) + predictedCollFee_B;
    uint256 expectedRemainingColl_C = (troveManager.getTroveEntireColl(troveIDs.C) - correspondingColl.C) + predictedCollFee_C;
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemption3TroveLeavesCollFeesInTroves() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [predictedCollFee_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 41)
  │   💬 Args: [predictedCollFee_B, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 42)
  │   💬 Args: [predictedCollFee_C, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 43)
  │   💬 Args: [expectedRemainingColl_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 44)
  │   💬 Args: [expectedRemainingColl_B, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 45)
  │   💬 Args: [expectedRemainingColl_C, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 46)
  │   💬 Args: [E, totalBoldRedeemAmount]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 47)
  │   💬 Args: [troveManager.getTroveEntireColl(troveIDs.A), expectedRemainingColl_A, 20]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 48)
  │   💬 Args: [troveManager.getTroveEntireColl(troveIDs.B), expectedRemainingColl_B, 20]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 49)
      💬 Args: [troveManager.getTroveEntireColl(troveIDs.C), expectedRemainingColl_C, 20]
      👁️  Def: internal
```
