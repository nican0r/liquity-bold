# Function: testRedemption1TroveLeavesCollFeeInTrove()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemption1TroveLeavesCollFeeInTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
