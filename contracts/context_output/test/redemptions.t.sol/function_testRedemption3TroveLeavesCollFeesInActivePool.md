# Function: testRedemption3TroveLeavesCollFeesInActivePool()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemption3TroveLeavesCollFeesInActivePool() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [activePoolBalBefore, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 42)
  │   💬 Args: [activePoolCollTrackerBefore, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 43)
  │   💬 Args: [E, totalBoldRedeemAmount]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 44)
  │   💬 Args: [collToken.balanceOf(address(activePool)), activePoolBalBefore - expectedCollDelta, 30]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 45)
      💬 Args: [activePool.getCollBalance(), activePoolCollTrackerBefore - expectedCollDelta, 30]
      👁️  Def: internal
```
