# Function: testZombieTrovesCanReceiveRedistGains()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovesCanReceiveRedistGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveManager.getCurrentICR(troveIDs.E, price), MCR]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 51)
  │   💬 Args: [A, troveIDs.E]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 52)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.E)), uint8(ITroveManager.Status.closedByLiquidation)]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertTrue(bool) (NodeID: 55)
      💬 Args: [troveManager.hasRedistributionGains(troveIDs.C)]
      👁️  Def: internal
```
