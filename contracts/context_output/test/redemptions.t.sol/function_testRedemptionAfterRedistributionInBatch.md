# Function: testRedemptionAfterRedistributionInBatch()
...
function testRedemptionAfterRedistributionInBatch() public {
    ...
    assertApproxEqAbs(activePool.calcPendingAggInterest(), ((ARecordedDebt + BRecordedDebt) * MIN_ANNUAL_INTEREST_RATE) / DECIMAL_PRECISION, 1, "Pending debt mismatch");
}
```
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemptionAfterRedistributionInBatch() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.openTroveAndJoinBatchManager(address,uint256,uint256,address,uint256) (NodeID: 1)
  │   💬 Args: [B, 100 ether, 10e21, B, MIN_ANNUAL_INTEREST_RATE]
  │   👁️  Def: internal
  ...
  │   💬 Args: [A, 100 ether, 10e21, B, MIN_ANNUAL_INTEREST_RATE]
  │   👁️  Def: internal
  ...
  │   💬 Args: [C, 100 ether, 100e21, MIN_ANNUAL_INTEREST_RATE]
  │   👁️  Def: public
  ...
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 14)
  │   💬 Args: [B, CTroveId]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256,string) (NodeID: 15)
  │   💬 Args: [AEntireDebtBefore - (CEntireDebt / 2), redeemAmount, "Redeem amount too low"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256,string) (NodeID: 16)
  │   💬 Args: [redeemAmount, AEntireDebtBefore, "Redeem amount too high"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 17)
  │   💬 Args: [C, redeemAmount]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 18)
  │   💬 Args: [AEntireDebtAfter, AEntireDebtBefore - redeemAmount, "A debt mismatch"]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 19)
  │   💬 Args: [BEntireDebtAfter, BEntireDebtBefore, "B debt mismatch"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 20)
      💬 Args: [activePool.calcPendingAggInterest(), ((ARecordedDebt + BRecordedDebt) * MIN_ANNUAL_INTEREST_RATE) / DECIMAL_PRECISION, 1, "Pending debt mismatch"]
      👁️  Def: internal
```
