# Function: testRedemptionIsInOrderOfInterestRate()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testRedemptionIsInOrderOfInterestRate() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 40)
  │   💬 Args: [E, redeemAmount_1]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 41)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.A), 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 42)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), debt_B]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 43)
  │   💬 Args: [troveManager.getTroveEntireColl(troveIDs.B), coll]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 44)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.C), debt_C]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 45)
  │   💬 Args: [troveManager.getTroveEntireColl(troveIDs.C), coll]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 46)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.D), debt_D]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 47)
  │   💬 Args: [troveManager.getTroveEntireColl(troveIDs.D), coll]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 48)
  │   💬 Args: [E, redeemAmount_2]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 49)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), 0]
  │   👁️  Def: internal
