# Function: testZombieTroveCanBeLiquidated()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveCanBeLiquidated() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │       💬 Args: [_boldAmount, _annualInterestRate]
  │       👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 49)
  │   💬 Args: [E, boldToken.balanceOf(E)]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 50)
  │   💬 Args: [stabilityPool.getTotalBoldDeposits(), troveManager.getTroveEntireDebt(troveIDs.B)]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 51)
  │   💬 Args: [troveManager.getCurrentICR(troveIDs.B, price), MCR]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 54)
      💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.B)), uint8(ITroveManager.Status.closedByLiquidation)]
      👁️  Def: internal
```
