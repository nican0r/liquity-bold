...
### testCannotRedeemZero()

- **Signature**: `testCannotRedeemZero()`
- **Visibility**: public
- **Source Range**: 335:185:332
- **Details**: [function_testCannotRedeemZero.md](./function_testCannotRedeemZero.md)
...
### testRedemptionIsInOrderOfInterestRate()

- **Signature**: `testRedemptionIsInOrderOfInterestRate()`
- **Visibility**: public
- **Source Range**: 526:2291:332
- **Details**: [function_testRedemptionIsInOrderOfInterestRate.md](./function_testRedemptionIsInOrderOfInterestRate.md)
...
### testFullRedemptionDoesntCloseTroves()

- **Signature**: `testFullRedemptionDoesntCloseTroves()`
- **Visibility**: public
- **Source Range**: 2868:659:332
- **Details**: [function_testFullRedemptionDoesntCloseTroves.md](./function_testFullRedemptionDoesntCloseTroves.md)
...
### testFullRedemptionLeavesTrovesWithDebtEqualToZero()

- **Signature**: `testFullRedemptionLeavesTrovesWithDebtEqualToZero()`
- **Visibility**: public
- **Source Range**: 3533:615:332
- **Details**: [function_testFullRedemptionLeavesTrovesWithDebtEqualToZero.md](./function_testFullRedemptionLeavesTrovesWithDebtEqualToZero.md)
...
### testFullRedemptionSkipsTrovesAtZeroDebt()

- **Signature**: `testFullRedemptionSkipsTrovesAtZeroDebt()`
- **Visibility**: public
- **Source Range**: 4154:1400:332
- **Details**: [function_testFullRedemptionSkipsTrovesAtZeroDebt.md](./function_testFullRedemptionSkipsTrovesAtZeroDebt.md)
...
### testRedemptionIncludesAccruedTroveInterest()

- **Signature**: `testRedemptionIncludesAccruedTroveInterest()`
- **Visibility**: public
- **Source Range**: 5642:942:332
- **Details**: [function_testRedemptionIncludesAccruedTroveInterest.md](./function_testRedemptionIncludesAccruedTroveInterest.md)
...
### testRedemption1TroveLeavesCollFeeInTrove()

- **Signature**: `testRedemption1TroveLeavesCollFeeInTrove()`
- **Visibility**: public
- **Source Range**: 6590:1024:332
- **Details**: [function_testRedemption1TroveLeavesCollFeeInTrove.md](./function_testRedemption1TroveLeavesCollFeeInTrove.md)
...
### testRedemption1TroveLeavesCollFeeInActivePool()

- **Signature**: `testRedemption1TroveLeavesCollFeeInActivePool()`
- **Visibility**: public
- **Source Range**: 7620:1302:332
- **Details**: [function_testRedemption1TroveLeavesCollFeeInActivePool.md](./function_testRedemption1TroveLeavesCollFeeInActivePool.md)
...
### testRedemption3TroveLeavesCollFeesInTroves()

- **Signature**: `testRedemption3TroveLeavesCollFeesInTroves()`
- **Visibility**: public
- **Source Range**: 8928:2459:332
- **Details**: [function_testRedemption3TroveLeavesCollFeesInTroves.md](./function_testRedemption3TroveLeavesCollFeesInTroves.md)
...
### testRedemption3TroveLeavesCollFeesInActivePool()

- **Signature**: `testRedemption3TroveLeavesCollFeesInActivePool()`
- **Visibility**: public
- **Source Range**: 11393:1603:332
- **Details**: [function_testRedemption3TroveLeavesCollFeesInActivePool.md](./function_testRedemption3TroveLeavesCollFeesInActivePool.md)
...
### testFullyRedeemedTroveBecomesZombieTrove()

- **Signature**: `testFullyRedeemedTroveBecomesZombieTrove()`
- **Visibility**: public
- **Source Range**: 13032:400:332
- **Details**: [function_testFullyRedeemedTroveBecomesZombieTrove.md](./function_testFullyRedeemedTroveBecomesZombieTrove.md)
...
### testTroveRedeemedToBelowMIN_DEBTBecomesZombieTrove()

- **Signature**: `testTroveRedeemedToBelowMIN_DEBTBecomesZombieTrove()`
- **Visibility**: public
- **Source Range**: 13438:410:332
- **Details**: [function_testTroveRedeemedToBelowMIN_DEBTBecomesZombieTrove.md](./function_testTroveRedeemedToBelowMIN_DEBTBecomesZombieTrove.md)
...
### testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove()

- **Signature**: `testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove()`
- **Visibility**: public
- **Source Range**: 13854:410:332
- **Details**: [function_testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove.md](./function_testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove.md)
...
### testZombieTrovesRemovedFromSortedList()

- **Signature**: `testZombieTrovesRemovedFromSortedList()`
- **Visibility**: public
- **Source Range**: 14270:978:332
- **Details**: [function_testZombieTrovesRemovedFromSortedList.md](./function_testZombieTrovesRemovedFromSortedList.md)
...
### testZombieTroveCanStillBeRedeemedFrom()

- **Signature**: `testZombieTroveCanStillBeRedeemedFrom()`
- **Visibility**: public
- **Source Range**: 15254:821:332
- **Details**: [function_testZombieTroveCanStillBeRedeemedFrom.md](./function_testZombieTroveCanStillBeRedeemedFrom.md)
...
### testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves()

- **Signature**: `testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves()`
- **Visibility**: public
- **Source Range**: 16081:984:332
- **Details**: [function_testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves.md](./function_testRedemptionsWithNoPartialLeaveNoPointerToZombieTroves.md)
...
### testZombieTrovePointerGetsResetIfLastOneIsFullyRedemeed()

- **Signature**: `testZombieTrovePointerGetsResetIfLastOneIsFullyRedemeed()`
- **Visibility**: public
- **Source Range**: 17071:959:332
- **Details**: [function_testZombieTrovePointerGetsResetIfLastOneIsFullyRedemeed.md](./function_testZombieTrovePointerGetsResetIfLastOneIsFullyRedemeed.md)
...
### testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner()

- **Signature**: `testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner()`
- **Visibility**: public
- **Source Range**: 18036:750:332
- **Details**: [function_testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner.md](./function_testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner.md)
...
### testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest()

- **Signature**: `testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest()`
- **Visibility**: public
- **Source Range**: 18792:912:332
- **Details**: [function_testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest.md](./function_testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest.md)
...
### testZombieTrovePointerGetsResetIfTroveIsClosed()

- **Signature**: `testZombieTrovePointerGetsResetIfTroveIsClosed()`
- **Visibility**: public
- **Source Range**: 19710:957:332
- **Details**: [function_testZombieTrovePointerGetsResetIfTroveIsClosed.md](./function_testZombieTrovePointerGetsResetIfTroveIsClosed.md)
...
- **Signature**: `testZombieTrovePointerGetsResetIfTroveIsClosedFromABatch()`
- **Visibility**: public
- **Source Range**: 20673:974:332
- **Details**: [function_testZombieTrovePointerGetsResetIfTroveIsClosedFromABatch.md](./function_testZombieTrovePointerGetsResetIfTroveIsClosedFromABatch.md)
...
- **Signature**: `testZombieTrovePointerGetsResetIfTroveIsLiquidated()`
- **Visibility**: public
- **Source Range**: 21653:838:332
- **Details**: [function_testZombieTrovePointerGetsResetIfTroveIsLiquidated.md](./function_testZombieTrovePointerGetsResetIfTroveIsLiquidated.md)
...
### testZombieTrovePointerIsPreservedIfItIsSkippedAndNoNewZombieIsProduced()

- **Signature**: `testZombieTrovePointerIsPreservedIfItIsSkippedAndNoNewZombieIsProduced()`
- **Visibility**: external
- **Source Range**: 22497:1124:332
- **Details**: [function_testZombieTrovePointerIsPreservedIfItIsSkippedAndNoNewZombieIsProduced.md](./function_testZombieTrovePointerIsPreservedIfItIsSkippedAndNoNewZombieIsProduced.md)
...
### testZombieTrovesCanReceiveRedistGains()

- **Signature**: `testZombieTrovesCanReceiveRedistGains()`
- **Visibility**: public
- **Source Range**: 23627:1200:332
- **Details**: [function_testZombieTrovesCanReceiveRedistGains.md](./function_testZombieTrovesCanReceiveRedistGains.md)
...
### testZombieTrovesAccrueInterest()

- **Signature**: `testZombieTrovesAccrueInterest()`
- **Visibility**: public
- **Source Range**: 24833:1231:332
- **Details**: [function_testZombieTrovesAccrueInterest.md](./function_testZombieTrovesAccrueInterest.md)
...
### testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT()

- **Signature**: `testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT()`
- **Visibility**: public
- **Source Range**: 26070:856:332
- **Details**: [function_testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT.md](./function_testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT.md)
...
### testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT()

- **Signature**: `testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT()`
- **Visibility**: public
- **Source Range**: 26932:1502:332
- **Details**: [function_testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT.md](./function_testZombieTrovesCanReceiveRedistGainsThatBringThemAboveMIN_DEBT.md)
...
### testZombieBorrowerCanCloseZombieTrove()

- **Signature**: `testZombieBorrowerCanCloseZombieTrove()`
- **Visibility**: public
- **Source Range**: 28486:857:332
- **Details**: [function_testZombieBorrowerCanCloseZombieTrove.md](./function_testZombieBorrowerCanCloseZombieTrove.md)
...
### testZombieBorrowerCanDrawFreshDebtToAboveMIN_DEBT()

- **Signature**: `testZombieBorrowerCanDrawFreshDebtToAboveMIN_DEBT()`
- **Visibility**: public
- **Source Range**: 29349:1013:332
- **Details**: [function_testZombieBorrowerCanDrawFreshDebtToAboveMIN_DEBT.md](./function_testZombieBorrowerCanDrawFreshDebtToAboveMIN_DEBT.md)
...
### testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive()

- **Signature**: `testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive()`
- **Visibility**: public
- **Source Range**: 30368:1284:332
- **Details**: [function_testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive.md](./function_testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive.md)
...
### testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList()

- **Signature**: `testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList()`
- **Visibility**: public
- **Source Range**: 31658:1353:332
- **Details**: [function_testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList.md](./function_testZombieTroveDrawingFreshDebtToAboveMIN_DEBTInsertsItToSortedList.md)
...
### testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0()

- **Signature**: `testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0()`
- **Visibility**: public
- **Source Range**: 33017:1493:332
- **Details**: [function_testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0.md](./function_testZombieBorrowerDrawsFreshDebtToAboveMIN_DEBTReducesPendingInterestTo0.md)
...
### testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT()

- **Signature**: `testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT()`
- **Visibility**: public
- **Source Range**: 34516:876:332
- **Details**: [function_testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT.md](./function_testZombieTroveBorrowerCanNotDrawFreshDebtToBelowMIN_DEBT.md)
...
### testZombieTroveBorrowerCanNotRepayDebt()

- **Signature**: `testZombieTroveBorrowerCanNotRepayDebt()`
- **Visibility**: public
- **Source Range**: 35398:751:332
- **Details**: [function_testZombieTroveBorrowerCanNotRepayDebt.md](./function_testZombieTroveBorrowerCanNotRepayDebt.md)
...
### testZombieTroveBorrowerCanNotUseNormalWithdrawBoldFunction()

- **Signature**: `testZombieTroveBorrowerCanNotUseNormalWithdrawBoldFunction()`
- **Visibility**: public
- **Source Range**: 36155:637:332
- **Details**: [function_testZombieTroveBorrowerCanNotUseNormalWithdrawBoldFunction.md](./function_testZombieTroveBorrowerCanNotUseNormalWithdrawBoldFunction.md)
...
### testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction()

- **Signature**: `testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction()`
- **Visibility**: public
- **Source Range**: 36798:550:332
- **Details**: [function_testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction.md](./function_testZombieTroveBorrowerCanNotUseNormalAdjustTroveFunction.md)
...
### testZombieTroveBorrowerCanNotAddColl()

- **Signature**: `testZombieTroveBorrowerCanNotAddColl()`
- **Visibility**: public
- **Source Range**: 37354:708:332
- **Details**: [function_testZombieTroveBorrowerCanNotAddColl.md](./function_testZombieTroveBorrowerCanNotAddColl.md)
...
### testZombieTroveBorrowerCanNotChangeInterestRate()

- **Signature**: `testZombieTroveBorrowerCanNotChangeInterestRate()`
- **Visibility**: public
- **Source Range**: 38068:754:332
- **Details**: [function_testZombieTroveBorrowerCanNotChangeInterestRate.md](./function_testZombieTroveBorrowerCanNotChangeInterestRate.md)
...
### testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie()

- **Signature**: `testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie()`
- **Visibility**: public
- **Source Range**: 38828:1583:332
- **Details**: [function_testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie.md](./function_testZombieTroveAccruedInterestCanBePermissionlesslyAppliedButStaysZombie.md)
...
### testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated()

- **Signature**: `testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated()`
- **Visibility**: public
- **Source Range**: 40417:1476:332
- **Details**: [function_testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated.md](./function_testZombieTroveAccruedInterestCanBePermissionlesslyAppliedAndResuscitated.md)
...
### testZombieTroveCanBeLiquidated()

- **Signature**: `testZombieTroveCanBeLiquidated()`
- **Visibility**: public
- **Source Range**: 41899:1154:332
- **Details**: [function_testZombieTroveCanBeLiquidated.md](./function_testZombieTroveCanBeLiquidated.md)
...
### testZombieTroveCanActAsLastTrove()

- **Signature**: `testZombieTroveCanActAsLastTrove()`
- **Visibility**: public
- **Source Range**: 43059:1762:332
- **Details**: [function_testZombieTroveCanActAsLastTrove.md](./function_testZombieTroveCanActAsLastTrove.md)
...
### testRedemptionAfterRedistributionInBatch()

- **Signature**: `testRedemptionAfterRedistributionInBatch()`
- **Visibility**: public
- **Source Range**: 44870:2685:332
- **Details**: [function_testRedemptionAfterRedistributionInBatch.md](./function_testRedemptionAfterRedistributionInBatch.md)
...
### testBaseRateDecayCannotBeSlowedDown()

- **Signature**: `testBaseRateDecayCannotBeSlowedDown()`
- **Visibility**: external
- **Source Range**: 47561:934:332
- **Details**: [function_testBaseRateDecayCannotBeSlowedDown.md](./function_testBaseRateDecayCannotBeSlowedDown.md)
