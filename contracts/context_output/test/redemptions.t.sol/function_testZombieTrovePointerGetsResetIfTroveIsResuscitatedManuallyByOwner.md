# Function: testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovePointerGetsResetIfTroveIsResuscitatedManuallyByOwner() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 50)
