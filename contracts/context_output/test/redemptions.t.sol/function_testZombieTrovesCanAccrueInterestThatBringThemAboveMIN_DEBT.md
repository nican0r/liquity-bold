# Function: testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovesCanAccrueInterestThatBringThemAboveMIN_DEBT() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.A)), uint8(ITroveManager.Status.zombie)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 45)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLt(uint256,uint256) (NodeID: 46)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 47)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.A), 0, "A debt should be 0"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 48)
      💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT, "B debt should be more than min"]
      👁️  Def: internal
```
