# Function: testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove()
...
### _redeemAndCreateZombieTroveAAndHitB(struct BaseTest.ABCDEF)

- **Kind**: internal
- **Source**: 13637:948:261
- **Link**: `test/TestContracts/DevTestSetup.sol:DevTestSetup:_redeemAndCreateZombieTroveAAndHitB(struct BaseTest.ABCDEF)`
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testTroveRedeemedToAboveMIN_DEBTDoesNotBecomesZombieTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: DevTestSetup._redeemAndCreateZombieTroveAAndHitB(struct BaseTest.ABCDEF) (NodeID: 40)
  │   💬 Args: [troveIDs]
  │   👁️  Def: internal
  ...
  │ │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 43)
  ...
  │     💬 Args: [uint8(troveManager.getTroveStatus(_troveIDs.B)), uint8(ITroveManager.Status.active)]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 46)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.C)), uint8(ITroveManager.Status.active)]
  │   👁️  Def: internal
