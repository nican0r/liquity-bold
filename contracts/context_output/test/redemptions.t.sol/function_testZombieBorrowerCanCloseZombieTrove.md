# Function: testZombieBorrowerCanCloseZombieTrove()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieBorrowerCanCloseZombieTrove() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [E, A, boldToken.balanceOf(E) / 2]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.transferBold(address,address,uint256) (NodeID: 47)
  │   💬 Args: [E, B, boldToken.balanceOf(E)]
  │   👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 50)
  │   💬 Args: [A, troveIDs.A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.closeTrove(address,uint256) (NodeID: 51)
  │   💬 Args: [B, troveIDs.B]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 52)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.A)), uint8(ITroveManager.Status.closedByOwner)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 53)
      💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.B)), uint8(ITroveManager.Status.closedByOwner)]
      👁️  Def: internal
```
