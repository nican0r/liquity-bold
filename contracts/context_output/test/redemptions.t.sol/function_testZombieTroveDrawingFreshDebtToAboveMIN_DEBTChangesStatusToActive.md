# Function: testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTroveDrawingFreshDebtToAboveMIN_DEBTChangesStatusToActive() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [debtDelta_B, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.adjustZombieTrove(address,uint256,uint256,bool,uint256,bool) (NodeID: 48)
  │   💬 Args: [A, troveIDs.A, 0, false, debtDelta_A + surplusDebt, true]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 49)
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 53)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 54)
  │   💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.A)), uint8(ITroveManager.Status.active)]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 55)
      💬 Args: [uint8(troveManager.getTroveStatus(troveIDs.B)), uint8(ITroveManager.Status.active)]
      👁️  Def: internal
```
