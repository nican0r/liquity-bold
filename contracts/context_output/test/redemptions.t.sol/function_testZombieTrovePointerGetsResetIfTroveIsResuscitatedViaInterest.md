# Function: testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest()
...
```
┌─ [0] ⚙️ FUNCTION: Redemptions.testZombieTrovePointerGetsResetIfTroveIsResuscitatedViaInterest() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.adjustZombieTrove(address,uint256,uint256,bool,uint256,bool) (NodeID: 47)
  │   💬 Args: [B, troveIDs.B, 0, false, MIN_DEBT, true]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustTroveUpfrontFee(uint256,uint256) (NodeID: 48)
  │     💬 Args: [_troveId, _isDebtIncrease ? _boldChange : 0]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 49)
  │   💬 Args: [E, troveIDs.B]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256,string) (NodeID: 50)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIDs.B), MIN_DEBT, "B debt should be above min"]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 51)
