# Function: testChangeBatchInterestRateIncreasesDebtInActivePoolByFee()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testChangeBatchInterestRateIncreasesDebtInActivePoolByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 12)
      💬 Args: [activePool.aggRecordedDebt(), (activePoolInitialDebt + batchAccruedInterest) + batchAccruedManagementFee, 1]
      👁️  Def: internal
```
