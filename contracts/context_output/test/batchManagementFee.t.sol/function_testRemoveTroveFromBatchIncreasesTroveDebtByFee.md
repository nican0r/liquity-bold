# Function: testRemoveTroveFromBatchIncreasesTroveDebtByFee()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testRemoveTroveFromBatchIncreasesTroveDebtByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 12)
      💬 Args: [troveManager.getTroveDebt(troveId), (troveInitialDebt + troveAccruedInterest) + troveAccruedManagementFee]
      👁️  Def: internal
```
