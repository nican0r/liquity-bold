# Function: testPrematureChangeBatchInterestRateUpdatesAggBatchWeightedMgmtFeeCorrectly()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testPrematureChangeBatchInterestRateUpdatesAggBatchWeightedMgmtFeeCorrectly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
