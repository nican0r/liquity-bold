# Function: testSwitchTroveBatchMintsFeeForBatches()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testSwitchTroveBatchMintsFeeForBatches() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │         💬 Args: [20e16, _annualInterestRate]
  │         👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,address) (NodeID: 11)
  │   💬 Args: [C, troveId, B]
  │   👁️  Def: internal
  │ └─ [2] ⚙️ FUNCTION: BaseTest.switchBatchManager(address,uint256,uint256,uint256,address,uint256,uint256,uint256) (NodeID: 12)
  ...
  │   💬 Args: [boldToken.balanceOf(B), batchBInitialBalance + batchBAccruedManagementFee]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 14)
      💬 Args: [boldToken.balanceOf(D), batchDInitialBalance + batchDAccruedManagementFee]
      👁️  Def: internal
```
