# Function: testChangeBatchInterestRateIncreasesTroveDebtByFee()
...
function testChangeBatchInterestRateIncreasesTroveDebtByFee() public {
    ...
    assertApproxEqAbs(troveManager.getTroveDebt(troveId), (troveInitialDebt + troveAccruedInterest) + troveAccruedManagementFee, 1);
}
```
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testChangeBatchInterestRateIncreasesTroveDebtByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256) (NodeID: 12)
      💬 Args: [troveManager.getTroveDebt(troveId), (troveInitialDebt + troveAccruedInterest) + troveAccruedManagementFee, 1]
      👁️  Def: internal
```
