# Function: testRemoveTroveFromBatchIncreasesDebtInActivePoolByFee()
...
```
┌─ [0] ⚙️ FUNCTION: BatchManagementFeeTest.testRemoveTroveFromBatchIncreasesDebtInActivePoolByFee() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
