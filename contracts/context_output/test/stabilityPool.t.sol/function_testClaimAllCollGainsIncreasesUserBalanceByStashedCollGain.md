# Function: testClaimAllCollGainsIncreasesUserBalanceByStashedCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testClaimAllCollGainsIncreasesUserBalanceByStashedCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [collBal_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.claimAllCollGains(address) (NodeID: 28)
  │   💬 Args: [A]
  │   👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 30)
      💬 Args: [collToken.balanceOf(A), collBal_A + stashedCollGain_A]
      👁️  Def: internal
```
