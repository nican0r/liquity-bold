# Function: testBoldRewardSumIncreasesWhenInterestAppliedPermissionlessly()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenInterestAppliedPermissionlessly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 26)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
