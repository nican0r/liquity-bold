# Function: testWithdrawFromSPNoClaim_WithOnlyStashedCollGainDoesntChangeStashedCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPNoClaim_WithOnlyStashedCollGainDoesntChangeStashedCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalNoClaim(address,uint256) (NodeID: 27)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 28)
      💬 Args: [stabilityPool.stashedColl(A), stashedCollGain]
      👁️  Def: internal
```
