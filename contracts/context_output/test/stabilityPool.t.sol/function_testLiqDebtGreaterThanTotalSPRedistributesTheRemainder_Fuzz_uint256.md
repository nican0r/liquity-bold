# Function: testLiqDebtGreaterThanTotalSPRedistributesTheRemainder_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiqDebtGreaterThanTotalSPRedistributesTheRemainder_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [A, troveIdB]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 18)
      💬 Args: [troveManager.getTroveEntireDebt(troveIdA), debtABefore + _toRedist, 1e3]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 19)
        💬 Args: [_x, _y, _margin, ""]
        👁️  Def: internal
```
