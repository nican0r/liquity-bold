# Function: testProvideToSPWithClaim_WithCurrentBOLDGainsZerosCurrentBOLDGains()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithCurrentBOLDGainsZerosCurrentBOLDGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
