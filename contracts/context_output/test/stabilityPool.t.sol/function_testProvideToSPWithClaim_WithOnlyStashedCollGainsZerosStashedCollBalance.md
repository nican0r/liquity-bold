# Function: testProvideToSPWithClaim_WithOnlyStashedCollGainsZerosStashedCollBalance()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithOnlyStashedCollGainsZerosStashedCollBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 27)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
