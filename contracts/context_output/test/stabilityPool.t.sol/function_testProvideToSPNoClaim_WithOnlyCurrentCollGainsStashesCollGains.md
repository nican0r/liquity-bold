# Function: testProvideToSPNoClaim_WithOnlyCurrentCollGainsStashesCollGains()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaim_WithOnlyCurrentCollGainsStashesCollGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
