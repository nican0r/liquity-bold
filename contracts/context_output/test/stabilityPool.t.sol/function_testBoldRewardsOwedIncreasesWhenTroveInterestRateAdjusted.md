# Function: testBoldRewardsOwedIncreasesWhenTroveInterestRateAdjusted()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenTroveInterestRateAdjusted() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.changeInterestRateNoHints(address,uint256,uint256) (NodeID: 27)
  │   💬 Args: [B, troveIDs.B, 75e16]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: BaseTest.predictAdjustInterestRateUpfrontFee(uint256,uint256) (NodeID: 28)
