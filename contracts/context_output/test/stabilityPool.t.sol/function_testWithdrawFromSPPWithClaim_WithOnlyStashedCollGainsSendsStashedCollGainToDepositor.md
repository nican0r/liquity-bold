# Function: testWithdrawFromSPPWithClaim_WithOnlyStashedCollGainsSendsStashedCollGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPPWithClaim_WithOnlyStashedCollGainsSendsStashedCollGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositNoClaim(address,uint256) (NodeID: 24)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
  ...
  │   💬 Args: [collBal_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 28)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 29)
      💬 Args: [collToken.balanceOf(A), collBal_A + stashedCollGain]
      👁️  Def: internal
```
