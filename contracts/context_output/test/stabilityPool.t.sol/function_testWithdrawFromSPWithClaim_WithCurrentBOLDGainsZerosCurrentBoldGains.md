# Function: testWithdrawFromSPWithClaim_WithCurrentBOLDGainsZerosCurrentBoldGains()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPWithClaim_WithCurrentBOLDGainsZerosCurrentBoldGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
