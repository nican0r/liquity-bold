# Function: testClaimAllCollGainsDoesNotChangeCompoundedDeposit()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testClaimAllCollGainsDoesNotChangeCompoundedDeposit() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalNoClaim(address,uint256) (NodeID: 32)
  │   💬 Args: [A, deposit_A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 33)
  │   💬 Args: [compoundedDeposit_A, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.claimAllCollGains(address) (NodeID: 34)
  │   💬 Args: [A]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 35)
      💬 Args: [compoundedDeposit_A, stabilityPool.getCompoundedBoldDeposit(A)]
      👁️  Def: internal
```
