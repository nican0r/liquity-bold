# Function: testBoldRewardsOwedIncreasesWhenDepositWithdrawn()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenDepositWithdrawn() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 29)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
