# Function: testWithdrawFromSPWithClaim_WithCurrentBOLDGainsSendsBOLDGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPWithClaim_WithCurrentBOLDGainsSendsBOLDGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 26)
  │   💬 Args: [A, withdrawal]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 27)
      💬 Args: [boldToken.balanceOf(A), (boldBal_A + withdrawal) + currentBoldGain]
      👁️  Def: internal
```
