# Function: testWithdrawFromSPNoClaimAddsBOLDGainsToDeposit()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPNoClaimAddsBOLDGainsToDeposit() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalNoClaim(address,uint256) (NodeID: 26)
  │   💬 Args: [A, withdrawal]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 27)
      💬 Args: [stabilityPool.getCompoundedBoldDeposit(A), (depositBefore_A - withdrawal) + currentBoldGain, 1e4]
      👁️  Def: public
