# Function: testWithdrawFromSPWithClaim_WithOnlyCurrentCollGainsSendsTotalCollGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPWithClaim_WithOnlyCurrentCollGainsSendsTotalCollGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 28)
      💬 Args: [collToken.balanceOf(A), collBal_A + currentCollGain]
      👁️  Def: internal
```
