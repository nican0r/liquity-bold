# Function: testGetDepositorBoldGain_1SPDepositor2RewardEvent_EarnsAllSPYield()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testGetDepositorBoldGain_1SPDepositor2RewardEvent_EarnsAllSPYield() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPWithdrawalAndClaim(address,uint256) (NodeID: 25)
  │   💬 Args: [B, stabilityPool.getCompoundedBoldDeposit(B)]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 26)
  │   💬 Args: [stabilityPool.getCompoundedBoldDeposit(A), stabilityPool.getTotalBoldDeposits(), 1e4]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 27)
  │     💬 Args: [_x, _y, _margin, ""]
  │     👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 30)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 31)
  │   💬 Args: [yieldGainsOwed_1, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 32)
  │   💬 Args: [pendingAggInterest_2, 0]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 33)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertGt(uint256,uint256) (NodeID: 34)
  │   💬 Args: [yieldGainsOwed_2, 0]
  │   👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 35)
      💬 Args: [stabilityPool.getDepositorYieldGain(A), expectedSpYield_1 + expectedSpYield_2, 1e4]
      👁️  Def: public
    └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 36)
        💬 Args: [_x, _y, _margin, ""]
        👁️  Def: internal
```
