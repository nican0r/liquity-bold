# Function: testProvideToSPWithClaim_WithOnlyCurrentBOLDGainsSendsTotalBOLDGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithOnlyCurrentBOLDGainsSendsTotalBOLDGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 26)
  │   💬 Args: [A, topUp]
  │   👁️  Def: public
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 27)
      💬 Args: [boldToken.balanceOf(A), (boldBal_A + currentBoldGain) - topUp]
      👁️  Def: internal
```
