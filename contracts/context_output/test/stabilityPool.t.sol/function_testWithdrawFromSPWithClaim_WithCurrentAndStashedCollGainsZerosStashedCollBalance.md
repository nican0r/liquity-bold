# Function: testWithdrawFromSPWithClaim_WithCurrentAndStashedCollGainsZerosStashedCollBalance()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testWithdrawFromSPWithClaim_WithCurrentAndStashedCollGainsZerosStashedCollBalance() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
