# Function: testSingleDepositorCantWithdrawWhenLeavingLessThan1BoldInPool_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testSingleDepositorCantWithdrawWhenLeavingLessThan1BoldInPool_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
