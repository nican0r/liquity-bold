# Function: testBoldRewardsOwedIncreasesWhenNewDepositIsMade()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenNewDepositIsMade() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositAndClaim(address,uint256) (NodeID: 30)
  │   💬 Args: [E, 1e18]
  │   👁️  Def: public
