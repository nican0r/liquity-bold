# Function: testLiqDebtGreaterThanTotalSSplitsCollGainsCorrectly_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiqDebtGreaterThanTotalSSplitsCollGainsCorrectly_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdUtils.bound(uint256,uint256,uint256) (NodeID: 1)
  │   💬 Args: [_toRedist, 1e18 + 1, 1000e18]
  │   👁️  Def: internal
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIdB), spBefore]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.liquidate(address,uint256) (NodeID: 18)
  │   💬 Args: [C, troveIdB]
  │   👁️  Def: public
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 19)
  │   💬 Args: [stabilityPool.getTotalBoldDeposits(), spBefore - liqDebtOffset]
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.assertApproximatelyEqual(uint256,uint256,uint256) (NodeID: 20)
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIdA), vars.debtABefore + _toRedist, 1e3]
  │   👁️  Def: public
  │ └─ [2] ⚙️ FUNCTION: StdAssertions.assertApproxEqAbs(uint256,uint256,uint256,string) (NodeID: 21)
  │     💬 Args: [_x, _y, _margin, ""]
  │     👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 22)
  │   💬 Args: [collToken.balanceOf(C), (vars.collCBefore + vars.collGasComp) + 375e14]
  │   👁️  Def: internal
