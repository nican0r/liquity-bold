# Function: testProvideToSPWithClaim_WithOnlyCurrentCollGainsSendsTotalCollGainToDepositor()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPWithClaim_WithOnlyCurrentCollGainsSendsTotalCollGainToDepositor() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
