# Function: testClaimAllCollGainsRevertsWhenUserHasNoCollGains()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testClaimAllCollGainsRevertsWhenUserHasNoCollGains() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
