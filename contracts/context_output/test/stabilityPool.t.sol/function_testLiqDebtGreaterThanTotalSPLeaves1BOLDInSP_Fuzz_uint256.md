# Function: testLiqDebtGreaterThanTotalSPLeaves1BOLDInSP_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiqDebtGreaterThanTotalSPLeaves1BOLDInSP_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   💬 Args: [troveManager.getTroveEntireDebt(troveIdB), stabilityPool.getTotalBoldDeposits()]
  │   👁️  Def: internal
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertLe(uint256,uint256) (NodeID: 19)
