# Function: testProvideToSPNoClaim_WithOnlyStashedCollGainDoesntChangeStashedCollGain()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testProvideToSPNoClaim_WithOnlyStashedCollGainDoesntChangeStashedCollGain() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.makeSPDepositNoClaim(address,uint256) (NodeID: 27)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
