# Function: testBoldRewardsOwedIncreasesWhenInterestAppliedPermissionlessly()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardsOwedIncreasesWhenInterestAppliedPermissionlessly() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.applyPendingDebt(address,uint256) (NodeID: 27)
  │   💬 Args: [B, troveIDs.A]
  │   👁️  Def: public
