# Function: testLiqDebtLessThanSPMinus1BOLDDoesNotRedistribute_Fuzz(uint256)
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testLiqDebtLessThanSPMinus1BOLDDoesNotRedistribute_Fuzz(uint256) (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256) (NodeID: 19)
      💬 Args: [troveManager.getTroveEntireDebt(troveIdA), debtABefore]
      👁️  Def: internal
```
