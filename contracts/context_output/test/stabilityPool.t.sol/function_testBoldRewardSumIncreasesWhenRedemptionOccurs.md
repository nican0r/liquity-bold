# Function: testBoldRewardSumIncreasesWhenRedemptionOccurs()
...
```
┌─ [0] ⚙️ FUNCTION: SPTest.testBoldRewardSumIncreasesWhenRedemptionOccurs() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: public
  ...
  │   👁️  Def: internal
  ├─ [1] ⚙️ FUNCTION: BaseTest.redeem(address,uint256) (NodeID: 26)
  │   💬 Args: [A, 1e18]
  │   👁️  Def: public
