...
- **Name**: AnchoredSPInvariantsTest
- **Type**: Contract
- **Path**: test/AnchoredSPInvariantsTest.t.sol
...
```solidity
SPInvariantsTestHandler internal handler
```

**SPInvariantsTestHandler**: [test/TestContracts/SPInvariantsTestHandler.t.sol/contract_SPInvariantsTestHandler.md]
...
### testUnclaimableDeposit()

- **Signature**: `testUnclaimableDeposit()`
- **Visibility**: external
- **Source Range**: 4542:2303:228
- **Details**: [function_testUnclaimableDeposit.md](./function_testUnclaimableDeposit.md)
...
### testUnclaimableDeposit2()

- **Signature**: `testUnclaimableDeposit2()`
- **Visibility**: external
- **Source Range**: 6851:6978:228
- **Details**: [function_testUnclaimableDeposit2.md](./function_testUnclaimableDeposit2.md)
...
- **Details**: [function_testUnderflow.md](./function_testUnderflow.md)
...
### testNotEnoughYieldToClaim()

- **Signature**: `testNotEnoughYieldToClaim()`
- **Visibility**: external
- **Source Range**: 18975:940:228
- **Details**: [function_testNotEnoughYieldToClaim.md](./function_testNotEnoughYieldToClaim.md)
...
### testNotEnoughYieldToClaim2()

- **Signature**: `testNotEnoughYieldToClaim2()`
- **Visibility**: external
- **Source Range**: 19921:7032:228
- **Details**: [function_testNotEnoughYieldToClaim2.md](./function_testNotEnoughYieldToClaim2.md)
...
### testNotEnoughYieldToClaim3()

- **Signature**: `testNotEnoughYieldToClaim3()`
- **Visibility**: external
- **Source Range**: 26959:6049:228
- **Details**: [function_testNotEnoughYieldToClaim3.md](./function_testNotEnoughYieldToClaim3.md)
...
### testNotEnoughYieldToClaim4()

- **Signature**: `testNotEnoughYieldToClaim4()`
- **Visibility**: external
- **Source Range**: 33014:3163:228
- **Details**: [function_testNotEnoughYieldToClaim4.md](./function_testNotEnoughYieldToClaim4.md)
...
### testCollGainsUnderflow3CollSkin()

- **Signature**: `testCollGainsUnderflow3CollSkin()`
- **Visibility**: external
- **Source Range**: 36183:5814:228
- **Details**: [function_testCollGainsUnderflow3CollSkin.md](./function_testCollGainsUnderflow3CollSkin.md)
...
### testSPYieldBigDispropRedeem()

- **Signature**: `testSPYieldBigDispropRedeem()`
- **Visibility**: external
- **Source Range**: 42003:2326:228
- **Details**: [function_testSPYieldBigDispropRedeem.md](./function_testSPYieldBigDispropRedeem.md)
