...
```
┌─ [0] ⚙️ FUNCTION: ZapperWETHTest.testCanAddColl() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 1)
  │   💬 Args: [troveManager.getTroveEntireColl(troveId), ethAmount1 + ethAmount2, "Coll mismatch"]
  │   👁️  Def: internal
  ...
  └─ [1] ⚙️ FUNCTION: StdAssertions.assertEq(uint256,uint256,string) (NodeID: 4)
      💬 Args: [A.balance, ethBalanceBefore - ethAmount2, "ETH bal mismatch"]
      👁️  Def: internal
```
