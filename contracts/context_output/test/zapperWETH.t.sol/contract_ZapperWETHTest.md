...
- **Details**: [function_testCanOpenTrove.md](./function_testCanOpenTrove.md)
...
### testCanOpenTroveWithBatchManager()

- **Signature**: `testCanOpenTroveWithBatchManager()`
- **Visibility**: external
- **Source Range**: 3216:1574:339
- **Details**: [function_testCanOpenTroveWithBatchManager.md](./function_testCanOpenTroveWithBatchManager.md)
...
- **Details**: [function_testCanNotOpenTroveWithBatchManagerAndInterest.md](./function_testCanNotOpenTroveWithBatchManagerAndInterest.md)
...
- **Signature**: `testCanAddColl()`
- **Visibility**: external
- **Source Range**: 5676:1311:339
- **Details**: [function_testCanAddColl.md](./function_testCanAddColl.md)
...
- **Visibility**: external
- **Source Range**: 6993:1312:339
- **Details**: [function_testCanWithdrawColl.md](./function_testCanWithdrawColl.md)
...
### testCannotWithdrawCollIfZapperIsNotReceiver()

- **Signature**: `testCannotWithdrawCollIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 8311:1136:339
- **Details**: [function_testCannotWithdrawCollIfZapperIsNotReceiver.md](./function_testCannotWithdrawCollIfZapperIsNotReceiver.md)
...
### testCanNotAddReceiverWithoutRemoveManager()

- **Signature**: `testCanNotAddReceiverWithoutRemoveManager()`
- **Visibility**: external
- **Source Range**: 9453:1071:339
- **Details**: [function_testCanNotAddReceiverWithoutRemoveManager.md](./function_testCanNotAddReceiverWithoutRemoveManager.md)
...
- **Details**: [function_testCanRepayBold.md](./function_testCanRepayBold.md)
...
- **Visibility**: external
- **Source Range**: 12558:1917:339
- **Details**: [function_testCanWithdrawBold.md](./function_testCanWithdrawBold.md)
...
### testCannotWithdrawBoldIfZapperIsNotReceiver()

- **Signature**: `testCannotWithdrawBoldIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 14481:1350:339
- **Details**: [function_testCannotWithdrawBoldIfZapperIsNotReceiver.md](./function_testCannotWithdrawBoldIfZapperIsNotReceiver.md)
...
### testCanAdjustTroveWithdrawCollAndBold()

- **Signature**: `testCanAdjustTroveWithdrawCollAndBold()`
- **Visibility**: external
- **Source Range**: 15879:2054:339
- **Details**: [function_testCanAdjustTroveWithdrawCollAndBold.md](./function_testCanAdjustTroveWithdrawCollAndBold.md)
...
### testCannotAdjustTroveWithdrawCollAndBoldIfZapperIsNotReceiver()

- **Signature**: `testCannotAdjustTroveWithdrawCollAndBoldIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 17939:1460:339
- **Details**: [function_testCannotAdjustTroveWithdrawCollAndBoldIfZapperIsNotReceiver.md](./function_testCannotAdjustTroveWithdrawCollAndBoldIfZapperIsNotReceiver.md)
...
### testCanAdjustTroveAddCollAndBold()

- **Signature**: `testCanAdjustTroveAddCollAndBold()`
- **Visibility**: external
- **Source Range**: 19405:2177:339
- **Details**: [function_testCanAdjustTroveAddCollAndBold.md](./function_testCanAdjustTroveAddCollAndBold.md)
...
### testCanAdjustZombieTroveWithdrawCollAndBold()

- **Signature**: `testCanAdjustZombieTroveWithdrawCollAndBold()`
- **Visibility**: external
- **Source Range**: 21588:2215:339
- **Details**: [function_testCanAdjustZombieTroveWithdrawCollAndBold.md](./function_testCanAdjustZombieTroveWithdrawCollAndBold.md)
...
### testCannotAdjustZombieTroveWithdrawCollAndBoldIfZapperIsNotReceiver()

- **Signature**: `testCannotAdjustZombieTroveWithdrawCollAndBoldIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 23809:1650:339
- **Details**: [function_testCannotAdjustZombieTroveWithdrawCollAndBoldIfZapperIsNotReceiver.md](./function_testCannotAdjustZombieTroveWithdrawCollAndBoldIfZapperIsNotReceiver.md)
...
### testCanAdjustZombieTroveAddCollAndWithdrawBold()

- **Signature**: `testCanAdjustZombieTroveAddCollAndWithdrawBold()`
- **Visibility**: external
- **Source Range**: 25465:2175:339
- **Details**: [function_testCanAdjustZombieTroveAddCollAndWithdrawBold.md](./function_testCanAdjustZombieTroveAddCollAndWithdrawBold.md)
...
### testCannotAdjustZombieTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver()

- **Signature**: `testCannotAdjustZombieTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 27646:1610:339
- **Details**: [function_testCannotAdjustZombieTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver.md](./function_testCannotAdjustZombieTroveAddCollAndWithdrawBoldIfZapperIsNotReceiver.md)
...
- **Signature**: `testCanCloseTrove()`
- **Visibility**: external
- **Source Range**: 29262:2065:339
- **Details**: [function_testCanCloseTrove.md](./function_testCanCloseTrove.md)
...
### testCannotCloseTroveIfZapperIsNotReceiver()

- **Signature**: `testCannotCloseTroveIfZapperIsNotReceiver()`
- **Visibility**: external
- **Source Range**: 31333:1942:339
- **Details**: [function_testCannotCloseTroveIfZapperIsNotReceiver.md](./function_testCannotCloseTroveIfZapperIsNotReceiver.md)
...
### testExcessRepaymentByAdjustGoesBackToUser()

- **Signature**: `testExcessRepaymentByAdjustGoesBackToUser()`
- **Visibility**: external
- **Source Range**: 33281:1815:339
- **Details**: [function_testExcessRepaymentByAdjustGoesBackToUser.md](./function_testExcessRepaymentByAdjustGoesBackToUser.md)
...
### testExcessRepaymentByRepayGoesBackToUser()

- **Signature**: `testExcessRepaymentByRepayGoesBackToUser()`
- **Visibility**: external
- **Source Range**: 35102:1636:339
- **Details**: [function_testExcessRepaymentByRepayGoesBackToUser.md](./function_testExcessRepaymentByRepayGoesBackToUser.md)
