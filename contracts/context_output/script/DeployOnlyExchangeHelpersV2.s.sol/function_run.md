...
**Contract**: [script/DeployOnlyExchangeHelpersV2.s.sol/contract_DeployOnlyExchangeHelpersV2.md]
...
function run() external {
    ...
    vm.startBroadcast();
    HybridCurveUniV3ExchangeHelpersV2 exchangeHelpersV2 = new HybridCurveUniV3ExchangeHelpersV2({_usdc: USDC, _weth: WETH, _curvePool: ICurveStableswapNGPool(address(curveUsdcBold)), _usdcIndex: int8((curveUsdcBold.coins(0) == USDC) ? 0 : 1), _boldIndex: int8((curveUsdcBold.coins(0) == BOLD) ? 0 : 1), _feeUsdcWeth: UNIV3_FEE_USDC_WETH, _feeWethColl: UNIV3_FEE_WETH_COLL, _uniV3Quoter: (block.chainid == 1) ? uniV3QuoterMainnet : uniV3QuoterSepolia});
...
```
┌─ [0] ⚙️ FUNCTION: DeployOnlyExchangeHelpersV2.run() (NodeID: 0)
    💬 Args: [no args]
    👁️  Def: external
  ├─ [1] ⚙️ FUNCTION: UseDeployment._loadDeploymentFromManifest(string) (NodeID: 1)
  │   💬 Args: [string.concat("addresses/", block.chainid.toString(), ".json")]
  │   👁️  Def: internal
  │ ├─ [2] ⚙️ FUNCTION: Strings.toString(uint256) (NodeID: 40)
  │ │   💬 Args: [block.chainid]
  │ │   👁️  Def: internal
  │ │ └─ [3] ⚙️ FUNCTION: Math.log10(uint256) (NodeID: 41)
  │ │     💬 Args: [value]
  │ │     👁️  Def: internal
  ...
  │     👁️  Def: internal
  └─ [1] ⚙️ FUNCTION: console.log(string,address) (NodeID: 42)
      💬 Args: ["exchangeHelpersV2:", address(exchangeHelpersV2)]
      👁️  Def: internal
