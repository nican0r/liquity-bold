...
- **Name**: DeployOnlyExchangeHelpers
- **Type**: Contract
- **Path**: script/DeployOnlyExchangeHelpers.s.sol
...
```solidity
IERC20 internal constant USDC = IERC20(0xc4f4dE29be4d05EA0644dfebb44a87a48E3BfcCE)
```
...
```solidity
IWETH internal constant WETH = IWETH(0xbCDdC15adbe087A75526C0b7273Fcdd27bE9dD18)
```
...
```solidity
ICurveStableswapNGPool internal constant usdcCurvePool = ICurveStableswapNGPool(0xdCD2D012C1A4fc509763657ED24b83c8Fe6cf756)
```
